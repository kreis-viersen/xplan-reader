...
<!--
	...
	<sld:NamedLayer>
		<se:Name>so_schutzgebietwasserrecht</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:SO_SchutzgebietWasserrecht</se:FeatureTypeName>
				<se:Rule>
					<se:Name>so_schutzgebietwasserrecht</se:Name>
					<se:Description>
						<se:Title>SO: SchutzgebietWasserrecht</se:Title>
					</se:Description>
