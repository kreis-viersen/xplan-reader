	...
	<sld:NamedLayer>
		...
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:SO_Bereich</se:FeatureTypeName>
				<se:Rule>
					<se:Name>so_bereich</se:Name>
					<se:Description>
						<se:Title>SO: Bereich</se:Title>
					</se:Description>
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						<se:Geometry>
							<ogc:PropertyName>geltungsbereich</ogc:PropertyName>
						</se:Geometry>
						<se:Stroke>
