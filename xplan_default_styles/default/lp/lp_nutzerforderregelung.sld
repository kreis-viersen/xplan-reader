...
<!--
	...
	<sld:NamedLayer>
		<se:Name>lp_nutzerforderregelung</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:sed="http://www.deegree.org/se" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd http://www.deegree.org/se http://schemas.deegree.org/se/1.1.0/Symbolizer-deegree.xsd">
				...
				<se:FeatureTypeName>xplan:LP_NutzungserfordernisRegelung</se:FeatureTypeName>
				<!-- Fläche -->
				<se:Rule>
					<se:Name>lp_nutzerforderregelung</se:Name>
					<se:Description>
						<se:Title>Flächen zum Schutz und zur Pflege</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
					...
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:GraphicStroke>
								...
								<se:InitialGap>40</se:InitialGap>
								<se:Gap>70</se:Gap>
							</se:GraphicStroke>
						</se:Stroke>
						<sed:PerpendicularOffset type="Standard">-3.75</sed:PerpendicularOffset>
					...
					<se:LineSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:GraphicStroke>
								...
								<se:InitialGap>10</se:InitialGap>
								<se:Gap>70</se:Gap>
							</se:GraphicStroke>
						</se:Stroke>
					</se:LineSymbolizer>
					<se:LineSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:GraphicStroke>
								...
								<se:InitialGap>20</se:InitialGap>
								<se:Gap>70</se:Gap>
							</se:GraphicStroke>
						</se:Stroke>
					</se:LineSymbolizer>
					<se:LineSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:GraphicStroke>
								...
								<se:InitialGap>50</se:InitialGap>
								<se:Gap>70</se:Gap>
							</se:GraphicStroke>
						</se:Stroke>
					</se:LineSymbolizer>
