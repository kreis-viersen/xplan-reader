...
<!--
	...
	<sld:NamedLayer>
		<se:Name>lp_erholungfreizeit</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:sed="http://www.deegree.org/se" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd http://www.deegree.org/se http://schemas.deegree.org/se/1.1.0/Symbolizer-deegree.xsd">
				...
				<se:FeatureTypeName>xplan:LP_ErholungFreizeit</se:FeatureTypeName>
				<!-- Fläche -->
				<se:Rule>
					<se:Name>lp_erholungfreizeit</se:Name>
					<se:Description>
						<se:Title>LP: Erholung und Freizeit</se:Title>
					</se:Description>
					<ogc:Filter>
					...
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:SvgParameter name="stroke">#70944D</se:SvgParameter>
					...
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:GraphicStroke>
								...
								<se:InitialGap>30</se:InitialGap>
								<se:Gap>30</se:Gap>
							</se:GraphicStroke>
						</se:Stroke>
						<sed:PerpendicularOffset type="Standard">-3.75</sed:PerpendicularOffset>
							...
							<se:GraphicStroke>
								<se:Graphic>
									<se:Mark>
										...
										<se:MarkIndex>2661</se:MarkIndex>
										<se:Fill>
											<se:SvgParameter name="fill">#70944D</se:SvgParameter>
										</se:Fill>
										<se:Stroke>
