...
<!--
	...
	<sld:NamedLayer>
		<se:Name>lp_rasterplanaender</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:LP_RasterplanAenderung</se:FeatureTypeName>
				<!-- Fläche -->
				<se:Rule>
					<se:Name>lp_rasterplanaender</se:Name>
					<se:Description>
						<se:Title>LP: RasterplanAenderung</se:Title>
					</se:Description>
					<ogc:Filter>
				...
				<!-- Linien -->
				<se:Rule>
					<se:Name>lp_sonstsrecht</se:Name>
					<se:Description>
						<se:Title>LP: Sonstiges Recht</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:PropertyIsEqualTo>
