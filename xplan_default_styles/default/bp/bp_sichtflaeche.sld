...
<!--
	...
	<sld:NamedLayer>
		<se:Name>bp_sichtflaeche</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				<se:Name>transparent</se:Name>
				<se:FeatureTypeName>xplan:BP_Sichtflaeche</se:FeatureTypeName>
				<se:Rule>
					<se:Name>bp_sichtflaeche</se:Name>
					<se:Description>
						<se:Title>BP: Sichtflaeche</se:Title>
					</se:Description>
					...
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Fill>
							<se:GraphicFill>
								<se:Graphic>
									<se:ExternalGraphic>
										<se:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="../../symbols/sichtflaeche.png"/>
