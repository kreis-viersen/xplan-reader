...
<!--
	...
	<sld:NamedLayer>
		<se:Name>bp_denkmscheinzanlpt</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:BP_DenkmalschutzEinzelanlagePunkt</se:FeatureTypeName>
				<se:Rule>
					<se:Name>bp_denkmscheinzanlpt</se:Name>
					<se:Description>
					...
					<se:PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Graphic>
							<se:Mark>
								<se:OnlineResource xlink:type="simple" xlink:href="../../symbols/d_sym.svg"/>
