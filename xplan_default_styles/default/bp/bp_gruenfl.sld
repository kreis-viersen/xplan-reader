	...
	<sld:NamedLayer>
		...
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:BP_GruenFlaeche</se:FeatureTypeName>
				<!-- Grünfläche Privat -->
				<se:Rule>
					<se:Name>bp_gruenfl</se:Name>
					<se:Description>
						<se:Title>BP: Grünfläche Privat</se:Title>
					</se:Description>
					<ogc:Filter>
				...
				<se:Rule>
					<se:Name>bp_gruenfl</se:Name>
					<se:Description>
						<se:Title>BP: Grünfläche Öffentlich</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>nutzungsform</ogc:PropertyName>
				...
				<se:Rule>
					<se:Name>bp_gruenfl</se:Name>
					<se:Description>
						<se:Title>BP: Grünfläche</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:PropertyIsNull>
							<ogc:PropertyName>nutzungsform</ogc:PropertyName>
