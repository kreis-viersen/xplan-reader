...
<!--
	...
	<sld:NamedLayer>
		<se:Name>bp_gestbaugebsym</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:BP_GestaltungBaugebiet</se:FeatureTypeName>
				<!-- TODO komplett?! -->
				<se:Rule>
					<se:Name>bp_gestbaugeb</se:Name>
					<se:Description>
						<se:Title>BP: Gestaltung Baugebiet</se:Title>
					</se:Description>
					<se:TextSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Label>
							<ogc:PropertyName>DNmin</ogc:PropertyName>
						</se:Label>
						<se:Font>
					...
					<se:TextSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Label>
							<ogc:PropertyName>DNmax</ogc:PropertyName>
						</se:Label>
						<se:Font>
							<se:SvgParameter name="font-family">Arial</se:SvgParameter>
							<se:SvgParameter name="font-family">Sans-Serif</se:SvgParameter>
					...
					<se:TextSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Label>
							<ogc:PropertyName>DNZwingend</ogc:PropertyName>
						</se:Label>
						<se:Font>
							<se:SvgParameter name="font-family">Arial</se:SvgParameter>
							<se:SvgParameter name="font-family">Sans-Serif</se:SvgParameter>
					...
					<se:TextSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Label>
							<ogc:PropertyName>FR</ogc:PropertyName>
						</se:Label>
						<se:Font>
							<se:SvgParameter name="font-family">Arial</se:SvgParameter>
							<se:SvgParameter name="font-family">Sans-Serif</se:SvgParameter>
						...
						<se:LabelPlacement>
							<se:PointPlacement>
								<se:Displacement>
									<se:DisplacementX>19</se:DisplacementX>
									<se:DisplacementY>0</se:DisplacementY>
								</se:Displacement>
							</se:PointPlacement>
						</se:LabelPlacement>
					...
					<se:TextSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Label>
							<ogc:PropertyName>dachform</ogc:PropertyName>
						</se:Label>
						<se:Font>
							<se:SvgParameter name="font-family">Arial</se:SvgParameter>
							<se:SvgParameter name="font-family">Sans-Serif</se:SvgParameter>
					...
					<se:TextSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Label>
							<ogc:PropertyName>detaillierteDachform</ogc:PropertyName>
						</se:Label>
						<se:Font>
							<se:SvgParameter name="font-family">Arial</se:SvgParameter>
							<se:SvgParameter name="font-family">Sans-Serif</se:SvgParameter>
