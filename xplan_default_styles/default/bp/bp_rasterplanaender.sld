...
<!--
	...
	<sld:NamedLayer>
		<se:Name>bp_rasterplanaender</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:BP_RasterplanAenderung</se:FeatureTypeName>
				<!-- TODO platzhalter -->
				<se:Rule>
					<se:Name>bp_rasterplanaender</se:Name>
					<se:Description>
						<se:Title>BP: Rasterplanänderung</se:Title>
					</se:Description>
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						<se:Geometry>
							<ogc:PropertyName>geltungsbereichAenderung</ogc:PropertyName>
						</se:Geometry>
						<se:Stroke>
