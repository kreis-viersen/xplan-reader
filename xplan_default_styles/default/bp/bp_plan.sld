	...
	<sld:NamedLayer>
		...
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:sed="http://www.deegree.org/se" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd http://www.deegree.org/se http://schemas.deegree.org/se/1.1.0/Symbolizer-deegree.xsd">
				...
				<se:FeatureTypeName>xplan:BP_Plan</se:FeatureTypeName>
				<se:Rule>
					<se:Name>bp_plan</se:Name>
					<se:Description>
						<se:Title>BP: Plan</se:Title>
					</se:Description>
					...
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:SvgParameter name="stroke">#80847A</se:SvgParameter>
				...
				<se:Rule>
					...
					<se:PolygonSymbolizer uom="pixel">
						<se:Geometry>
							<ogc:PropertyName>raeumlicherGeltungsbereich</ogc:PropertyName>
						</se:Geometry>
						<se:Stroke>
