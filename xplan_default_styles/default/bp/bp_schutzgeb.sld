	...
	<sld:NamedLayer>
		...
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:sed="http://www.deegree.org/se" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd http://www.deegree.org/se http://schemas.deegree.org/se/1.1.0/Symbolizer-deegree.xsd">
				...
				<se:FeatureTypeName>xplan:BP_Schutzgebiet</se:FeatureTypeName>
				<!-- TODO: Linien & Punkte -->
				<!-- Flaeche -->
				<se:Rule>
					<se:Name>bp_schutzgebiet Flaeche</se:Name>
					<se:Description>
						<se:Title>BP: Schutzgebiet Flaeche</se:Title>
					</se:Description>
					<ogc:Filter>
				...
				<!-- Linie -->
				<se:Rule>
					<se:Name>bp_schutzgebiet Linie</se:Name>
					<se:Description>
						<se:Title>BP: Schutzgebiet Linie</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>BP: Naturschutzgebiet</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>BP: Nationalpark</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>BP: Biosphärenreservat</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>BP: Landschaftsschutzgebiet</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>BP: Naturpark</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>BP: Naturdenkmal</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>BP: Geschützter Landschaftsbestandteil</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>BP: Gesetzlich geschütztes Biotop</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>BP: Gebiet gemeinschaftlicher Bedeutung</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>BP: Europäisches Vogelschutzgebiet</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
