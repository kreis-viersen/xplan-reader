	...
	<sld:NamedLayer>
		...
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:sed="http://www.deegree.org/se" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd http://www.deegree.org/se http://schemas.deegree.org/se/1.1.0/Symbolizer-deegree.xsd">
				...
				<se:FeatureTypeName>xplan:BP_Strassenkoerper</se:FeatureTypeName>
				<!-- Flaechendarstellung -->
				<!-- Aufschuettung -->
				<se:Rule>
					<se:Name>Aufschuettung</se:Name>
					<se:Description>
						<se:Title>BP: Aufschüttung</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
					...
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:GraphicStroke>
								<se:Graphic>
									<se:Mark>
										<se:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="../../symbols/strkoerperauf_rs.svg"/>
				...
				<!-- Abgrabung -->
				<se:Rule>
					<se:Name>Abgrabung</se:Name>
					<se:Description>
						<se:Title>BP: Abgrabung</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
				...
				<!-- Stuetzmauer -->
				<se:Rule>
					<se:Name>Stuetzmauer</se:Name>
					<se:Description>
						<se:Title>BP: Stützmauer</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
					...
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:GraphicStroke>
								<se:Graphic>
									<se:Mark>
										<se:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="../../symbols/strkoerperstuetz_rs.svg"/>
										<se:Format>svg</se:Format>
										<se:Fill>
											<se:SvgParameter name="fill">#000000</se:SvgParameter>
										</se:Fill>
