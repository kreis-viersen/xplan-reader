	...
	<sld:NamedLayer>
		...
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:BP_LandwirtschaftsLinie</se:FeatureTypeName>
				<se:Rule>
					<se:Name>bp_lwlin</se:Name>
					<se:Description>
						<se:Title>BP: Landwirtschaftslinie</se:Title>
					</se:Description>
					<ogc:Filter>
					...
					<se:LineSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:SvgParameter name="stroke">#d1de85</se:SvgParameter>
