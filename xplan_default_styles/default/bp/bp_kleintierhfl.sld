...
<!--
	...
	<sld:NamedLayer>
		<se:Name>bp_kleintierhfl</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:BP_KleintierhaltungFlaeche</se:FeatureTypeName>
				<se:Rule>
					<se:Name>bp_kleintierhfl</se:Name>
					<se:Description>
						<se:Title>BP: Kleintierhaltungsfläche</se:Title>
					</se:Description>
					<ogc:Filter>
					...
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<!--
                        <Fill>
        <SvgParameter name="fill">#d1de85</SvgParameter>
