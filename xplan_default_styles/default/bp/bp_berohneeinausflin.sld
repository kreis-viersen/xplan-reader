...
<!--
	...
	<sld:NamedLayer>
		<se:Name>bp_berohneeinausflin</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:sed="http://www.deegree.org/se" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd http://www.deegree.org/se http://schemas.deegree.org/se/1.1.0/Symbolizer-deegree.xsd">
				...
				<se:FeatureTypeName>xplan:BP_BereichOhneEinAusfahrtLinie</se:FeatureTypeName>
				<se:Rule>
					<se:Name>bp_berohneeinausflin</se:Name>
					<se:Description>
						<se:Title>BP: Bereich ohne Ein- oder Ausfahrt</se:Title>
					</se:Description>
					...
					<se:LineSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:GraphicStroke>
								<se:Graphic>
									<se:Mark>
										<se:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="../../symbols/berohneeinausflin_sym.svg"/>
