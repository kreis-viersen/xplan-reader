...
<!--
	...
	<sld:NamedLayer>
		<se:Name>bp_aufschuettsfl</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:sed="http://www.deegree.org/se" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd http://www.deegree.org/se http://schemas.deegree.org/se/1.1.0/Symbolizer-deegree.xsd">
				...
				<se:FeatureTypeName>xplan:BP_AufschuettungsFlaeche</se:FeatureTypeName>
				<se:Rule>
					<se:Name>bp_aufschuettsfl</se:Name>
					<se:Description>
						<se:Title>BP: Aufschüttungsfläche</se:Title>
					</se:Description>
					...
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<sed:PerpendicularOffset type="Standard">-2.1</sed:PerpendicularOffset>
					</se:PolygonSymbolizer>
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						<se:Geometry>
							<ogc:PropertyName>position</ogc:PropertyName>
						...
						<sed:PerpendicularOffset type="Standard">-3.6</sed:PerpendicularOffset>
					</se:PolygonSymbolizer>
				</se:Rule>
			</se:FeatureTypeStyle>
		</sld:UserStyle>
