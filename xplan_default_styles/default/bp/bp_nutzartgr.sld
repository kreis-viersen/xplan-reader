	...
	<sld:NamedLayer>
		...
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:BP_NutzungsartenGrenze</se:FeatureTypeName>
				<se:Rule>
					<se:Name>bp_nutzartgr</se:Name>
					<se:Description>
						<se:Title>BP: Nutzungsartengrenze</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:Or>
				...
				<se:Rule>
					<se:Name>bp_nutzartgr</se:Name>
					<se:Description>
						<se:Title>BP: Sonstige Abgrenzung</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>typ</ogc:PropertyName>
