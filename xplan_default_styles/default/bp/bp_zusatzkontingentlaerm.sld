...
<!--
	...
	<sld:NamedLayer>
		<se:Name>bp_zusatzkontingentlaerm</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:BP_ZusatzkontingentLaerm</se:FeatureTypeName>
				<se:Rule>
					<se:Name>bp_zusatzkontingentlaerm</se:Name>
					<se:Description>
						<se:Title>BP: ZusatzkontingentLaerm</se:Title>
					</se:Description>
