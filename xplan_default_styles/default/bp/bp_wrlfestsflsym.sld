...
<!--
	...
	<sld:NamedLayer>
		<se:Name>bp_wrlfestsflsym</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:BP_WasserrechtlicheFestsetzungsFlaeche</se:FeatureTypeName>
				<!-- SchutzgebietQuellGrundwasser -->
				<!-- Rule wg. symbolPosition entfernt -->
				<!-- SchutzgebietOberflaechengewaesser -->
				<!-- Rule wg. symbolPosition entfernt -->
				<!-- WasserschutzgebietZone1 -->
				<!-- Rule wg. symbolPosition entfernt -->
				<!-- WasserschutzgebietZone2 -->
				<!-- Rule wg. symbolPosition entfernt -->
				<!-- WasserschutzgebietZone3 -->
				<!-- Rule wg. symbolPosition entfernt -->
				<!-- WasserschutzgebietZone3a -->
				<!-- Rule wg. symbolPosition entfernt -->
				<!-- WasserschutzgebietZone3b -->
				<!-- Rule wg. symbolPosition entfernt -->
