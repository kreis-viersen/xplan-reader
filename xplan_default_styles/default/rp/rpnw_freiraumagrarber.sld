...
<!--
	...
	<sld:NamedLayer>
		<se:Name>rpnw_freiraumagrarber</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:RP_NRW_FreiraumAgrarbereich</se:FeatureTypeName>
				<!-- Fläche -->
				<se:Rule>
					<se:Name>rpnw_freiraumagrarber</se:Name>
					<se:Description>
						<se:Title>RP: NRW Freiraum- und Agrarbereiche</se:Title>
					</se:Description>
					<ogc:Filter>
