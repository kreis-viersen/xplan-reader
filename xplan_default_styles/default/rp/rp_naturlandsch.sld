...
<!--
	...
	<sld:NamedLayer>
		<se:Name>rp_naturlandsch</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:sed="http://www.deegree.org/se" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:RP_NaturLandschaft</se:FeatureTypeName>
				<!-- Fläche -->
				<se:Rule>
					<se:Name>rp_naturlandsch</se:Name>
					<se:Description>
						<se:Title>RP: Natur und Landschaft</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
				...
				<se:Rule>
					...
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<sed:PerpendicularOffset>-0.5</sed:PerpendicularOffset>
					</se:PolygonSymbolizer>
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						<se:Geometry>
							<ogc:PropertyName>position</ogc:PropertyName>
						...
						<se:Stroke>
							<!-- grün -->
							<se:SvgParameter name="stroke">#00ff33</se:SvgParameter>
							<se:SvgParameter name="stroke-opacity">1.0</se:SvgParameter>
					...
					<se:LineSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:GraphicStroke>
								<se:Graphic>
									<se:Mark>
										<se:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="../../symbols/naturlandschaft-freiraum.svg"/>
