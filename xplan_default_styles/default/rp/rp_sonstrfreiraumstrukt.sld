...
<!--
	...
	<sld:NamedLayer>
		<se:Name>rp_sonstrfreiraumstrukt</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:RP_SonstigerFreiraumstruktur</se:FeatureTypeName>
				<!-- Fläche -->
				<se:Rule>
					<se:Name>rp_sonstrfreiraumstrukt</se:Name>
					<se:Description>
						<se:Title>RP: sonstige Freiraumstruktur</se:Title>
					</se:Description>
					<ogc:Filter>
