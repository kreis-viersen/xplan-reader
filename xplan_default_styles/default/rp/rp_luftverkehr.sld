...
<!--
	...
	<sld:NamedLayer>
		<se:Name>rp_luftverkehr</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:RP_Luftverkehr</se:FeatureTypeName>
				<!--Verkehrsflughafen-->
				<se:Rule>
					<se:Name>VR_Verkehrsflughafen</se:Name>
					<se:Description>
						<se:Title>VR_Verkehrsflughafen</se:Title>
					</se:Description>
					<ogc:Filter>
				...
				<!--Verkehrslandeplatz-->
				<se:Rule>
					<se:Name>VR_Verkehrslandeplatz</se:Name>
					<se:Description>
						<se:Title>VR_Verkehrslandeplatz</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>typ</ogc:PropertyName>
