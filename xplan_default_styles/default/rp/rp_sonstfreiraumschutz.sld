...
<!--
	...
	<sld:NamedLayer>
		<se:Name>rp_sonstfreiraumschutz</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:RP_SonstigerFreiraumschutz</se:FeatureTypeName>
				<!--RP_SonstigerFreiraumschutz-->
				<se:Rule>
					<se:Name>RP_SonstigerFreiraumschutz</se:Name>
					<se:Description>
						<se:Title>SonstigerFreiraumschutz</se:Title>
					</se:Description>
