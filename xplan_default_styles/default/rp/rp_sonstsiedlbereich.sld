...
<!--
	...
	<sld:NamedLayer>
		<se:Name>rp_sonstsiedlbereich</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:RP_SonstigerSiedlungsbereich</se:FeatureTypeName>
				<!--RP_SonstigerSiedlungsbereich-->
				<se:Rule>
					<se:Name>RP_SonstigerSiedlungsbereich</se:Name>
					<se:Description>
						<se:Title>SonstigerSiedlungsbereich</se:Title>
					</se:Description>
