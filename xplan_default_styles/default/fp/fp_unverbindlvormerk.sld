...
<!--
	...
	<sld:NamedLayer>
		<se:Name>fp_unverbindlvormerk</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:FP_UnverbindlicheVormerkung</se:FeatureTypeName>
				<!-- surface -->
				<se:Rule>
					<se:Name>fp_unverbindlvormerk</se:Name>
					<se:Description>
						<se:Title>FP: Unverbindliche Vormerkung</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
