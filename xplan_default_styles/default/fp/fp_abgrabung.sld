	...
	<sld:NamedLayer>
		...
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:sed="http://www.deegree.org/se" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd http://www.deegree.org/se http://schemas.deegree.org/se/1.1.0/Symbolizer-deegree.xsd">
				...
				<se:FeatureTypeName>xplan:FP_Abgrabung</se:FeatureTypeName>
				<se:Rule>
					<se:Name>fp_abgrabung Flaeche</se:Name>
					<se:Description>
						<se:Title>FP: Abgrabung Flaeche</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
					...
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<sed:PerpendicularOffset type="Edged">-6.5</sed:PerpendicularOffset>
				...
				<!-- Linie -->
				<se:Rule>
					<se:Name>fp_abgrabung Linie</se:Name>
					<se:Description>
						<se:Title>FP: SchutzgebietNaturschutzrecht Linie</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:PropertyIsEqualTo>
				...
				<!-- Punkt -->
				<se:Rule>
					<se:Name>fp_abgrabung Punkt</se:Name>
					<se:Description>
						<se:Title>FP: Abgrabung Punkt</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:PropertyIsEqualTo>
					...
					<se:PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Graphic>
							<se:Mark>
								<se:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="../../symbols/abgrabungbs_sym.svg"/>
