	...
	<sld:NamedLayer>
		...
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:FP_Gewaesser</se:FeatureTypeName>
				<se:Rule>
					<se:Name>fp_gew</se:Name>
					<se:Description>
						<se:Title>FP: Gewässer Fläche</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
					...
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Fill>
							<se:SvgParameter name="fill">#75c7ff</se:SvgParameter>
				...
				<se:Rule>
					...
					<se:LineSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:SvgParameter name="stroke">#75c7ff</se:SvgParameter>
							<se:SvgParameter name="stroke-opacity">1.0</se:SvgParameter>
