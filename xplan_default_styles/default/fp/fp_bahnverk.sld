	...
	<sld:NamedLayer>
		...
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<!-- FP: Bahnverkehr Fläche -->
				<se:Rule>
					<se:Name>fp_bahnverk</se:Name>
					<se:Description>
						<se:Title>FP: Bahnverkehr Fläche</se:Title>
					</se:Description>
					<ogc:Filter>
				...
				<!-- FP: Bahnverkehr Linie -->
				<se:Rule>
					<se:Name>fp_bahnverk</se:Name>
					<se:Description>
						<se:Title>FP: Bahnverkehr Linie</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:PropertyIsEqualTo>
				...
				<!-- FP: Bahnverkehr Punkt -->
				<se:Rule>
					<se:Name>fp_bahnverk</se:Name>
					<se:Description>
						<se:Title>FP: Bahnverkehr Punkt</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:PropertyIsEqualTo>
