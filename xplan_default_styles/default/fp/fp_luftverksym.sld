...
<!--
	...
	<sld:NamedLayer>
		<se:Name>fp_luftverksym</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<!-- Ballonstartplatz -->
				<!-- <Rule>
      <Name>Ballonstartplatz</Name>
      <Description>
          <Title>FP: Ballonstartplatz</Title>
      </Description>
      <ogc:Filter>
        <ogc:And>
          <ogc:Not>
...
-->
				<!-- Haengegleiter -->
				<!-- <Rule>
      <Name>Haengegleiter</Name>
      <Description>
          <Title>FP: Hängegleiter</Title>
      </Description>
      <ogc:Filter>
        <ogc:And>
          <ogc:Not>
      ...
      <PointSymbolizer uom="meter">
          ...
          <Graphic>
              ...
              <Size>70</Size>
				...
				<!-- Gleitsegler -->
				<!-- <Rule>
      <Name>Gleitsegler</Name>
      <Description>
          <Title>FP: Gleitsegler</Title>
      </Description>
      <ogc:Filter>
        <ogc:And>
          <ogc:Not>
				...
				<se:Rule>
					...
					<se:TextSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:LabelPlacement>
							<se:PointPlacement>
								<se:Displacement>
									<se:DisplacementX>26</se:DisplacementX>
