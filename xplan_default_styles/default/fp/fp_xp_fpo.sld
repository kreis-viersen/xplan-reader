	...
	<sld:NamedLayer>
		...
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:XP_FPO</se:FeatureTypeName>
				<se:Rule>
					<se:Name>fp_xp_fpo</se:Name>
					<se:Description>
						<se:Title>FP: Flächenhaftes Präsentationsobjekt</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>xpPlanType</ogc:PropertyName>
							<ogc:Literal>FP_Plan</ogc:Literal>
						</ogc:PropertyIsEqualTo>
					</ogc:Filter>
