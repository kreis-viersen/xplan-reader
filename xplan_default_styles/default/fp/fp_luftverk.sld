	...
	<sld:NamedLayer>
		...
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:sed="http://www.deegree.org/se" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd http://www.deegree.org/se http://schemas.deegree.org/se/1.1.0/Symbolizer-deegree.xsd">
				...
				<se:FeatureTypeName>xplan:FP_Luftverkehr</se:FeatureTypeName>
				<!-- Fläche -->
				<se:Rule>
					<se:Name>fp_luftverk</se:Name>
					<se:Description>
						<se:Title>FP: Luftverkehr</se:Title>
					</se:Description>
					<ogc:Filter>
					...
					<se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Stroke>
							<se:SvgParameter name="stroke">#CC3399</se:SvgParameter>
				...
				<!-- Flughafen -->
				<se:Rule>
					<se:Name>Flughafen</se:Name>
					<se:Description>
						<se:Title>FP: Flughafen</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
					...
					<se:PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Graphic>
							<se:Mark>
								<se:OnlineResource xlink:type="simple" xlink:href="../../symbols/luftverkflflugh_sym.svg"/>
				...
				<!-- Landeplatz -->
				<se:Rule>
					<se:Name>Landeplatz</se:Name>
					<se:Description>
						<se:Title>FP: Landeplatz</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
					...
					<se:PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Graphic>
							<se:Mark>
								<se:OnlineResource xlink:type="simple" xlink:href="../../symbols/luftverkfllandepl_sym.svg"/>
								<se:Format>svg</se:Format>
								<se:Fill>
									<se:SvgParameter name="fill">#000000</se:SvgParameter>
									<se:SvgParameter name="fill-opacity">0.0</se:SvgParameter>
				...
				<!-- Segelfluggelaende -->
				<se:Rule>
					<se:Name>Segelfluggelaende</se:Name>
					<se:Description>
						<se:Title>FP: Segelfluggelände</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
					...
					<se:PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Graphic>
							<se:Mark>
								<se:OnlineResource xlink:type="simple" xlink:href="../../symbols/luftverkflsegel_sym.svg"/>
								<se:Format>svg</se:Format>
								<se:Fill>
									<se:SvgParameter name="fill">#000000</se:SvgParameter>
									<se:SvgParameter name="fill-opacity">0.0</se:SvgParameter>
				...
				<se:Rule>
					<se:Name>Hubschrauberlandeplatz</se:Name>
					<se:Description>
						<se:Title>FP: Hubschrauberlandeplatz</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
					...
					<se:PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
						...
						<se:Graphic>
							<se:Mark>
								<se:OnlineResource xlink:type="simple" xlink:href="../../symbols/luftverkflhub_sym.svg"/>
								<se:Format>svg</se:Format>
								<se:Fill>
									<se:SvgParameter name="fill">#000000</se:SvgParameter>
									<se:SvgParameter name="fill-opacity">0.0</se:SvgParameter>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>FP: Ballonstartplatz</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>FP: Hängegleiter</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>FP: Gleitsegler</se:Title>
					</se:Description>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
