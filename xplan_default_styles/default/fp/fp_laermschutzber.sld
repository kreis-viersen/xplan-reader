...
<!--
	...
	<sld:NamedLayer>
		<se:Name>fp_laermschutzber</se:Name>
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle xmlns:ogc="http://www.opengis.net/ogc" xmlns:xplan="http://www.deegree.org/xplanung/1/0" xsi:schemaLocation="http://www.opengis.net/se http://schemas.opengis.net/se/1.1.0/FeatureStyle.xsd">
				...
				<se:FeatureTypeName>xplan:FP_Laermschutzbereich</se:FeatureTypeName>
				<!-- TODO Style platzhalter -->
				<se:Rule>
					<se:Name>fp_laermschutzber</se:Name>
					<se:Description>
						<se:Title>FP: Lärmschutzbereich</se:Title>
					</se:Description>
