...
class XplanReader:
    ...
    def importXplanGml(self):
        ...
        if result == 1:
            ...
            addXplanLayer("FP_TextAbschnittFlaeche", "Flaeche")
            ...
            addXplanLayer("SO_Baubeschraenkung", "Flaeche")
            addXplanLayer("SO_Wasserwirtschaft", "Flaeche")
            addXplanLayer("SO_Sichtflaeche", "Flaeche")
            addXplanLayer("SO_TextAbschnittFlaeche", "Flaeche")
            ...
            addXplanLayer("FP_Nutzungsbeschraenkung", "Flaeche")
            ...
            addXplanLayer("XP_Flaechengeometrie", "Flaeche")
            ...
            addXplanLayer("SO_Strassenverkehr", "Linie")
            addXplanLayer("SO_Baubeschraenkung", "Linie")
            addXplanLayer("SO_Wasserwirtschaft", "Linie")
            ...
            addXplanLayer("FP_Nutzungsbeschraenkung", "Linie")
            ...
            addXplanLayer("XP_Liniengeometrie", "Linie")
            ...
            addXplanLayer("SO_Strassenverkehr", "Punkt")
            ...
            addXplanLayer("FP_Nutzungsbeschraenkung", "Punkt")
            ...
            addXplanLayer("SO_Baubeschraenkung", "Punkt")
            addXplanLayer("SO_Wasserwirtschaft", "Linie")
            addXplanLayer("SO_Gelaendemorphologie", "Punkt")
            ...
            addXplanLayer("XP_Punktgeometrie", "Punkt")
