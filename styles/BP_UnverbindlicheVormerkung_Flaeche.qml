...
<qgis version="3.28.4-Firenze" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" symbollevels="0" enableorderby="0">
    <rules key="{e3e585df-ea4f-4b52-ab6c-ed9634a1d492}">
      <rule key="{49f7a10f-c16c-4584-9cb0-9e96c7b7ded4}" symbol="0"/>
    </rules>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style allowHtml="0" blendMode="0" fontSizeUnit="Point" fontItalic="0" useSubstitutions="0" fontSize="8" fontKerning="1" namedStyle="Regular" isExpression="1" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOpacity="1" previewBkgrdColor="255,255,255,255" fontWeight="50" fontWordSpacing="0" textColor="0,0,0,255" fontLetterSpacing="0" textOrientation="horizontal" forcedBold="0" fontUnderline="0" multilineHeightUnit="Percentage" forcedItalic="0" capitalization="0" fieldName="'Vormerkung:'+ '\n' +&#xd;&#xa; CASE&#xd;&#xa; When try(&quot;vormerkung&quot; is not null) then &quot;vormerkung&quot;&#xd;&#xa; ELSE 'vormerkung nicht definiert'&#xd;&#xa; end&#xd;&#xa; " multilineHeight="1" legendString="Aa" fontFamily="Arial">
        <families/>
        <text-buffer bufferSizeUnits="Percentage" bufferBlendMode="0" bufferOpacity="1" bufferJoinStyle="128" bufferSize="25" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,158,23,255" bufferNoFill="1"/>
      ...
      <text-format rightDirectionSymbol=">" multilineAlign="3" addDirectionSymbol="0" decimals="3" autoWrapLength="15" reverseDirectionSymbol="0" placeDirectionSymbol="0" formatNumbers="0" plussign="0" leftDirectionSymbol="&lt;" useMaxLineLengthForAutoWrap="1" wrapChar=""/>
