...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.26.3-Buenos Aires">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" referencescale="-1" symbollevels="0">
    <rules key="{8e8ad9aa-93b9-4669-a71b-71c401a48587}">
      <rule symbol="0" key="{1c9fc84b-e78b-480f-9b94-06c4eb4475f4}"/>
    </rules>
    <symbols>
      <symbol type="line" is_animated="0" frame_rate="10" name="0" alpha="1" force_rhr="0" clip_to_extent="1">
          ...
          <symbol type="marker" is_animated="0" frame_rate="10" name="@0@0" alpha="1" force_rhr="0" clip_to_extent="1">
            ...
            <layer class="SimpleMarker" pass="0" locked="0" enabled="1">
              <Option type="Map">
                ...
                <Option type="QString" value="126,126,126,255" name="color"/>
        ...
        <layer class="SimpleLine" pass="0" locked="0" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="126,126,126,255" name="line_color"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format autoWrapLength="0" rightDirectionSymbol=">" useMaxLineLengthForAutoWrap="1" addDirectionSymbol="0" formatNumbers="0" leftDirectionSymbol="&lt;" wrapChar="" multilineAlign="0" reverseDirectionSymbol="0" placeDirectionSymbol="0" decimals="3" plussign="0"/>
      <placement overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" allowDegraded="0" overrunDistance="0" lineAnchorType="0" rotationUnit="AngleDegrees" xOffset="0" offsetUnits="MM" quadOffset="4" distMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" placement="3" repeatDistance="0" distUnits="MM" geometryGeneratorType="PointGeometry" maxCurvedCharAngleIn="25" priority="5" overrunDistanceUnit="MM" overlapHandling="PreventOverlap" repeatDistanceUnits="MM" geometryGenerator="" lineAnchorClipping="0" offsetType="0" geometryGeneratorEnabled="0" fitInPolygonOnly="0" lineAnchorTextPoint="FollowPlacement" maxCurvedCharAngleOut="-25" layerType="LineGeometry" rotationAngle="0" polygonPlacementFlags="2" lineAnchorPercent="0.5" yOffset="0" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" placementFlags="9" labelOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
