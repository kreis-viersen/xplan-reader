...
<qgis styleCategories="Symbology|Labeling" version="3.28.4-Firenze" labelsEnabled="1">
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" symbollevels="0" enableorderby="0">
    <rules key="{8e8ad9aa-93b9-4669-a71b-71c401a48587}">
      <rule symbol="0" label="alle" key="{1c9fc84b-e78b-480f-9b94-06c4eb4475f4}"/>
      <rule symbol="1" label="Typ nicht definiert" filter=" &quot;typ&quot; is NULL" key="{27064c51-fa87-402e-b4b3-455c49629091}"/>
    </rules>
    <symbols>
      <symbol is_animated="0" alpha="1" type="line" clip_to_extent="1" name="0" force_rhr="0" frame_rate="10">
        ...
        <layer class="MarkerLine" enabled="1" locked="0" pass="0">
          ...
          <symbol is_animated="0" alpha="1" type="marker" clip_to_extent="1" name="@0@0" force_rhr="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleMarker" enabled="1" locked="0" pass="0">
              <Option type="Map">
                ...
                <Option value="126,126,126,255" type="QString" name="color"/>
        ...
        <layer class="SimpleLine" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="126,126,126,255" type="QString" name="line_color"/>
      ...
      <symbol is_animated="0" alpha="1" type="line" clip_to_extent="1" name="1" force_rhr="0" frame_rate="10">
        ...
        <layer class="MarkerLine" enabled="1" locked="0" pass="0">
          ...
          <symbol is_animated="0" alpha="1" type="marker" clip_to_extent="1" name="@1@0" force_rhr="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format useMaxLineLengthForAutoWrap="1" placeDirectionSymbol="0" rightDirectionSymbol=">" formatNumbers="0" plussign="0" wrapChar="" multilineAlign="0" addDirectionSymbol="0" decimals="3" autoWrapLength="0" leftDirectionSymbol="&lt;" reverseDirectionSymbol="0"/>
      <placement allowDegraded="0" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" xOffset="0" yOffset="0" repeatDistance="0" placement="3" maxCurvedCharAngleOut="-25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" placementFlags="9" lineAnchorClipping="0" geometryGeneratorEnabled="0" overrunDistance="0" polygonPlacementFlags="2" quadOffset="4" overlapHandling="PreventOverlap" maxCurvedCharAngleIn="25" offsetUnits="MM" priority="5" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" centroidWhole="0" preserveRotation="1" overrunDistanceUnit="MM" distUnits="MM" lineAnchorTextPoint="FollowPlacement" geometryGenerator="" fitInPolygonOnly="0" repeatDistanceUnits="MM" lineAnchorType="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" layerType="LineGeometry" distMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" geometryGeneratorType="PointGeometry"/>
      <rendering minFeatureSize="0" obstacleType="1" limitNumLabels="0" scaleMax="4001" fontMinPixelSize="3" labelPerPart="0" unplacedVisibility="0" fontLimitPixelSize="0" fontMaxPixelSize="10000" mergeLines="0" maxNumLabels="2000" obstacle="1" scaleVisibility="1" scaleMin="0" zIndex="0" obstacleFactor="1" drawLabels="1" upsidedownLabels="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
