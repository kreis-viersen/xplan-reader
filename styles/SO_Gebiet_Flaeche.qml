...
<qgis styleCategories="Symbology|Labeling" version="3.26.3-Buenos Aires" labelsEnabled="1">
  <renderer-v2 referencescale="-1" forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer">
    <rules key="{98123d31-ba61-40fc-9f2b-af5937d1d4e6}">
      <rule scalemaxdenom="30001" key="{76e2ca4d-90c0-4fa8-838a-c183d6c5bc7d}" symbol="0" scalemindenom="999"/>
    </rules>
    <symbols>
      <symbol name="0" is_animated="0" frame_rate="10" alpha="1" type="fill" clip_to_extent="1" force_rhr="0">
        ...
        <layer locked="0" class="SimpleLine" pass="0" enabled="1">
          <Option type="Map">
            ...
            <Option value="0" name="draw_inside_polygon" type="QString"/>
            <Option value="miter" name="joinstyle" type="QString"/>
            <Option value="224,51,91,255" name="line_color" type="QString"/>
            <Option value="solid" name="line_style" type="QString"/>
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="miter" k="joinstyle"/>
          <prop v="224,51,91,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
        ...
        <layer locked="0" class="SimpleLine" pass="0" enabled="1">
          <Option type="Map">
            <Option value="0" name="align_dash_pattern" type="QString"/>
            <Option value="flat" name="capstyle" type="QString"/>
            <Option value="0.2;5" name="customdash" type="QString"/>
            <Option value="3x:0,0,0,0,0,0" name="customdash_map_unit_scale" type="QString"/>
            <Option value="RenderMetersInMapUnits" name="customdash_unit" type="QString"/>
            <Option value="0" name="dash_pattern_offset" type="QString"/>
            <Option value="3x:0,0,0,0,0,0" name="dash_pattern_offset_map_unit_scale" type="QString"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style capitalization="0" fontFamily="Arial" fieldName="'SO Gebiet' ||  '\n' || '&lt;p>'||&#xd;&#xa;&#xd;&#xa;CASE &#xd;&#xa;WHEN try(gebietsArt is not NULL,'-') THEN &#xd;&#xa;CASE &#xd;&#xa; WHEN &quot;gebietsArt&quot;= 1000 THEN 'Umlegungsgebiet' &#xd;&#xa; WHEN &quot;gebietsArt&quot;= 1100 THEN 'Sanierung' &#xd;&#xa; WHEN &quot;gebietsArt&quot;= 1200 THEN 'Entwicklung' &#xd;&#xa; WHEN &quot;gebietsArt&quot;= 1300 THEN 'Umbaugebiet' &#xd;&#xa; WHEN &quot;gebietsArt&quot;= 1400 THEN 'soziale'||'&lt;/p>'|| '&lt;p>'||'Stadt' &#xd;&#xa; WHEN &quot;gebietsArt&quot;= 1500 THEN 'Business'||'&lt;/p>'|| '&lt;p>'||'Improvement'||'&lt;/p>'|| '&lt;p>'||'District' &#xd;&#xa; WHEN &quot;gebietsArt&quot;= 1600 THEN 'Housing'||'&lt;/p>'|| '&lt;p>'||'Improvement'||'&lt;/p>'|| '&lt;p>'||'District' &#xd;&#xa; WHEN &quot;gebietsArt&quot;= 1999 or &quot;gebietsArt&quot;= 1700  THEN 'allg. Erhaltungsgebiet'  /* neuer Schlüssel mit V6*/&#xd;&#xa; WHEN &quot;gebietsArt&quot;= 2000 or &quot;gebietsArt&quot;= 17000 THEN 'Erhaltungsgebiet'||'&lt;/p>'|| '&lt;p>'||'Städtebauliche Gestalt' /* neuer Schlüssel mit V6*/&#xd;&#xa; WHEN &quot;gebietsArt&quot;= 2100 or &quot;gebietsArt&quot;= 17001 THEN 'Erhaltungsgebiet'||'&lt;/p>'|| '&lt;p>'||' Wohnbevoelkerung' /* neuer Schlüssel mit V6*/&#xd;&#xa; WHEN &quot;gebietsArt&quot;= 2200 or &quot;gebietsArt&quot;= 17002 THEN 'Erhaltungsgebiet'||'&lt;/p>'|| '&lt;p>'||' Umstrukturierung' /* neuer Schlüssel mit V6*/&#xd;&#xa; WHEN &quot;gebietsArt&quot;= 2300 THEN 'Städtebauliches'||'&lt;/p>'|| '&lt;p>'||'Entwicklungskonzept'||'&lt;/p>'|| '&lt;p>'||'Stärkung'||'&lt;/p>'|| '&lt;p>'||'Innenentwicklung' &#xd;&#xa; WHEN &quot;gebietsArt&quot;= 2400 THEN 'Gebiet '||'&lt;/p>'|| '&lt;p>'||'mit einem'||'&lt;/p>'|| '&lt;p>'||'angespannten'||'&lt;/p>'|| '&lt;p>'||'Wohnungsmarkt' &#xd;&#xa; WHEN &quot;gebietsArt&quot;= 9999 THEN 'Genehmigung'||'&lt;/p>'|| '&lt;p>'||'Wohnungseigentum' &#xd;&#xa; WHEN &quot;gebietsArt&quot;= 9999 THEN 'sonst.'||'&lt;/p>'|| '&lt;p>'||'Gebietstyp' &#xd;&#xa;ELSE '&lt;span style=&quot;color:#FF0000&quot;>'||'Gebietsart'||'&lt;/p>'|| '&lt;p>'||'nicht erfasst'||'&lt;/span>'&#xd;&#xa;END&#xd;&#xa;ELSE '' &#xd;&#xa;END  ||'&lt;/p>'&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa; " blendMode="0" fontWeight="50" multilineHeight="1" fontLetterSpacing="0" textOpacity="1" legendString="Aa" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" useSubstitutions="0" previewBkgrdColor="255,255,255,255" forcedBold="0" fontKerning="1" isExpression="1" namedStyle="Standard" fontSize="7" textOrientation="horizontal" textColor="50,50,50,255" allowHtml="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontWordSpacing="0" forcedItalic="0">
        <families/>
      ...
      <text-format formatNumbers="0" reverseDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" plussign="0" rightDirectionSymbol=">" leftDirectionSymbol="&lt;" decimals="3" placeDirectionSymbol="0" autoWrapLength="0" wrapChar="" multilineAlign="3" addDirectionSymbol="0"/>
      <placement repeatDistanceUnits="MM" placementFlags="10" overrunDistanceUnit="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" lineAnchorTextPoint="FollowPlacement" overrunDistance="0" allowDegraded="0" rotationAngle="0" geometryGeneratorType="PointGeometry" dist="0" fitInPolygonOnly="0" layerType="PolygonGeometry" lineAnchorPercent="0.5" quadOffset="4" overlapHandling="PreventOverlap" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationUnit="AngleDegrees" placement="0" centroidWhole="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="5" centroidInside="1" geometryGenerator="" offsetType="0" maxCurvedCharAngleOut="-25" yOffset="0" maxCurvedCharAngleIn="25" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" xOffset="0" offsetUnits="MM" repeatDistance="0" geometryGeneratorEnabled="0" polygonPlacementFlags="2" preserveRotation="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM"/>
      <rendering maxNumLabels="2000" minFeatureSize="0" scaleMax="8000" limitNumLabels="0" scaleMin="999" fontMinPixelSize="3" obstacleType="1" labelPerPart="0" mergeLines="0" zIndex="0" fontLimitPixelSize="0" unplacedVisibility="0" drawLabels="1" upsidedownLabels="0" obstacle="1" scaleVisibility="1" obstacleFactor="1" fontMaxPixelSize="10000"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties" type="Map">
            <Option name="PositionPoint" type="Map">
              ...
              <Option value="translate(&#xd;&#xa;closest_point(&#xd;&#xa;exterior_ring(&#xd;&#xa;buffer(&#xd;&#xa;var( 'vereinfacht_' +  plan_layer_id()) , @map_scale/30)),&#xd;&#xa;point_on_surface($geometry)&#xd;&#xa;), -@map_scale/90, 0)" name="expression" type="QString"/>
