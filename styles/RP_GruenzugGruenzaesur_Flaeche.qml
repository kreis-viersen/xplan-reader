...
<qgis version="3.28.3-Firenze" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 referencescale="-1" type="singleSymbol" forceraster="0" enableorderby="0" symbollevels="0">
    <symbols>
      <symbol force_rhr="0" clip_to_extent="1" frame_rate="10" type="fill" alpha="1" name="0" is_animated="0">
        ...
        <layer class="PointPatternFill" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" value="3" name="distance_x"/>
            ...
            <Option type="QString" value="701221454" name="seed"/>
          </Option>
          <data_defined_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
          ...
          <symbol force_rhr="0" clip_to_extent="1" frame_rate="10" type="marker" alpha="1" name="@0@0" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleMarker" enabled="1" locked="0" pass="0">
              <Option type="Map">
                ...
                <Option type="QString" value="0,109,0,255" name="color"/>
                ...
                <Option type="QString" value="0,109,0,255" name="outline_color"/>
        ...
        <layer class="SimpleLine" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="0,109,0,255" name="line_color"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement repeatDistance="0" offsetType="0" placement="0" offsetUnits="MM" overlapHandling="PreventOverlap" lineAnchorType="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorTextPoint="FollowPlacement" rotationAngle="0" centroidWhole="0" lineAnchorClipping="0" layerType="PolygonGeometry" geometryGeneratorType="PointGeometry" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="1" lineAnchorPercent="0.5" yOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" priority="5" overrunDistanceUnit="MM" allowDegraded="0" rotationUnit="AngleDegrees" fitInPolygonOnly="0" distUnits="MM" repeatDistanceUnits="MM" preserveRotation="1" xOffset="0" polygonPlacementFlags="2" geometryGeneratorEnabled="0" dist="0" quadOffset="4" maxCurvedCharAngleOut="-25" overrunDistance="0" placementFlags="10" maxCurvedCharAngleIn="25"/>
