...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling" version="3.26.3-Buenos Aires">
  <renderer-v2 enableorderby="0" symbollevels="0" type="singleSymbol" referencescale="-1" forceraster="0">
    <symbols>
      <symbol clip_to_extent="1" alpha="1" type="marker" force_rhr="0" name="0" frame_rate="10" is_animated="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format reverseDirectionSymbol="0" wrapChar="" placeDirectionSymbol="0" plussign="0" rightDirectionSymbol=">" useMaxLineLengthForAutoWrap="1" multilineAlign="3" autoWrapLength="30" decimals="3" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0"/>
      <placement fitInPolygonOnly="0" geometryGenerator="" preserveRotation="1" xOffset="1.2" repeatDistanceUnits="MM" overrunDistance="0" allowDegraded="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overlapHandling="PreventOverlap" maxCurvedCharAngleOut="-25" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" polygonPlacementFlags="2" quadOffset="5" rotationAngle="0" geometryGeneratorType="PointGeometry" placementFlags="10" layerType="PointGeometry" lineAnchorTextPoint="FollowPlacement" repeatDistance="0" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" lineAnchorPercent="0.5" yOffset="0" priority="5" lineAnchorClipping="0" offsetType="1" distUnits="MM" rotationUnit="AngleDegrees" lineAnchorType="0" maxCurvedCharAngleIn="25" placement="1" offsetUnits="RenderMetersInMapUnits"/>
      <rendering mergeLines="0" fontMaxPixelSize="10000" zIndex="0" drawLabels="1" fontLimitPixelSize="0" obstacleFactor="1" fontMinPixelSize="3" scaleMin="1" limitNumLabels="0" upsidedownLabels="0" labelPerPart="0" minFeatureSize="0" scaleMax="2001" unplacedVisibility="0" scaleVisibility="1" obstacleType="1" obstacle="1" maxNumLabels="2000"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
