...
<qgis labelsEnabled="1" version="3.26.3-Buenos Aires" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{a58ed13c-b3f3-46d4-8b28-fe1da1ead37e}">
      <rule symbol="0" key="{2b500b41-50a5-4807-8a7c-9a25696b750d}" scalemindenom="1" scalemaxdenom="10001"/>
    </rules>
    <symbols>
      <symbol type="fill" name="0" alpha="1" force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1">
        ...
        <layer class="MarkerLine" pass="0" locked="0" enabled="1">
          ...
          <symbol type="marker" name="@0@2" alpha="1" force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
