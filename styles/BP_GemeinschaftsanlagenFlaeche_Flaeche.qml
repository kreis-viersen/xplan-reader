...
<qgis version="3.26.3-Buenos Aires" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 symbollevels="0" type="RuleRenderer" forceraster="0" referencescale="-1" enableorderby="0">
    <rules key="{533c79a0-36da-484e-a3a7-07159875a2b5}">
      <rule label="Gemeinschaftliche Stellplätze" symbol="0" filter="try(&quot;zweckbestimmung&quot;=1000) or try(&quot;zweckbestimmung&quot;[0]=1000)" scalemaxdenom="2501" scalemindenom="1" key="{556d5595-d57e-4598-abaa-13754f788c95}"/>
      <rule label="Gemeinschaftsgaragen" symbol="1" filter="try(&quot;zweckbestimmung&quot;=2000) or try(&quot;zweckbestimmung&quot;[0]=2000)" scalemaxdenom="2501" scalemindenom="1" key="{e702a436-fac5-4e55-9c6e-c7188933f368}"/>
      <rule label="Spielplatz" symbol="2" filter="try(&quot;zweckbestimmung&quot;=3000) or try(&quot;zweckbestimmung&quot;[0]=3000)" scalemaxdenom="2501" scalemindenom="1" key="{bae1ce6a-b254-4be6-8942-848f459dea2f}"/>
      <rule label="Carport" symbol="3" filter="try(&quot;zweckbestimmung&quot;=3100) or try(&quot;zweckbestimmung&quot;[0]=3100)" scalemaxdenom="2501" scalemindenom="1" key="{8d4e9e4a-bd2d-4fa7-a93f-63949c20900e}"/>
      <rule label="Gemeinschaftstiefgarage" symbol="4" filter="try(&quot;zweckbestimmung&quot;=3200) or try(&quot;zweckbestimmung&quot;[0]=3200)" scalemaxdenom="2501" scalemindenom="1" key="{f68c18aa-c219-4879-b5de-94852b6a9bdd}"/>
      <rule label="Nebengebäude" symbol="5" filter="try(&quot;zweckbestimmung&quot;=3300) or try(&quot;zweckbestimmung&quot;[0]=3300)" scalemaxdenom="2501" scalemindenom="1" key="{dfd98a32-629b-4aa4-8546-1eaf36192368}"/>
      <rule label="AbfallSammelanlagen" symbol="6" filter="try(&quot;zweckbestimmung&quot;=3400) or try(&quot;zweckbestimmung&quot;[0]=3400)" scalemaxdenom="2501" scalemindenom="1" key="{b78c01ce-4bef-4b85-b830-a92108e622b2}"/>
      <rule label="Energie-Verteilungsanlagen" symbol="7" filter="try(&quot;zweckbestimmung&quot;=3500) or try(&quot;zweckbestimmung&quot;[0]=3500)" scalemaxdenom="2501" scalemindenom="1" key="{d734c051-4361-4fbb-aeae-8bac503be74a}"/>
      <rule label="Abfall-Wertstoffbehaelter" symbol="8" filter="try(&quot;zweckbestimmung&quot;=3600) or try(&quot;zweckbestimmung&quot;[0]=3600)" scalemaxdenom="2501" scalemindenom="1" key="{de03648d-9f79-4769-b298-988539e5be15}"/>
      <rule label="Freizeiteinrichtungen" symbol="9" filter="try(&quot;zweckbestimmung&quot;=3700) or try(&quot;zweckbestimmung&quot;[0]=37200)" scalemaxdenom="2501" scalemindenom="1" key="{f0724222-0437-4cfb-b51b-1574042651e9}"/>
      <rule label="Lärmschutzanlagen" symbol="10" filter="try(&quot;zweckbestimmung&quot;=3800) or try(&quot;zweckbestimmung&quot;[0]=3800)" scalemaxdenom="2501" scalemindenom="1" key="{fd0f9866-df83-423d-934c-6b6689d67132}"/>
      <rule label="Anlage Abwasser/Regenwasser" symbol="11" filter="try(&quot;zweckbestimmung&quot;=3900) or try(&quot;zweckbestimmung&quot;[0]=3900)" scalemaxdenom="2501" scalemindenom="1" key="{6d9322ea-2207-4db1-9ab1-2b8d342d5008}"/>
      <rule label="Ausgleichsmassnahmen" symbol="12" filter="try(&quot;zweckbestimmung&quot;=4000) or try(&quot;zweckbestimmung&quot;[0]=4000)" scalemaxdenom="2501" scalemindenom="1" key="{b3eba9aa-9774-4c95-b837-d3d10d1813e4}"/>
      <rule label="Fahrradstellplätze" symbol="13" filter="try(&quot;zweckbestimmung&quot;=4100) or try(&quot;zweckbestimmung&quot;[0]=4100)" scalemaxdenom="2501" scalemindenom="1" key="{ae140946-74ab-4048-b939-1cd26e392042}"/>
      <rule label="Gemeinschaftsdachgärten" symbol="14" filter="try(&quot;zweckbestimmung&quot;=4200) or try(&quot;zweckbestimmung&quot;[0]=4200)" scalemaxdenom="2501" scalemindenom="1" key="{7c3ae6f1-c36a-43ba-946c-4da03a3579f3}"/>
      <rule label="gemeinschaftlich nutzbare Dachflächen" symbol="15" filter="try(&quot;zweckbestimmung&quot;=4300) or try(&quot;zweckbestimmung&quot;[0]=4300)" scalemaxdenom="2501" scalemindenom="1" key="{c9815fcb-e345-4dbf-bf2f-aa9effaba068}"/>
      <rule label="Sonstige Zweckbestimmung" symbol="16" filter="try(&quot;zweckbestimmung&quot;=9999) or try(&quot;zweckbestimmung&quot;[0]=9999)" scalemaxdenom="2501" scalemindenom="1" key="{ea73f54a-21f9-47f1-9dbf-c78f0e2d5f4a}"/>
      <rule label="mehrere Zweckbestimmungen" symbol="17" filter="try(array_length (&quot;zweckbestimmung&quot;)>1)" key="{f6b4ef74-d302-4502-bddf-98d95f15ecd0}"/>
      <rule label="Zweckbestimmung nicht definiert" symbol="18" filter="try((array_length(&quot;zweckbestimmung&quot;)>0 and &quot;zweckbestimmung&quot;[0] is NULL)) or try(&quot;zweckbestimmung&quot; is NULL)" key="{f6e30fea-63f1-4942-8f9a-b4603a9a7772}"/>
    </rules>
    <symbols>
      ...
      <symbol frame_rate="10" force_rhr="0" type="fill" alpha="1" clip_to_extent="1" is_animated="0" name="18">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
    ...
    <rules key="{bce4175b-5f5d-40f7-9d2e-10fe3be7a992}">
      <rule scalemaxdenom="1001" scalemindenom="1" key="{0dbba8c5-0e79-4c50-89c9-af2e952e8bfe}">
        <settings calloutType="simple">
          ...
          <rendering unplacedVisibility="0" scaleMin="0" scaleMax="0" obstacleFactor="1" labelPerPart="0" obstacleType="1" zIndex="0" drawLabels="1" mergeLines="0" minFeatureSize="0" obstacle="1" fontMaxPixelSize="10000" fontLimitPixelSize="0" scaleVisibility="0" fontMinPixelSize="3" maxNumLabels="2000" limitNumLabels="0" upsidedownLabels="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
              <Option name="properties"/>
