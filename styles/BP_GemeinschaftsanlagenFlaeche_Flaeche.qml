...
<qgis styleCategories="Symbology|Labeling" version="3.26.3-Buenos Aires" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" forceraster="0" referencescale="-1" symbollevels="0" enableorderby="0">
    <rules key="{533c79a0-36da-484e-a3a7-07159875a2b5}">
      <rule filter="try(&quot;zweckbestimmung&quot;=1000) or try(&quot;zweckbestimmung&quot;[0]=1000)" symbol="0" label="Gemeinschaftliche Stellplätze" key="{556d5595-d57e-4598-abaa-13754f788c95}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=2000) or try(&quot;zweckbestimmung&quot;[0]=2000)" symbol="1" label="Gemeinschaftsgaragen" key="{e702a436-fac5-4e55-9c6e-c7188933f368}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=3000) or try(&quot;zweckbestimmung&quot;[0]=3000)" symbol="2" label="Spielplatz" key="{bae1ce6a-b254-4be6-8942-848f459dea2f}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=3100) or try(&quot;zweckbestimmung&quot;[0]=3100)" symbol="3" label="Carport" key="{8d4e9e4a-bd2d-4fa7-a93f-63949c20900e}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=3200) or try(&quot;zweckbestimmung&quot;[0]=3200)" symbol="4" label="Gemeinschaftstiefgarage" key="{f68c18aa-c219-4879-b5de-94852b6a9bdd}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=3300) or try(&quot;zweckbestimmung&quot;[0]=3300)" symbol="5" label="Nebengebäude" key="{dfd98a32-629b-4aa4-8546-1eaf36192368}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=3400) or try(&quot;zweckbestimmung&quot;[0]=3400)" symbol="6" label="AbfallSammelanlagen" key="{b78c01ce-4bef-4b85-b830-a92108e622b2}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=3500) or try(&quot;zweckbestimmung&quot;[0]=3500)" symbol="7" label="Energie-Verteilungsanlagen" key="{d734c051-4361-4fbb-aeae-8bac503be74a}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=3600) or try(&quot;zweckbestimmung&quot;[0]=3600)" symbol="8" label="Abfall-Wertstoffbehaelter" key="{de03648d-9f79-4769-b298-988539e5be15}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=3700) or try(&quot;zweckbestimmung&quot;[0]=37200)" symbol="9" label="Freizeiteinrichtungen" key="{f0724222-0437-4cfb-b51b-1574042651e9}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=3800) or try(&quot;zweckbestimmung&quot;[0]=3800)" symbol="10" label="Lärmschutzanlagen" key="{fd0f9866-df83-423d-934c-6b6689d67132}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=3900) or try(&quot;zweckbestimmung&quot;[0]=3900)" symbol="11" label="Anlage Abwasser/Regenwasser" key="{6d9322ea-2207-4db1-9ab1-2b8d342d5008}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=4000) or try(&quot;zweckbestimmung&quot;[0]=4000)" symbol="12" label="Ausgleichsmassnahmen" key="{b3eba9aa-9774-4c95-b837-d3d10d1813e4}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=4100) or try(&quot;zweckbestimmung&quot;[0]=4100)" symbol="13" label="Fahrradstellplätze" key="{ae140946-74ab-4048-b939-1cd26e392042}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=4200) or try(&quot;zweckbestimmung&quot;[0]=4200)" symbol="14" label="Gemeinschaftsdachgärten" key="{7c3ae6f1-c36a-43ba-946c-4da03a3579f3}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=4300) or try(&quot;zweckbestimmung&quot;[0]=4300)" symbol="15" label="gemeinschaftlich nutzbare Dachflächen" key="{c9815fcb-e345-4dbf-bf2f-aa9effaba068}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=9999) or try(&quot;zweckbestimmung&quot;[0]=9999)" symbol="16" label="Sonstige Zweckbestimmung" key="{ea73f54a-21f9-47f1-9dbf-c78f0e2d5f4a}" scalemindenom="1" scalemaxdenom="2501"/>
      <rule filter="try(array_length (&quot;zweckbestimmung&quot;)>1)" symbol="17" label="mehrere Zweckbestimmungen" key="{f6b4ef74-d302-4502-bddf-98d95f15ecd0}"/>
      <rule filter="try((array_length(&quot;zweckbestimmung&quot;)>0 and &quot;zweckbestimmung&quot;[0] is NULL)) or try(&quot;zweckbestimmung&quot; is NULL)" symbol="18" label="Zweckbestimmung nicht definiert" key="{f6e30fea-63f1-4942-8f9a-b4603a9a7772}"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0" is_animated="0" frame_rate="10" force_rhr="0">
        ...
        <layer locked="0" pass="0" enabled="1" class="SimpleLine">
          <Option type="Map">
            ...
            <Option value="2.5;2.5" type="QString" name="customdash"/>
            ...
            <Option value="253,52,31,255" type="QString" name="line_color"/>
          ...
          <prop v="253,52,31,255" k="line_color"/>
