...
<qgis minScale="10000" simplifyMaxScale="1" labelsEnabled="0" symbologyReferenceScale="-1" readOnly="0" maxScale="0" simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyLocal="1" hasScaleBasedVisibilityFlag="1" version="3.24.2-Tisler" styleCategories="AllStyleCategories">
    ...
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" name="0" alpha="1" type="line">
        ...
        <layer enabled="1" pass="0" locked="0" class="SimpleLine">
          ...
          <prop k="line_color" v="0,123,206,255"/>
  ...
  <DiagramLayerSettings priority="0" zIndex="0" showAll="1" obstacle="0" dist="0" placement="2" linePlacementFlags="18">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="sonstRechtscharakterCode">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="gehoertZuSO_Bereich">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="artDerFestlegungCode">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="detailArtDerFestlegungCode">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="20" field="startBedingung" name=""/>
    <alias index="21" field="endeBedingung" name=""/>
    <alias index="22" field="ebene" name=""/>
    <alias index="23" field="rechtsverbindlich" name=""/>
    <alias index="24" field="informell" name=""/>
    <alias index="25" field="hatGenerAttribut" name=""/>
    <alias index="26" field="hoehenangabe" name=""/>
    <alias index="27" field="externeReferenz" name=""/>
    <alias index="28" field="gehoertNachrichtlichZuBereich" name=""/>
    <alias index="29" field="gehoertZuBereich" name=""/>
    <alias index="30" field="wirdDargestelltDurch" name=""/>
    <alias index="31" field="rechtscharakter" name=""/>
    <alias index="32" field="rechtscharakterCode" name=""/>
    <alias index="33" field="sonstRechtscharakter" name=""/>
    <alias index="34" field="sonstRechtscharakterCode" name=""/>
    <alias index="35" field="gehoertZuSO_Bereich" name=""/>
    <alias index="36" field="flaechenschluss" name=""/>
    <alias index="37" field="flussrichtung" name=""/>
    <alias index="38" field="nordwinkel" name=""/>
    <alias index="39" field="nordwinkelUOM" name=""/>
    <alias index="40" field="artDerFestlegung" name=""/>
    <alias index="41" field="artDerFestlegungCode" name=""/>
    <alias index="42" field="detailArtDerFestlegung" name=""/>
    <alias index="43" field="detailArtDerFestlegungCode" name=""/>
    <alias index="44" field="istNatuerlichesUberschwemmungsgebiet" name=""/>
    <alias index="45" field="name" name=""/>
    <alias index="46" field="nummer" name=""/>
    <alias index="47" field="aufschrift" name=""/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" field="sonstRechtscharakterCode" expression=""/>
    <default applyOnUpdate="0" field="gehoertZuSO_Bereich" expression=""/>
    ...
    <default applyOnUpdate="0" field="artDerFestlegungCode" expression=""/>
    <default applyOnUpdate="0" field="detailArtDerFestlegung" expression=""/>
    <default applyOnUpdate="0" field="detailArtDerFestlegungCode" expression=""/>
    <default applyOnUpdate="0" field="istNatuerlichesUberschwemmungsgebiet" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" field="sonstRechtscharakter" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="sonstRechtscharakterCode" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="gehoertZuSO_Bereich" unique_strength="0" notnull_strength="0"/>
    ...
    <constraint exp_strength="0" constraints="0" field="artDerFestlegung" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="artDerFestlegungCode" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="detailArtDerFestlegung" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="detailArtDerFestlegungCode" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="istNatuerlichesUberschwemmungsgebiet" unique_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="sonstRechtscharakterCode" desc=""/>
    <constraint exp="" field="gehoertZuSO_Bereich" desc=""/>
    ...
    <constraint exp="" field="artDerFestlegungCode" desc=""/>
    <constraint exp="" field="detailArtDerFestlegung" desc=""/>
    <constraint exp="" field="detailArtDerFestlegungCode" desc=""/>
    <constraint exp="" field="istNatuerlichesUberschwemmungsgebiet" desc=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" hidden="0" name="sonstRechtscharakter" type="field"/>
      <column width="-1" hidden="0" name="sonstRechtscharakterCode" type="field"/>
      <column width="-1" hidden="0" name="gehoertZuSO_Bereich" type="field"/>
      ...
      <column width="-1" hidden="0" name="artDerFestlegung" type="field"/>
      <column width="-1" hidden="0" name="artDerFestlegungCode" type="field"/>
      <column width="-1" hidden="0" name="detailArtDerFestlegung" type="field"/>
      <column width="-1" hidden="0" name="detailArtDerFestlegungCode" type="field"/>
      <column width="-1" hidden="0" name="istNatuerlichesUberschwemmungsgebiet" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="gehoertZuSO_Bereich"/>
    ...
    <field editable="1" name="istNatuerlichesUberschwemmungsgebiet"/>
    ...
    <field editable="1" name="sonstRechtscharakterCode"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="artDerFestlegungCode"/>
    ...
    <field labelOnTop="0" name="detailArtDerFestlegungCode"/>
    ...
    <field labelOnTop="0" name="gehoertZuSO_Bereich"/>
    ...
    <field labelOnTop="0" name="istNatuerlichesUberschwemmungsgebiet"/>
    ...
    <field labelOnTop="0" name="sonstRechtscharakterCode"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="artDerFestlegungCode"/>
    ...
    <field reuseLastValue="0" name="detailArtDerFestlegungCode"/>
    ...
    <field reuseLastValue="0" name="gehoertZuSO_Bereich"/>
    ...
    <field reuseLastValue="0" name="istNatuerlichesUberschwemmungsgebiet"/>
    ...
    <field reuseLastValue="0" name="sonstRechtscharakterCode"/>
