...
<qgis styleCategories="Symbology|Labeling" version="3.26.3-Buenos Aires" labelsEnabled="1">
  <renderer-v2 type="singleSymbol" forceraster="0" referencescale="-1" symbollevels="0" enableorderby="0">
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0" is_animated="0" frame_rate="10" force_rhr="0">
        ...
        <layer locked="0" pass="0" enabled="1" class="SimpleLine">
          <Option type="Map">
            ...
            <Option value="0,123,206,255" type="QString" name="line_color"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format multilineAlign="0" leftDirectionSymbol="&lt;" reverseDirectionSymbol="0" formatNumbers="0" rightDirectionSymbol=">" autoWrapLength="0" decimals="3" addDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" plussign="0" wrapChar="" placeDirectionSymbol="0"/>
      <placement rotationAngle="0" centroidInside="0" xOffset="0" distUnits="MM" fitInPolygonOnly="0" placementFlags="9" priority="5" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" geometryGeneratorType="PointGeometry" maxCurvedCharAngleOut="-25" centroidWhole="0" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" overrunDistance="0" offsetType="0" rotationUnit="AngleDegrees" preserveRotation="1" offsetUnits="MM" geometryGeneratorEnabled="0" placement="3" lineAnchorTextPoint="FollowPlacement" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" overlapHandling="PreventOverlap" repeatDistance="0" lineAnchorPercent="0.5" layerType="LineGeometry" lineAnchorClipping="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" quadOffset="4" polygonPlacementFlags="2" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" allowDegraded="0"/>
      <rendering obstacle="1" zIndex="0" obstacleType="1" fontMinPixelSize="3" unplacedVisibility="0" mergeLines="0" labelPerPart="0" maxNumLabels="2000" obstacleFactor="1" fontMaxPixelSize="10000" minFeatureSize="0" scaleVisibility="1" upsidedownLabels="0" drawLabels="1" scaleMax="4001" limitNumLabels="0" fontLimitPixelSize="0" scaleMin="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
