...
<qgis minScale="25000" simplifyMaxScale="1" labelsEnabled="0" symbologyReferenceScale="-1" readOnly="0" maxScale="1" simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyLocal="1" hasScaleBasedVisibilityFlag="1" version="3.24.2-Tisler" styleCategories="AllStyleCategories">
  <flags>
  ...
  <aliases>
    ...
    <alias index="26" field="gehoertZuBereich" name=""/>
    <alias index="27" field="wirdDargestelltDurch" name=""/>
    <alias index="28" field="rechtscharakter" name=""/>
    <alias index="29" field="rechtscharakterCode" name=""/>
    <alias index="30" field="sonstRechtscharakter" name=""/>
    <alias index="31" field="sonstRechtscharakterCode" name=""/>
    <alias index="32" field="flaechenschluss" name=""/>
    <alias index="33" field="flussrichtung" name=""/>
    <alias index="34" field="nordwinkel" name=""/>
    <alias index="35" field="nordwinkelUOM" name=""/>
    <alias index="36" field="artDerFestlegung" name=""/>
    <alias index="37" field="artDerFestlegungCode" name=""/>
    <alias index="38" field="detailArtDerFestlegung" name=""/>
    <alias index="39" field="detailArtDerFestlegungCode" name=""/>
    <alias index="40" field="name" name=""/>
    <alias index="41" field="nummer" name=""/>
    <alias index="42" field="aufschrift" name=""/>
  </aliases>
  <defaults>
  ...
  <attributetableconfig sortOrder="1" sortExpression="&quot;artDerFestlegung&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="165" hidden="0" name="artDerFestlegung" type="field"/>
