...
<qgis version="3.28.3-Firenze" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" forceraster="0" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{aa942b76-5bc9-4bd6-b3e4-9327eebd4754}">
      <rule key="{a7cf58d0-67a3-47fa-96b1-d44488433b78}" symbol="0"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" name="0" frame_rate="10" alpha="1" type="line" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" pass="0" locked="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option value="0.5" name="trim_distance_end" type="QString"/>
            <Option value="3x:0,0,0,0,0,0" name="trim_distance_end_map_unit_scale" type="QString"/>
            <Option value="RenderMetersInMapUnits" name="trim_distance_end_unit" type="QString"/>
            <Option value="0.5" name="trim_distance_start" type="QString"/>
        ...
        <layer enabled="1" pass="0" locked="0" class="MarkerLine">
          ...
          <symbol clip_to_extent="1" name="@0@1" frame_rate="10" alpha="1" type="marker" force_rhr="0" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" locked="0" class="MarkerLine">
          ...
          <symbol clip_to_extent="1" name="@0@2" frame_rate="10" alpha="1" type="marker" force_rhr="0" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style previewBkgrdColor="255,255,255,255" fontLetterSpacing="0" multilineHeightUnit="Percentage" fieldName="wert" isExpression="0" textOrientation="horizontal" legendString="Aa" fontStrikeout="0" fontFamily="Arial" fontWordSpacing="0" allowHtml="0" fontSize="8" fontUnderline="0" fontItalic="0" blendMode="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" textColor="50,50,50,255" capitalization="0" fontSizeUnit="Point" forcedItalic="0" textOpacity="1" namedStyle="Standard" fontWeight="50" forcedBold="0" fontKerning="1">
        <families/>
        <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSizeUnits="Percentage" bufferColor="250,250,250,255" bufferOpacity="1" bufferJoinStyle="128" bufferNoFill="1" bufferDraw="1" bufferSize="30"/>
        <text-mask maskType="0" maskOpacity="1" maskEnabled="0" maskSize="30" maskJoinStyle="128" maskedSymbolLayers="" maskSizeUnits="Percentage" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <text-format reverseDirectionSymbol="0" wrapChar="" addDirectionSymbol="0" autoWrapLength="0" plussign="0" rightDirectionSymbol=">" leftDirectionSymbol="&lt;" multilineAlign="0" formatNumbers="0" placeDirectionSymbol="0" decimals="3" useMaxLineLengthForAutoWrap="1"/>
      <placement overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" centroidInside="0" offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" offsetUnits="MM" quadOffset="4" lineAnchorTextPoint="FollowPlacement" dist="0" lineAnchorClipping="0" geometryGeneratorType="PointGeometry" overrunDistance="0" maxCurvedCharAngleIn="25" allowDegraded="0" rotationAngle="0" geometryGeneratorEnabled="0" distMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" centroidWhole="0" polygonPlacementFlags="2" lineAnchorType="0" priority="5" repeatDistance="0" preserveRotation="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationUnit="AngleDegrees" yOffset="0" layerType="LineGeometry" overlapHandling="PreventOverlap" xOffset="0" placement="3" fitInPolygonOnly="0" lineAnchorPercent="0.5"/>
      <rendering obstacleFactor="1" obstacleType="1" unplacedVisibility="0" fontLimitPixelSize="0" fontMaxPixelSize="10000" fontMinPixelSize="3" zIndex="0" labelPerPart="0" limitNumLabels="0" minFeatureSize="0" obstacle="1" scaleMax="0" mergeLines="0" scaleVisibility="0" maxNumLabels="2000" drawLabels="1" upsidedownLabels="0" scaleMin="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
