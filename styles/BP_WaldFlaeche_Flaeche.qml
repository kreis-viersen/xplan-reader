...
<qgis labelsEnabled="1" version="3.32.3-Lima" styleCategories="Symbology|Labeling|MapTips">
  <renderer-v2 forceraster="0" referencescale="-1" enableorderby="0" type="RuleRenderer" symbollevels="0">
    <rules key="{62a6a4f4-713b-44b0-801a-061c788e0635}">
      <rule symbol="0" key="{f1c6078f-c201-4c66-bc73-be57bb0b3914}"/>
    </rules>
    <symbols>
      <symbol name="0" frame_rate="10" is_animated="0" alpha="1" type="fill" force_rhr="0" clip_to_extent="1">
        ...
        <layer class="SimpleFill" pass="0" enabled="1" locked="0" id="{d4316d8f-6b1f-44cb-803b-16c7ffdb447a}">
          <Option type="Map">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement rotationUnit="AngleDegrees" lineAnchorClipping="0" maxCurvedCharAngleOut="-25" dist="0" centroidWhole="0" placement="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" layerType="PolygonGeometry" xOffset="0" geometryGeneratorEnabled="0" lineAnchorTextPoint="FollowPlacement" offsetUnits="MM" rotationAngle="0" offsetType="0" distUnits="MM" allowDegraded="0" yOffset="0" maxCurvedCharAngleIn="25" lineAnchorPercent="0.5" overrunDistance="0" repeatDistanceUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidInside="0" repeatDistance="0" preserveRotation="1" overlapHandling="PreventOverlap" geometryGenerator="" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" geometryGeneratorType="PointGeometry" polygonPlacementFlags="2" fitInPolygonOnly="0" priority="5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
