...
<qgis labelsEnabled="1" version="3.32.3-Lima" styleCategories="Symbology|Labeling|MapTips">
  <renderer-v2 forceraster="0" referencescale="-1" enableorderby="0" type="singleSymbol" symbollevels="0">
    <symbols>
      <symbol name="0" frame_rate="10" is_animated="0" alpha="1" type="line" force_rhr="0" clip_to_extent="1">
        ...
        <layer class="SimpleLine" pass="0" enabled="1" locked="0" id="{7ae1584d-1094-4ab7-941f-a2006d2d2b38}">
          <Option type="Map">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOpacity="1" blendMode="0" legendString="Aa" fontWordSpacing="0" namedStyle="Standard" previewBkgrdColor="255,255,255,255" capitalization="0" fontFamily="Arial" fontItalic="0" forcedItalic="0" useSubstitutions="0" fieldName="'SO_SchutzgebietWasserrecht als Linie ungeeignet'" fontSize="8" fontLetterSpacing="0" multilineHeightUnit="Percentage" fontUnderline="0" allowHtml="0" forcedBold="0" textOrientation="horizontal" textColor="255,0,0,255" fontKerning="1" isExpression="1" fontStrikeout="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWeight="50" fontSizeUnit="Point">
        <families/>
