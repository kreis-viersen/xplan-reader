...
<qgis version="3.36.3-Maidenhead" labelsEnabled="1" styleCategories="Symbology|Labeling|MapTips">
  <renderer-v2 enableorderby="0" referencescale="-1" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{e7a458f1-32dd-429b-bd2d-3cb98343b589}">
      ...
      <rule key="{220def19-7718-4258-8802-7854cdcdae2d}" filter="try(array_length(&quot;zweckbestimmung&quot;) >1) or try(array_length(&quot;allgemein&quot;) >1)" symbol="1" label="davon mehrere Zweckbestimmungen"/>
      <rule key="{4bdb96bf-7b49-4004-b609-a7ef54743136}" filter="&quot;zweckbestimmung&quot; is null and &quot;allgemein&quot; is null" checkstate="0" symbol="2" label="davon keine Zweckbestimmung"/>
    </rules>
    <symbols>
      ...
      <symbol is_animated="0" name="2" frame_rate="10" type="fill" force_rhr="0" clip_to_extent="1" alpha="1">
        ...
        <layer enabled="1" id="{c645f8d9-054c-48bd-9fbf-89ab9f4dcfca}" class="SimpleFill" pass="0" locked="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" name="" frame_rate="10" type="fill" force_rhr="0" clip_to_extent="1" alpha="1">
        ...
        <layer enabled="1" id="{7a00c947-7b5f-463e-a9d8-dddb38a4fa7e}" class="SimpleFill" pass="0" locked="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
