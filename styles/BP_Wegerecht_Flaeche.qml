...
<qgis version="3.28.4-Firenze" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 symbollevels="0" type="RuleRenderer" forceraster="0" referencescale="-1" enableorderby="0">
    <rules key="{69c904ba-2bbf-4a02-bc76-87b109cfb1aa}">
      <rule filter="try(&quot;typ&quot;=1000)or (try(&quot;typ&quot;[0]=1000)and try(array_length(&quot;typ&quot;)=1))" symbol="0" label="Gehrecht" key="{91a1e01b-6577-4932-b9a3-f2c233e7cca1}"/>
      <rule filter="try(&quot;typ&quot;=2000)or (try(&quot;typ&quot;[0]=2000)and try(array_length(&quot;typ&quot;)=1))" symbol="1" label="Fahrrecht" key="{a0b8a704-3c44-4850-b417-7b66e5158491}"/>
      <rule filter="try(&quot;typ&quot;=2500)or (try(&quot;typ&quot;[0]=2500)and try(array_length(&quot;typ&quot;)=1))" symbol="2" label="Radfahrrecht" key="{5f822429-17bf-4014-968f-c3828aceabec}"/>
      <rule filter="try(&quot;typ&quot;=4000)or (try(&quot;typ&quot;[0]=4000)and try(array_length(&quot;typ&quot;)=1))" symbol="3" label="Leitungsrecht" key="{c59dff90-ccba-46c9-8146-a8295f3b746b}"/>
      <rule filter="try(&quot;typ&quot; = 3000) or try(&quot;typ&quot;[0]=3000) or try(&quot;typ&quot; = 10002000)or try(&quot;typ&quot;= array(1000, 2000) )or try(&quot;typ&quot;= array(2000, 1000) )" symbol="4" label="GehFahrrecht" key="{7ef9f9b1-57a2-4fd0-8cec-096c7d400554}"/>
      <rule filter="try(&quot;typ&quot; = 4100) or try(&quot;typ&quot;[0]=3000) or try(&quot;typ&quot; = 10004000)or try(&quot;typ&quot;= array(1000, 4000) )or try(&quot;typ&quot;= array(4000, 1000) )" symbol="5" label="GehLeitungsrecht" key="{d2b55b89-3264-4338-b6b8-22f6c143341b}"/>
      <rule filter="try(&quot;typ&quot; = 4200) or try(&quot;typ&quot;[0]=4200) or try(&quot;typ&quot; = 20004000)or try(&quot;typ&quot;= array(2000, 4000) )or try(&quot;typ&quot;= array(4000, 2000) )" symbol="6" label="FahrLeitungsrecht" key="{1dcb8d8a-99a6-40a6-96a8-c5d941b7f976}"/>
      <rule filter="try(&quot;typ&quot; = 5000) or try(&quot;typ&quot;[0]=5000) or try(&quot;typ&quot; = 100020004000) or try(&quot;typ&quot;= array(1000, 2000, 4000)) or try(&quot;typ&quot;= array(1000, 4000, 2000)) or try(&quot;typ&quot;= array(2000, 1000, 4000)) or try(&quot;typ&quot;= array(2000, 4000, 1000)) or try(&quot;typ&quot;= array(4000, 1000, 2000)) or try(&quot;typ&quot;= array(4000, 2000, 1000))" symbol="7" label="GehFahrLeitungsrecht" key="{f00478c7-0f09-4901-b3cc-28ec5c28e7ad}"/>
      <rule filter="try(&quot;typ&quot; = 9999) or try(&quot;typ&quot;[0]=9999)" symbol="8" label="sonst.Nutzungsrecht" key="{69c845d2-9e91-43cf-857b-663ba22c8925}"/>
      <rule filter="try(&quot;typ&quot; is NULL) or try(&quot;typ&quot;[0] is NULL)" symbol="9" label="Typ nicht definiert" key="{ee18483e-5939-4562-b1c0-264d022c6c1e}"/>
    </rules>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <rendering obstacle="1" fontLimitPixelSize="0" scaleMax="125" obstacleType="1" zIndex="0" drawLabels="1" obstacleFactor="1" mergeLines="0" fontMinPixelSize="3" unplacedVisibility="0" scaleVisibility="1" maxNumLabels="2000" fontMaxPixelSize="10000" upsidedownLabels="0" minFeatureSize="0" limitNumLabels="0" scaleMin="0" labelPerPart="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
