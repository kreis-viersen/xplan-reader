...
<qgis styleCategories="Symbology|Labeling|MapTips" labelsEnabled="1" version="3.44.3-Solothurn">
  <renderer-v2 referencescale="-1" type="RuleRenderer" forceraster="0" symbollevels="0" enableorderby="0">
    ...
    <symbols>
      <symbol is_animated="0" alpha="1" clip_to_extent="1" type="fill" name="0" frame_rate="10" force_rhr="0">
        ...
        <layer class="SimpleFill" locked="0" pass="0" id="{a3cb7390-de49-4f70-9fbe-cec3c4664ea7}" enabled="1">
          <Option type="Map">
        ...
        <layer class="SimpleLine" locked="0" pass="0" id="{3d1e03a4-7c72-4111-a1de-3c8d860d49bc}" enabled="1">
          <Option type="Map">
      ...
      <symbol is_animated="0" alpha="1" clip_to_extent="1" type="fill" name="10" frame_rate="10" force_rhr="0">
        ...
        <layer class="SimpleFill" locked="0" pass="0" id="{ae3adc0d-1b6c-4eb4-9974-bf2a7a1159f9}" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" alpha="1" clip_to_extent="1" type="fill" name="" frame_rate="10" force_rhr="0">
        ...
        <layer class="SimpleFill" locked="0" pass="0" id="{ffa50ad7-1dfd-4a33-a223-11d20d063cdc}" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement centroidWhole="0" lineAnchorClipping="0" placementFlags="10" overrunDistance="0" offsetUnits="MM" dist="0" offsetType="0" geometryGeneratorEnabled="0" maxCurvedCharAngleIn="25" distMapUnitScale="3x:0,0,0,0,0,0" maximumDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" fitInPolygonOnly="0" centroidInside="1" quadOffset="4" lineAnchorType="0" lineAnchorPercent="0.5" lineAnchorTextPoint="FollowPlacement" xOffset="0" rotationUnit="AngleDegrees" repeatDistance="0" allowDegraded="0" overrunDistanceUnit="MM" layerType="PolygonGeometry" rotationAngle="0" distUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maximumDistanceUnit="MM" maxCurvedCharAngleOut="-25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="0" overlapHandling="PreventOverlap" yOffset="0" polygonPlacementFlags="2" priority="5" geometryGeneratorType="PointGeometry" maximumDistance="0" preserveRotation="1" prioritization="PreferCloser"/>
      <rendering zIndex="0" obstacleFactor="1" scaleMax="126" fontLimitPixelSize="0" minFeatureSize="0" mergeLines="0" fontMaxPixelSize="10000" maxNumLabels="2000" limitNumLabels="0" upsidedownLabels="0" labelPerPart="0" scaleMin="0" scaleVisibility="1" obstacleType="1" obstacle="1" fontMinPixelSize="3" drawLabels="1" unplacedVisibility="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
