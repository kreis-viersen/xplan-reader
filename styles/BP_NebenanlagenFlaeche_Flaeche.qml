...
<qgis styleCategories="Symbology|Labeling|MapTips" labelsEnabled="1" version="3.44.3-Solothurn">
  <renderer-v2 referencescale="-1" type="RuleRenderer" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{9dfc0a75-d9c0-4cad-b3f9-ce088dd71470}">
      ...
      <rule symbol="1" filter="try(&quot;zweckbestimmung&quot; is NULL) and  try(&quot;zweckbestimmung&quot;[0] is NULL) and try(&quot;allgemein&quot; is NULL) and  try(&quot;allgemein&quot;[0] is NULL)" label="davon Zweckbestimmung nicht definiert" key="{04f96f79-168b-4540-b61a-6cd55918c80e}"/>
    </rules>
    <symbols>
      <symbol is_animated="0" alpha="1" clip_to_extent="1" type="fill" name="0" frame_rate="10" force_rhr="0">
        ...
        <layer class="SimpleLine" locked="0" pass="0" id="{3a6ba5da-ca3a-4a37-83f5-ab1e47dc0c9a}" enabled="1">
          <Option type="Map">
      ...
      <symbol is_animated="0" alpha="1" clip_to_extent="1" type="fill" name="1" frame_rate="10" force_rhr="0">
        ...
        <layer class="SimpleFill" locked="0" pass="0" id="{a8c565e9-184e-4ee5-aff7-5862f779cd4f}" enabled="1">
          <Option type="Map">
            ...
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
            <Option value="128,14,16,255,rgb:0.5019608,0.054902,0.0627451,1" type="QString" name="outline_color"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" alpha="1" clip_to_extent="1" type="fill" name="" frame_rate="10" force_rhr="0">
        ...
        <layer class="SimpleFill" locked="0" pass="0" id="{0906f755-31f0-4023-922a-ebfbb74a5b0e}" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
