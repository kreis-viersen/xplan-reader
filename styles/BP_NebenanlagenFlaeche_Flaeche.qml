...
<qgis version="3.32.3-Lima" labelsEnabled="1" styleCategories="Symbology|Labeling|MapTips">
  <renderer-v2 referencescale="-1" type="RuleRenderer" enableorderby="0" forceraster="0" symbollevels="0">
    <rules key="{9dfc0a75-d9c0-4cad-b3f9-ce088dd71470}">
      ...
      <rule symbol="1" label="davon Zweckbestimmung nicht definiert" filter="try(&quot;zweckbestimmung&quot; is NULL) and  try(&quot;zweckbestimmung&quot;[0] is NULL) and try(&quot;allgemein&quot; is NULL) and  try(&quot;allgemein&quot;[0] is NULL)" key="{04f96f79-168b-4540-b61a-6cd55918c80e}"/>
    </rules>
    <symbols>
      <symbol is_animated="0" force_rhr="0" name="0" clip_to_extent="1" frame_rate="10" type="fill" alpha="1">
        ...
        <layer enabled="1" pass="0" locked="0" class="SimpleLine" id="{3a6ba5da-ca3a-4a37-83f5-ab1e47dc0c9a}">
          <Option type="Map">
      ...
      <symbol is_animated="0" force_rhr="0" name="1" clip_to_extent="1" frame_rate="10" type="fill" alpha="1">
        ...
        <layer enabled="1" pass="0" locked="0" class="SimpleFill" id="{a8c565e9-184e-4ee5-aff7-5862f779cd4f}">
          <Option type="Map">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" reverseDirectionSymbol="0" placeDirectionSymbol="0" plussign="0" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" multilineAlign="0" wrapChar="" decimals="3" autoWrapLength="0"/>
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleOut="-25" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" dist="0" overlapHandling="PreventOverlap" geometryGeneratorType="PointGeometry" geometryGeneratorEnabled="0" xOffset="0" quadOffset="4" placement="0" centroidWhole="0" fitInPolygonOnly="0" geometryGenerator="" repeatDistanceUnits="MM" preserveRotation="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorTextPoint="FollowPlacement" lineAnchorType="0" offsetType="0" layerType="PolygonGeometry" yOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="5" centroidInside="1" lineAnchorClipping="0" repeatDistance="0" overrunDistanceUnit="MM" placementFlags="10" offsetUnits="MM" allowDegraded="0" rotationAngle="0" distUnits="MM" overrunDistance="0" distMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" lineAnchorPercent="0.5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
      <rendering unplacedVisibility="0" drawLabels="1" fontLimitPixelSize="0" minFeatureSize="0" obstacleFactor="1" fontMaxPixelSize="10000" mergeLines="0" obstacleType="1" upsidedownLabels="0" fontMinPixelSize="3" obstacle="1" scaleMax="501" labelPerPart="0" maxNumLabels="2000" scaleMin="0" zIndex="0" limitNumLabels="0" scaleVisibility="1"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties"/>
