...
<qgis simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="1" simplifyLocal="1" symbologyReferenceScale="-1" simplifyDrawingHints="1" readOnly="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="0" version="3.36.1-Maidenhead" hasScaleBasedVisibilityFlag="0" maxScale="0">
  <flags>
  ...
  <temporal enabled="0" endExpression="" mode="0" durationField="ebene" durationUnit="min" endField="" startExpression="" startField="" limitMode="0" fixedDuration="0" accumulate="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation zscale="1" type="IndividualFeatures" showMarkerSymbolInSurfacePlots="0" extrusionEnabled="0" extrusion="0" zoffset="0" respectLayerSymbol="1" clamping="Terrain" binding="Centroid" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" type="line" name="" force_rhr="0" alpha="1">
        ...
        <layer pass="0" enabled="1" class="SimpleLine" locked="0" id="{1b2ae96d-af78-43fb-a442-952e6d3abc20}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" type="fill" name="" force_rhr="0" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="SimpleFill" locked="0" id="{63621017-9a44-44f5-a2cf-d42e141dff82}">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" type="marker" name="" force_rhr="0" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="SimpleMarker" locked="0" id="{2a772c77-39ff-4484-81c5-603371c71d2a}">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" symbollevels="0" enableorderby="0">
    <rules key="{9dfc0a75-d9c0-4cad-b3f9-ce088dd71470}">
      ...
      <rule symbol="1" label="davon Zweckbestimmung nicht definiert" key="{04f96f79-168b-4540-b61a-6cd55918c80e}" filter="try(&quot;zweckbestimmung&quot; is NULL) and  try(&quot;zweckbestimmung&quot;[0] is NULL) and try(&quot;allgemein&quot; is NULL) and  try(&quot;allgemein&quot;[0] is NULL)"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" type="fill" name="0" force_rhr="0" alpha="1">
        ...
        <layer pass="0" enabled="1" class="SimpleLine" locked="0" id="{3a6ba5da-ca3a-4a37-83f5-ab1e47dc0c9a}">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" type="fill" name="1" force_rhr="0" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="SimpleFill" locked="0" id="{a8c565e9-184e-4ee5-aff7-5862f779cd4f}">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
            ...
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
            <Option type="QString" value="128,14,16,255,rgb:0.50196078431372548,0.05490196078431372,0.06274509803921569,1" name="outline_color"/>
            <Option type="QString" value="solid" name="outline_style"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" type="fill" name="" force_rhr="0" alpha="1">
        ...
        <layer pass="0" enabled="1" class="SimpleFill" locked="0" id="{0906f755-31f0-4023-922a-ebfbb74a5b0e}">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontWeight="50" textOrientation="horizontal" forcedItalic="0" forcedBold="0" capitalization="0" fontKerning="1" textColor="255,0,0,255,rgb:1,0,0,1" fieldName="replace(&#xd;&#xa;case when try(&quot;zweckbestimmung&quot; is not NULL)then array_to_string(array_foreach(case when try  (array_length(&quot;zweckbestimmung&quot;)  >= 0) then &quot;zweckbestimmung&quot;&#xd;&#xa; Else array(&quot;zweckbestimmung&quot;) end , &#xd;&#xa;case&#xd;&#xa;&#xd;&#xa;when @element=1000 then '\nStellpl.'&#xd;&#xa;when @element=2000 then '\nGa'&#xd;&#xa;when @element=3000 then '\nSpielplatz'&#xd;&#xa;when @element=3100 then '\nCarport'&#xd;&#xa;when @element=3200 then '\nTGa'&#xd;&#xa;when @element=3300 then '\nNeben-\ngebäude'&#xd;&#xa;when @element=3400 then '\nAbfall-\nsammel-\nanlage'&#xd;&#xa;when @element=3500 then '\nEnergie-\nverteil-\nungs-\nanlagen'&#xd;&#xa;when @element=3600 then '\nAbfall-\nwertstoff-\nbehälter'&#xd;&#xa;when @element=3700 then '\nFahrrad-\nstell-\nplätze'&#xd;&#xa;when @element=9999 then '\nsonst.'&#xd;&#xa;&#xd;&#xa;else 'was anderes'&#xd;&#xa;end)) ELSE CASE WHEN var('xplanversion_'+plan_layer_id())>=6 THEN '' ELSE 'Zweckbestimmung\nnicht\ndefiniert' END END,',','')&#xd;&#xa;&#xd;&#xa;+replace(&#xd;&#xa;case when try(&quot;allgemein&quot; is not NULL)then array_to_string(array_foreach(case when try  (array_length(&quot;allgemein&quot;)  >= 0) then &quot;allgemein&quot;&#xd;&#xa; Else array(&quot;allgemein&quot;) end , &#xd;&#xa;case&#xd;&#xa;when @element=1000 then '\nStellpl.'&#xd;&#xa;when @element=2000 then '\nGa'&#xd;&#xa;when @element=3000 then '\nSpielplatz'&#xd;&#xa;when @element=3100 then '\nCarport'&#xd;&#xa;when @element=3200 then '\nTGa'&#xd;&#xa;when @element=3300 then '\nNeben-\ngebäude'&#xd;&#xa;when @element=3400 then '\nAbfall-\nsammel-\nanlage'&#xd;&#xa;when @element=3500 then '\nEnergie-\nverteil-\nungs-\nanlagen'&#xd;&#xa;when @element=3600 then '\nAbfall-\nwertstoff-\nbehälter'&#xd;&#xa;when @element=3700 then '\nFahrrad-\nstell-\nplätze'&#xd;&#xa;when @element=9999 then '\nsonst.'&#xd;&#xa;&#xd;&#xa;else 'was anderes'&#xd;&#xa;end)) ELSE CASE WHEN var('xplanversion_'+plan_layer_id())&lt;6 THEN '' ELSE 'Zweckbestimmung\nnicht\ndefiniert' END END ,',','')&#xd;&#xa;&#xd;&#xa;+ case When try(bezugspunkt is not NULL) and try(h is not NULL) then&#xd;&#xa;&#x9;CASE&#xd;&#xa;&#x9;When  try(&quot;bezugspunkt&quot;=1000)   then '\nTH ' + to_string(&quot;h&quot;)+'m' &#xd;&#xa;&#x9;When  try(&quot;bezugspunkt&quot;=2000)   then '\nFH ' + to_string(&quot;h&quot;)+'m' &#xd;&#xa;&#x9;When  try(&quot;bezugspunkt&quot;=3000)   then '\nOK ' + to_string(&quot;h&quot;)+'m' &#xd;&#xa;&#x9;When  try(&quot;bezugspunkt&quot;=3500)   then '\nLH ' + to_string(&quot;h&quot;)+'m' &#xd;&#xa;&#x9;When  try(&quot;bezugspunkt&quot;=4000)   then '\nSH ' + to_string(&quot;h&quot;)+'m' &#xd;&#xa;&#x9;When  try(&quot;bezugspunkt&quot;=4500)   then '\nEFH '+ to_string(&quot;h&quot;)+'m' &#xd;&#xa;&#x9;When  try(&quot;bezugspunkt&quot;=5000)   then '\nHBA '+ to_string(&quot;h&quot;)+'m' &#xd;&#xa;&#x9;When  try(&quot;bezugspunkt&quot;=5500)   then '\nUK ' + to_string(&quot;h&quot;)+'m' &#xd;&#xa;&#x9;When  try(&quot;bezugspunkt&quot;=6000)   then '\nGBH '+ to_string(&quot;h&quot;)+'m' &#xd;&#xa;&#x9;When  try(&quot;bezugspunkt&quot;=6500)   then '\nWH ' + to_string(&quot;h&quot;)+'m' &#xd;&#xa;&#x9;ELSE '' END &#xd;&#xa;&#x9;+&#xd;&#xa;&#x9;CASE&#xd;&#xa;&#x9;When  try(&quot;hoehenbezug&quot;=1000) then ' NHN'&#xd;&#xa;&#x9;When  try(&quot;hoehenbezug&quot;=1100) then ' NN'&#xd;&#xa;&#x9;When  try(&quot;hoehenbezug&quot;=1200) then ' DHHN'&#xd;&#xa;&#x9;When  try(&quot;hoehenbezug&quot;=2000) then ' rGelOK'&#xd;&#xa;&#x9;When  try(&quot;hoehenbezug&quot;=2500) then ' rGehOK'&#xd;&#xa;&#x9;When  try(&quot;hoehenbezug&quot;=3000) then ' rBezHö'&#xd;&#xa;&#x9;when  try(&quot;abweichenderHoehenbezug&quot;   is not NULL) then ' '+ &quot;abweichenderHoehenbezug&quot;&#xd;&#xa;&#x9;ELSE '' &#x9;END &#xd;&#xa;ELSE '' END &#xd;&#xa;&#xd;&#xa;+ case when  try(&quot;ebene&quot; &lt;0) then  '\n'  || 'unterirdisch' else '' end&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;+ case &#xd;&#xa;when try(length(to_string(&quot;gliederung1&quot;))>15)then'\n'+left(to_string(&quot;gliederung1&quot;),15)+'...'&#xd;&#xa;when try(length(to_string(&quot;gliederung1&quot;))&lt;16)then'\n'+to_string(&quot;gliederung1&quot;)&#xd;&#xa;ELSE''End&#xd;&#xa;+ case &#xd;&#xa;when try(length(to_string(&quot;gliederung2&quot;))>15) then ' '+left(to_string(&quot;gliederung2&quot;),15)+'...'&#xd;&#xa;when try(length(to_string(&quot;gliederung2&quot;))&lt;16) then ' '+to_string(&quot;gliederung2&quot;)&#xd;&#xa;ELSE''End&#xd;&#xa;+case &#xd;&#xa;when try(length(&quot;aufschrift&quot;)>15)then'\n'+left(&quot;aufschrift&quot;,15)+'...'&#xd;&#xa;when try(length(&quot;aufschrift&quot;)&lt;16)then'\n'+&quot;aufschrift&quot;&#xd;&#xa;ELSE''End&#xd;&#xa;+case &#xd;&#xa;when try(length(&quot;text&quot;)>15)then'\n'+left(&quot;text&quot;,15)+'...'&#xd;&#xa;when try(length(&quot;text&quot;)&lt;126)then'\n'+&quot;text&quot;&#xd;&#xa;ELSE''End &#xd;&#xa;+ case &#xd;&#xa;when try(length(&quot;textlicheErgaenzung&quot;)>15)then'\n'+left(&quot;textlicheErgaenzung&quot;,15)+'...'&#xd;&#xa;when try(length(&quot;textlicheErgaenzung&quot;)&lt;16)then'\n'+&quot;textlicheErgaenzung&quot;&#xd;&#xa;ELSE''End&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;/* -----------Beginn Textabschnitte -----*/&#xd;&#xa;+case when try(&quot;refTextInhalt_href&quot;)is not null then&#xd;&#xa;&#x9;case &#xd;&#xa;&#x9;when try(array_length(&quot;refTextInhalt_href&quot;)>1) then '\n'+to_string(array_length(&quot;refTextInhalt_href&quot;))+' Textabschnitte:\n' &#xd;&#xa;&#x9;+replace(&#x9;lower(&#x9;array_to_string( &#x9;array_sort(&#x9;array_foreach(&#x9;array_foreach(&quot;refTextInhalt_href&quot;,&#xd;&#xa;&#x9;attribute(get_feature(var('textabschnitt_' + plan_layer_id()),'gml_id', right(@element, length(@element)-1)),'schluessel') &#xd;&#xa;&#x9;||', ')&#x9;,left(@element,12))&#x9;)&#x9;,'xyz')),&#xd;&#xa;&#x9;array(' nr.','nr.',' ','xyz', 'a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p',&#xd;&#xa;&#x9;'q','r','s','t','u','v','w','x','y','z','ä','ö','ü','ß','#','_','§',',','(',')'), &#xd;&#xa;&#x9;array('.'   ,''   ,'' ,'  ' , '','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''))&#xd;&#xa;&#x9;&#xd;&#xa;&#x9;when try(array_length(&quot;refTextInhalt_href&quot;)=1) then '\n'+'1 Textabschnitt:'&#xd;&#xa;&#x9;+replace(&#x9;lower(&#x9;array_to_string( &#x9;array_sort(&#x9;array_foreach(&#x9;array_foreach(&quot;refTextInhalt_href&quot;,&#xd;&#xa;&#x9;attribute(get_feature(var('textabschnitt_' + plan_layer_id()),'gml_id', right(@element, length(@element)-1)),'schluessel') &#xd;&#xa;&#x9;||', ')&#x9;,left(@element,12))&#x9;)&#x9;,'xyz')),&#xd;&#xa;&#x9;array(' nr.','nr.',' ','xyz', 'a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p',&#xd;&#xa;&#x9;'q','r','s','t','u','v','w','x','y','z','ä','ö','ü','ß','#','_','§',',','(',')'), &#xd;&#xa;&#x9;array('.'   ,''   ,'' ,'  ' , '','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''))&#xd;&#xa;&#x9;&#xd;&#xa;&#x9;when try(&quot;refTextInhalt_href&quot;)is not null then '\n'+'1 Textabschnitt:'&#xd;&#xa;&#x9;+replace(&#x9;lower(&#x9;array_to_string( &#x9;array_sort(&#x9;array_foreach(&#x9;array_foreach(array(&quot;refTextInhalt_href&quot;),&#xd;&#xa;&#x9;attribute(get_feature(var('textabschnitt_' + plan_layer_id()),'gml_id', right(@element, length(@element)-1)),'schluessel') &#xd;&#xa;&#x9;||', ')&#x9;,left(@element,12))&#x9;)&#x9;,'xyz')),&#xd;&#xa;&#x9;array(' nr.','nr.',' ','xyz', 'a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p',&#xd;&#xa;&#x9;'q','r','s','t','u','v','w','x','y','z','ä','ö','ü','ß','#','_','§',',','(',')'), &#xd;&#xa;&#x9;array('.'   ,''   ,'' ,'  ' , '','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''))&#xd;&#xa;&#x9;ELSE  ''End &#xd;&#xa;ELSE '' END &#xd;&#xa;&#xd;&#xa;/* -----------Ende Textabschnitte -----*/&#xd;&#xa;&#xd;&#xa;" blendMode="0" useSubstitutions="0" fontUnderline="0" allowHtml="0" fontFamily="Arial" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="1" fontSize="8" fontWordSpacing="0" legendString="Aa" fontSizeUnit="Point" multilineHeight="1" fontItalic="0" textOpacity="1" namedStyle="Standard" fontLetterSpacing="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255,rgb:1,1,1,1" multilineHeightUnit="Percentage">
        ...
        <shadow shadowRadiusAlphaOnly="0" shadowOpacity="0.69999999999999996" shadowBlendMode="6" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetAngle="135" shadowOffsetDist="1" shadowDraw="0" shadowRadiusUnit="MM" shadowUnder="0" shadowOffsetGlobal="1" shadowRadius="1.5" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetUnit="MM" shadowColor="0,0,0,255,rgb:0,0,0,1" shadowScale="100"/>
        <dd_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
      ...
      <text-format plussign="0" rightDirectionSymbol=">" decimals="3" addDirectionSymbol="0" reverseDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" formatNumbers="0" autoWrapLength="0" leftDirectionSymbol="&lt;" placeDirectionSymbol="0" wrapChar="" multilineAlign="0"/>
      <placement lineAnchorClipping="0" offsetUnits="MM" repeatDistance="0" rotationUnit="AngleDegrees" geometryGeneratorType="PointGeometry" quadOffset="4" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" dist="0" offsetType="0" overrunDistance="0" polygonPlacementFlags="2" geometryGenerator="" centroidWhole="0" lineAnchorType="0" placementFlags="10" allowDegraded="0" yOffset="0" preserveRotation="1" overrunDistanceUnit="MM" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" priority="5" maxCurvedCharAngleIn="25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidInside="1" layerType="PolygonGeometry" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-25" xOffset="0" distUnits="MM" lineAnchorPercent="0.5" placement="0" lineAnchorTextPoint="FollowPlacement" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overlapHandling="PreventOverlap" fitInPolygonOnly="0" rotationAngle="0"/>
      <rendering fontMinPixelSize="3" zIndex="0" drawLabels="1" obstacle="1" mergeLines="0" labelPerPart="0" maxNumLabels="2000" obstacleFactor="1" upsidedownLabels="0" limitNumLabels="0" scaleVisibility="1" obstacleType="1" minFeatureSize="0" fontMaxPixelSize="10000" fontLimitPixelSize="0" scaleMin="0" scaleMax="501" unplacedVisibility="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
          <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory spacingUnitScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" sizeType="MM" barWidth="5" penAlpha="255" spacingUnit="MM" lineSizeType="MM" backgroundAlpha="255" labelPlacementMethod="XHeight" diagramOrientation="Up" lineSizeScale="3x:0,0,0,0,0,0" opacity="1" backgroundColor="#ffffff" rotationOffset="270" minimumSize="0" sizeScale="3x:0,0,0,0,0,0" enabled="0" spacing="5" minScaleDenominator="0" maxScaleDenominator="0" scaleDependency="Area" height="15" penWidth="0" showAxis="1" penColor="#000000" width="15" direction="0">
      <fontProperties strikethrough="0" style="" description="MS Shell Dlg 2,8.3,-1,5,50,0,0,0,0,0" bold="0" italic="0" underline="0"/>
      <axisSymbol>
        <symbol clip_to_extent="1" is_animated="0" frame_rate="10" type="line" name="" force_rhr="0" alpha="1">
          <data_defined_properties>
            <Option type="Map">
          ...
          <layer pass="0" enabled="1" class="SimpleLine" locked="0" id="{4d4f9ae8-fe21-4e46-9662-2f2f783721ad}">
            <Option type="Map">
              <Option type="QString" value="0" name="align_dash_pattern"/>
              <Option type="QString" value="square" name="capstyle"/>
              <Option type="QString" value="5;2" name="customdash"/>
  ...
  <DiagramLayerSettings obstacle="0" zIndex="0" priority="0" placement="1" dist="0" showAll="1" linePlacementFlags="18">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias index="9" field="aufschrift" name=""/>
    <alias index="10" field="rechtscharakter" name=""/>
    <alias index="11" field="flaechenschluss" name=""/>
    <alias index="12" field="zweckbestimmung" name=""/>
  </aliases>
  <splitPolicies>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="Envelope_srsName" exp_strength="0" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" field="lowerCorner" exp_strength="0" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" field="upperCorner" exp_strength="0" notnull_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" field="wert" exp_strength="0" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" field="gehoertZuBereich_href" exp_strength="0" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" field="wirdDargestelltDurch_href" exp_strength="0" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="Envelope_srsName" desc="" exp=""/>
    <constraint field="lowerCorner" desc="" exp=""/>
    <constraint field="upperCorner" desc="" exp=""/>
    <constraint field="ebene" desc="" exp=""/>
    <constraint field="name" desc="" exp=""/>
    <constraint field="wert" desc="" exp=""/>
    <constraint field="gehoertZuBereich_href" desc="" exp=""/>
    <constraint field="wirdDargestelltDurch_href" desc="" exp=""/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column width="-1" type="field" name="Envelope_srsName" hidden="0"/>
      <column width="-1" type="field" name="lowerCorner" hidden="0"/>
      <column width="-1" type="field" name="upperCorner" hidden="0"/>
      <column width="-1" type="field" name="ebene" hidden="0"/>
      <column width="-1" type="field" name="name" hidden="0"/>
      <column width="-1" type="field" name="wert" hidden="0"/>
      <column width="-1" type="field" name="gehoertZuBereich_href" hidden="0"/>
      <column width="-1" type="field" name="wirdDargestelltDurch_href" hidden="0"/>
      <column width="209" type="field" name="aufschrift" hidden="0"/>
