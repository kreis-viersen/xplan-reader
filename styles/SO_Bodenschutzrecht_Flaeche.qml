...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling|MapTips" version="3.40.1-Bratislava">
  <renderer-v2 referencescale="-1" forceraster="0" enableorderby="0" type="RuleRenderer" symbollevels="0">
    <rules key="{15b55f85-fef6-4d2f-aff8-d87b3255b737}">
      <rule symbol="0" label="alle" key="{d3d98db2-e4dc-4795-a9bd-7bf1d50ef253}"/>
      <rule symbol="1" label="Schädliche Bodenveränderung" key="{289cb9c9-370a-4abd-a6a3-10231a2d6796}" filter="&quot;artDerFestlegung&quot;= 1000"/>
      <rule symbol="2" label="Altlast" key="{df69eee7-b6a7-4b79-adb1-5d74ceec05d0}" filter="&quot;artDerFestlegung&quot;= 2000"/>
      <rule symbol="3" label="Altablagerung" key="{e66477d2-7c78-44cc-ab86-81585b951de6}" filter="&quot;artDerFestlegung&quot;=20000"/>
      <rule symbol="4" label="Altstandort" key="{dbfbec34-6b83-40ab-ac72-827fb8fb05a7}" filter="&quot;artDerFestlegung&quot;=20001"/>
      <rule symbol="5" label="Altstandort einer Altablagerung" key="{923d2caf-a4ac-4703-84b1-c8426b3148b8}" filter="&quot;artDerFestlegung&quot;=20002"/>
      <rule symbol="6" label="artDerFestlegung nicht definiert" key="{0e7cbddd-ea6a-4d35-830d-66e996d669e6}" filter="&quot;artDerFestlegung&quot; is null"/>
    </rules>
    <symbols>
      <symbol name="0" clip_to_extent="1" is_animated="0" frame_rate="10" force_rhr="0" type="fill" alpha="1">
        ...
        <layer locked="0" pass="0" class="SimpleLine" enabled="1" id="{ddc102a6-3224-4397-8366-f63aa17caf6c}">
          <Option type="Map">
            ...
            <Option name="line_color" value="209,61,61,255,rgb:0.81960784313725488,0.23921568627450981,0.23921568627450981,1" type="QString"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  ...
                  <Option name="expression" value="case &#xd;&#xa;when  plan_layer_id() ilike 'BP%' then 0.6&#xd;&#xa;when  plan_layer_id() ilike 'FP%' then 6&#xd;&#xa;Else 6&#xd;&#xa;end" type="QString"/>
        ...
        <layer locked="0" pass="0" class="SimpleLine" enabled="1" id="{0895e8c1-cf15-4646-bd38-8c4ff86e1745}">
          <Option type="Map">
            <Option name="align_dash_pattern" value="0" type="QString"/>
      ...
      <symbol name="6" clip_to_extent="1" is_animated="0" frame_rate="10" force_rhr="0" type="fill" alpha="1">
        ...
        <layer locked="0" pass="0" class="SimpleFill" enabled="1" id="{617551e1-93bb-4565-b748-13c189221f44}">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" clip_to_extent="1" is_animated="0" frame_rate="10" force_rhr="0" type="fill" alpha="1">
        ...
        <layer locked="0" pass="0" class="SimpleFill" enabled="1" id="{e56fd99f-b02b-4aef-a05a-fd288b19bc7e}">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
