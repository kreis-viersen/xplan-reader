...
<qgis version="3.26.3-Buenos Aires" styleCategories="Symbology|Labeling" labelsEnabled="0">
  <renderer-v2 symbollevels="0" referencescale="-1" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{aa460e6a-e887-466e-aabf-cb8b1c16ea15}">
      <rule scalemaxdenom="2501" symbol="0" scalemindenom="1" key="{9b604aa3-2e21-4728-be36-a3609c48de31}"/>
    </rules>
    <symbols>
      <symbol is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" name="0" type="line" alpha="1">
        ...
        <layer pass="0" class="MarkerLine" enabled="1" locked="0">
          ...
          <symbol is_animated="0" frame_rate="10" clip_to_extent="1" force_rhr="0" name="@0@0" type="marker" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
