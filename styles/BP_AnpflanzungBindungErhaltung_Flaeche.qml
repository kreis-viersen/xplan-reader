...
<qgis labelsEnabled="1" version="3.32.3-Lima" styleCategories="Symbology|Labeling|MapTips">
  <renderer-v2 forceraster="0" referencescale="-1" enableorderby="0" type="RuleRenderer" symbollevels="0">
    <rules key="{5361cec9-90ed-4333-ac4a-3b798e472d9d}">
      <rule scalemindenom="1" symbol="0" scalemaxdenom="2501" label="alles" key="{6b9a53f2-47fb-4c92-83b4-5193b087a306}"/>
      <rule filter="&quot;massnahme&quot;='1000'" scalemindenom="1" symbol="1" scalemaxdenom="2501" label="davon Bindung Erhaltung" key="{cfb65b8a-94d3-4bc4-aa55-88afffbe3108}"/>
      <rule filter="&quot;massnahme&quot;='2000' " scalemindenom="1" symbol="2" scalemaxdenom="2501" label="davon Anpflanzung" key="{58ec5aed-e6f2-4ba2-bbdf-e23fc5c6c876}"/>
      <rule filter="&quot;massnahme&quot; ='3000'" scalemindenom="1" symbol="3" scalemaxdenom="2501" label="davon Anpflanzung Bindung Erhaltung" key="{943fc6d9-da9c-4e74-b85d-3488d8b758b2}"/>
      <rule checkstate="0" filter="&quot;massnahme&quot; is NULL" scalemindenom="1" symbol="4" scalemaxdenom="2501" label="davon Maßnahme nicht definiert" key="{713ca222-b519-473e-a98d-98a5b8371cac}"/>
      <rule checkstate="0" filter="&quot;gegenstand&quot; is null" scalemindenom="1" symbol="5" scalemaxdenom="2501" label="davon Gegenstand nicht definiert" key="{6ca51d76-5910-4376-babb-42a0a157e29c}"/>
    </rules>
    <symbols>
      <symbol name="0" frame_rate="10" is_animated="0" alpha="1" type="fill" force_rhr="0" clip_to_extent="1">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0" id="{249fde16-8504-40ee-a24c-dc7afa3a45fd}">
          <Option type="Map">
          ...
          <symbol name="@0@0" frame_rate="10" is_animated="0" alpha="0.9" type="marker" force_rhr="0" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
            ...
            <layer class="SimpleMarker" pass="0" enabled="1" locked="0" id="{df4c2e37-93f3-448f-a781-a9ae6b0a766c}">
              <Option type="Map">
        ...
        <layer class="SimpleLine" pass="0" enabled="1" locked="0" id="{b72edd7f-e6ba-485c-ae37-4c47f0e4514c}">
          <Option type="Map">
      ...
      <symbol name="1" frame_rate="10" is_animated="0" alpha="1" type="fill" force_rhr="0" clip_to_extent="1">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0" id="{249fde16-8504-40ee-a24c-dc7afa3a45fd}">
          ...
          <symbol name="@1@0" frame_rate="10" is_animated="0" alpha="0.9" type="marker" force_rhr="0" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol name="2" frame_rate="10" is_animated="0" alpha="1" type="fill" force_rhr="0" clip_to_extent="1">
        ...
        <layer class="SimpleFill" pass="0" enabled="1" locked="0" id="{bf4bd98b-497d-4069-84b9-af932d0dfdfb}">
          <Option type="Map">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0" id="{ed5d1036-ccc7-464e-8818-2fb98d9f60d2}">
          <Option type="Map">
            <Option name="average_angle_length" type="QString" value="4"/>
            <Option name="average_angle_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="average_angle_unit" type="QString" value="RenderMetersInMapUnits"/>
          ...
          <symbol name="@2@1" frame_rate="10" is_animated="0" alpha="0.9" type="marker" force_rhr="0" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
            ...
            <layer class="SimpleMarker" pass="0" enabled="1" locked="0" id="{56978fdf-f1d4-4dbb-996a-1fb2b1b46487}">
              <Option type="Map">
                <Option name="angle" type="QString" value="0"/>
                <Option name="cap_style" type="QString" value="square"/>
        ...
        <layer class="SimpleLine" pass="0" enabled="1" locked="0" id="{dff789f6-8934-4c3b-b1c8-0cfd71df490f}">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="square"/>
            <Option name="customdash" type="QString" value="5;2"/>
      ...
      <symbol name="3" frame_rate="10" is_animated="0" alpha="1" type="fill" force_rhr="0" clip_to_extent="1">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0" id="{db6dd37f-a868-40a0-b864-bfc14a7209c6}">
          <Option type="Map">
            <Option name="average_angle_length" type="QString" value="4"/>
            <Option name="average_angle_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="average_angle_unit" type="QString" value="RenderMetersInMapUnits"/>
          ...
          <symbol name="@3@0" frame_rate="10" is_animated="0" alpha="0.9" type="marker" force_rhr="0" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
            ...
            <layer class="SimpleMarker" pass="0" enabled="1" locked="0" id="{f18e8bed-f9ab-40cf-b5a2-4e1e29e5026d}">
              <Option type="Map">
                <Option name="angle" type="QString" value="0"/>
                <Option name="cap_style" type="QString" value="square"/>
                <Option name="color" type="QString" value="255,255,255,255"/>
            ...
            <layer class="SimpleMarker" pass="0" enabled="1" locked="0" id="{ee885406-96c8-4186-afd0-e419e269bb4d}">
              <Option type="Map">
                <Option name="angle" type="QString" value="0"/>
                <Option name="cap_style" type="QString" value="square"/>
                <Option name="color" type="QString" value="0,0,0,255"/>
        ...
        <layer class="SimpleLine" pass="0" enabled="1" locked="0" id="{faf597bf-a8a1-49fc-8925-e4f1e925a241}">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
            <Option name="capstyle" type="QString" value="square"/>
            <Option name="customdash" type="QString" value="5;2"/>
      ...
      <symbol name="4" frame_rate="10" is_animated="0" alpha="1" type="fill" force_rhr="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer class="SimpleFill" pass="0" enabled="1" locked="0" id="{09134fd9-81bd-47f9-b401-57b782431cfa}">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
      ...
      <symbol name="5" frame_rate="10" is_animated="0" alpha="1" type="fill" force_rhr="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer class="SimpleFill" pass="0" enabled="1" locked="0" id="{c11924a4-7b68-4c66-b8db-7487c0a981c7}">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="255,0,0,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <rendering fontMinPixelSize="3" obstacleFactor="1" drawLabels="1" scaleMax="251" obstacleType="1" scaleVisibility="1" labelPerPart="0" upsidedownLabels="0" obstacle="1" minFeatureSize="0" fontLimitPixelSize="0" zIndex="0" fontMaxPixelSize="10000" maxNumLabels="2000" unplacedVisibility="0" limitNumLabels="0" scaleMin="0" mergeLines="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties"/>
