...
<qgis version="3.28.4-Firenze" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" forceraster="0" symbollevels="0" referencescale="-1" enableorderby="0">
    <rules key="{5361cec9-90ed-4333-ac4a-3b798e472d9d}">
      <rule key="{cfb65b8a-94d3-4bc4-aa55-88afffbe3108}" label="Bindung Erhaltung" symbol="0" scalemaxdenom="2501" filter="&quot;massnahme&quot;='1000'" scalemindenom="1"/>
      <rule key="{58ec5aed-e6f2-4ba2-bbdf-e23fc5c6c876}" label="Anpflanzung" symbol="1" scalemaxdenom="2501" filter="&quot;massnahme&quot;='2000' " scalemindenom="1"/>
      <rule key="{943fc6d9-da9c-4e74-b85d-3488d8b758b2}" label="Anpflanzung Bindung Erhaltung" symbol="2" scalemaxdenom="2501" filter="&quot;massnahme&quot; ='3000'" scalemindenom="1"/>
      <rule key="{713ca222-b519-473e-a98d-98a5b8371cac}" label="Maßnahme nicht definiert" symbol="3" scalemaxdenom="2501" filter="&quot;massnahme&quot; is NULL" scalemindenom="1"/>
      <rule key="{6ca51d76-5910-4376-babb-42a0a157e29c}" label="Gegenstand nicht definiert" symbol="4" scalemaxdenom="2501" filter="&quot;gegenstand&quot; is null" scalemindenom="1"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" alpha="1" type="fill" name="0" frame_rate="10" is_animated="0" force_rhr="0">
        ...
        <layer locked="0" enabled="1" pass="0" class="MarkerLine">
          ...
          <symbol clip_to_extent="1" alpha="0.9" type="marker" name="@0@0" frame_rate="10" is_animated="0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" alpha="1" type="fill" name="1" frame_rate="10" is_animated="0" force_rhr="0">
        ...
        <layer locked="0" enabled="1" pass="0" class="MarkerLine">
          ...
          <symbol clip_to_extent="1" alpha="0.9" type="marker" name="@1@0" frame_rate="10" is_animated="0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" alpha="1" type="fill" name="2" frame_rate="10" is_animated="0" force_rhr="0">
        ...
        <layer locked="0" enabled="1" pass="0" class="MarkerLine">
          ...
          <symbol clip_to_extent="1" alpha="0.9" type="marker" name="@2@0" frame_rate="10" is_animated="0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style previewBkgrdColor="255,255,255,255" textOpacity="1" textColor="50,50,50,255" blendMode="0" fontStrikeout="0" multilineHeight="1" fontItalic="0" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontLetterSpacing="0" fontKerning="1" forcedItalic="0" capitalization="0" fontUnderline="0" fontWordSpacing="0" textOrientation="horizontal" fontFamily="Arial" fontWeight="50" namedStyle="Regular" fieldName="case &#xd;&#xa;when try( &quot;massnahme&quot; is not null) then &#xd;&#xa;&#x9;case&#xd;&#xa;&#x9;when  &quot;massnahme&quot; =1000 then 'Bindung&amp;Erhaltung'+ '\n' &#xd;&#xa;&#x9;when  &quot;massnahme&quot; =2000 then 'Anpflanzung'+ '\n' &#xd;&#xa;&#x9;when  &quot;massnahme&quot; =3000 then 'Anpflanzung&amp;Bindung&amp;Erhaltung'+ '\n' &#xd;&#xa;&#x9;Else 'Maßnahme nicht definiert'+ '\n'  END &#xd;&#xa;Else 'Maßnahme nicht definiert'+ '\n'  END &#xd;&#xa;+&#xd;&#xa;case &#xd;&#xa;when try( &quot;gegenstand&quot; is not null) then &#xd;&#xa;&#x9;case&#xd;&#xa;&#x9;when  &quot;gegenstand&quot; =1000 then 'Bäume'&#xd;&#xa;&#x9;when  &quot;gegenstand&quot; =1100 then 'Kopfbäume'&#xd;&#xa;&#x9;when  &quot;gegenstand&quot; =1200 then 'Baumreihe'&#xd;&#xa;&#x9;when  &quot;gegenstand&quot; =2000 then 'Sträucher'&#xd;&#xa;&#x9;when  &quot;gegenstand&quot; =2050 then 'Bäume&amp;Sträucher'&#xd;&#xa;&#x9;when  &quot;gegenstand&quot; =2100 then 'Hecke'&#xd;&#xa;&#x9;when  &quot;gegenstand&quot; =2200 then 'Knick'&#xd;&#xa;&#x9;when  &quot;gegenstand&quot; =3000 then 'sonst.Bepflanzung'&#xd;&#xa;&#x9;when  &quot;gegenstand&quot; =4000 then 'Gewässer'&#xd;&#xa;&#x9;when  &quot;gegenstand&quot; =5000 then 'Fassadenbegrünung'&#xd;&#xa;&#x9;when  &quot;gegenstand&quot; =6000 then 'Dachbegrünung'&#x9;&#xd;&#xa;&#x9;Else 'gegenstand nicht definiert' END &#xd;&#xa;Else 'gegenstand nicht definiert' END &#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;text&quot; is not null) then   case &#xd;&#xa;when length(&quot;text&quot;)>25 then '\n'+left(replace(&quot;text&quot;,'\n',' '),25)+'...'&#xd;&#xa;when length(&quot;text&quot;)&lt;26 then '\n'+     replace(&quot;text&quot;,'\n',' ')  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung1&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung1&quot;)>25 then '\n'+left(to_string(&quot;gliederung1&quot;),25)+'...'&#xd;&#xa;when length(&quot;gliederung1&quot;)&lt;26 then '\n'+     to_string(&quot;gliederung1&quot;)  ELSE'' End ELSE '' End &#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung2&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung2&quot;)>25 then '\n'+left(to_string(&quot;gliederung2&quot;),25)+'...'&#xd;&#xa;when length(&quot;gliederung2&quot;)&lt;26 then '\n'+     to_string(&quot;gliederung2&quot;)  ELSE'' End ELSE '' End &#xd;&#xa;&#xd;&#xa;+ case when try(&quot;aufschrift&quot; is not null) then   case &#xd;&#xa;when length(&quot;aufschrift&quot;)>25 then '\n'+left(&quot;aufschrift&quot;,25)+'...'&#xd;&#xa;when length(&quot;aufschrift&quot;)&lt;26 then '\n'+     &quot;aufschrift&quot;  End ELSE '' End&#xd;&#xa;" legendString="Aa" multilineHeightUnit="Percentage" forcedBold="0" allowHtml="0" fontSize="8" isExpression="1">
        <families/>
        <text-buffer bufferOpacity="1" bufferColor="77,174,56,255" bufferBlendMode="0" bufferSize="25" bufferNoFill="1" bufferJoinStyle="128" bufferDraw="1" bufferSizeUnits="Percentage" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <text-format decimals="3" formatNumbers="0" reverseDirectionSymbol="0" addDirectionSymbol="0" plussign="0" wrapChar="" autoWrapLength="0" leftDirectionSymbol="&lt;" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" placeDirectionSymbol="0" multilineAlign="0"/>
      <placement lineAnchorType="0" rotationAngle="0" overrunDistanceUnit="MM" lineAnchorClipping="0" dist="0" repeatDistance="0" fitInPolygonOnly="0" priority="5" lineAnchorPercent="0.5" repeatDistanceUnits="MM" offsetUnits="MM" xOffset="0" layerType="PolygonGeometry" yOffset="0" overrunDistance="0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorTextPoint="FollowPlacement" preserveRotation="1" rotationUnit="AngleDegrees" geometryGeneratorEnabled="0" placementFlags="10" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" geometryGeneratorType="PointGeometry" overlapHandling="PreventOverlap" geometryGenerator="" maxCurvedCharAngleOut="-25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" placement="0" offsetType="0" maxCurvedCharAngleIn="25" polygonPlacementFlags="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distUnits="MM" allowDegraded="0" centroidInside="1"/>
      <rendering obstacleFactor="1" fontMaxPixelSize="10000" obstacle="1" labelPerPart="0" limitNumLabels="0" minFeatureSize="0" scaleVisibility="1" scaleMax="251" fontMinPixelSize="3" mergeLines="0" scaleMin="0" fontLimitPixelSize="0" unplacedVisibility="0" obstacleType="1" drawLabels="1" zIndex="0" upsidedownLabels="0" maxNumLabels="2000"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
