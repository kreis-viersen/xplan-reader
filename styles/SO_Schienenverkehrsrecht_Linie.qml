...
<qgis version="3.26.1-Buenos Aires" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 symbollevels="0" referencescale="-1" forceraster="0" enableorderby="0" type="RuleRenderer">
    <rules key="{41f13999-2541-43e7-aae4-a7d984180bea}">
      <rule symbol="0" key="{54005a0d-b1f0-4647-9140-713a5327a2fd}"/>
    </rules>
    <symbols>
      <symbol name="0" clip_to_extent="1" frame_rate="10" is_animated="0" alpha="1" type="line" force_rhr="0">
        ...
        <layer class="MarkerLine" pass="0" locked="0" enabled="1">
          ...
          <symbol name="@0@1" clip_to_extent="1" frame_rate="10" is_animated="0" alpha="1" type="marker" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontStrikeout="0" fontItalic="0" textColor="50,50,50,255" fontKerning="1" textOrientation="horizontal" useSubstitutions="0" textOpacity="1" forcedItalic="0" fontWeight="50" forcedBold="0" blendMode="0" fontUnderline="0" fontWordSpacing="0" capitalization="0" allowHtml="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" fontSizeUnit="Point" fontSize="8" multilineHeight="1" previewBkgrdColor="255,255,255,255" namedStyle="Regular" fontFamily="Arial" fieldName="CASE &#xd;&#xa;when try( &quot;artDerFestlegung&quot;=1000  ) then 'Bahnanlage'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=10000 ) then 'Bahnanlage DB'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=10001 ) then 'Personenbahnhof'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=10002 ) then 'Fernbahnhof'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=10003 ) then 'Güterbahnhof' &#xd;&#xa;when try( &quot;artDerFestlegung&quot;=1200  ) then 'Bahnlinie allg.'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=12000 ) then 'Personenbahnlinie'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=12001 ) then 'Regionalbahn'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=12002 ) then 'Kleinbahn' &#xd;&#xa;when try( &quot;artDerFestlegung&quot;=12003 ) then 'Güterbahnlinie'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=12004 ) then 'Werks-/Hafenbahnlinie'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=12005 ) then 'Seilbahn'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=1400  ) then 'Schienengebundener ÖPNV'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=14000 ) then 'Straßenbahn'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=14001 ) then 'U-Bahn'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=14002 ) then 'S-Bahn'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=14003 ) then 'Haltestelle ÖPNV'&#xd;&#xa;when try( &quot;artDerFestlegung&quot;=9999  ) then 'sonst, Schienenverkehrsrecht'&#xd;&#xa;ELSE 'artDerFestlegung nicht definiert'&#xd;&#xa;END&#xd;&#xa;+ case when try(&quot;text&quot; is not null) then   case &#xd;&#xa;when length(&quot;text&quot;)>25 then ' '+left(replace(&quot;text&quot;,'\n',' '),25)+'...'&#xd;&#xa;when length(&quot;text&quot;)&lt;26 then ' '+     replace(&quot;text&quot;,'\n',' ')  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;aufschrift&quot; is not null) then   case &#xd;&#xa;when length(&quot;aufschrift&quot;)>25 then ' '+left(&quot;aufschrift&quot;,25)+'...'&#xd;&#xa;when length(&quot;aufschrift&quot;)&lt;26 then ' '+     &quot;aufschrift&quot;  End ELSE '' End" isExpression="1" legendString="Aa">
        <families/>
      ...
      <text-format addDirectionSymbol="0" formatNumbers="0" plussign="0" useMaxLineLengthForAutoWrap="1" autoWrapLength="0" rightDirectionSymbol=">" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" wrapChar="" multilineAlign="0" decimals="3" placeDirectionSymbol="0"/>
      <placement xOffset="13" lineAnchorPercent="0.5" priority="5" rotationUnit="AngleDegrees" overlapHandling="PreventOverlap" allowDegraded="0" dist="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" distUnits="MM" overrunDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" polygonPlacementFlags="2" geometryGeneratorEnabled="0" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" yOffset="0" quadOffset="5" offsetUnits="RenderMetersInMapUnits" lineAnchorTextPoint="FollowPlacement" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" repeatDistanceUnits="MM" fitInPolygonOnly="0" centroidInside="0" offsetType="1" layerType="LineGeometry" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" preserveRotation="1" centroidWhole="0" placement="3" lineAnchorType="0" geometryGenerator="" placementFlags="9" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0"/>
      <rendering upsidedownLabels="0" scaleVisibility="1" minFeatureSize="0" labelPerPart="0" unplacedVisibility="0" fontMaxPixelSize="10000" scaleMin="1000" scaleMax="4001" drawLabels="1" fontLimitPixelSize="0" limitNumLabels="0" obstacle="1" obstacleType="1" maxNumLabels="2000" mergeLines="0" fontMinPixelSize="3" obstacleFactor="1" zIndex="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
