...
<qgis version="3.42.3-Münster" labelsEnabled="1" styleCategories="Symbology|Labeling|MapTips">
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol name="0" alpha="1" is_animated="0" clip_to_extent="1" type="line" force_rhr="0" frame_rate="10">
        ...
        <layer locked="1" id="{7dff0bd8-1c13-4a8d-8373-335cc2c407aa}" enabled="1" pass="0" class="SimpleLine">
          <Option type="Map">
          ...
          <effect enabled="0" type="effectStack">
            ...
            <effect type="outerGlow">
              <Option type="Map">
                ...
                <Option value="227,26,28,255,rgb:0.8901960784313725,0.10196078431372549,0.10980392156862745,1" name="single_color" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" alpha="1" is_animated="0" clip_to_extent="1" type="line" force_rhr="0" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{91ee7650-5f69-43cf-b6e5-9506c8a73182}" enabled="1" pass="0" class="SimpleLine">
          <Option type="Map">
            <Option value="0" name="align_dash_pattern" type="QString"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement offsetType="0" centroidWhole="0" preserveRotation="1" rotationAngle="0" prioritization="PreferCloser" xOffset="0" overrunDistance="0" overrunDistanceUnit="MM" centroidInside="1" lineAnchorTextPoint="FollowPlacement" lineAnchorPercent="0.5" quadOffset="4" repeatDistance="0" maximumDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" fitInPolygonOnly="0" geometryGeneratorType="PointGeometry" distUnits="MM" yOffset="0" dist="0" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" placement="2" placementFlags="10" layerType="LineGeometry" overlapHandling="PreventOverlap" geometryGeneratorEnabled="0" maxCurvedCharAngleOut="-25" maximumDistanceUnit="MM" geometryGenerator="" lineAnchorClipping="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" allowDegraded="0" priority="5" lineAnchorType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maximumDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
