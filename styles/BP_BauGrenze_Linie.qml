...
<qgis version="3.42.3-Münster" styleCategories="Symbology|Labeling|MapTips" labelsEnabled="1">
  <renderer-v2 enableorderby="0" referencescale="-1" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{ce40e26c-cae2-4d68-a0fb-4d1bc3305bb5}">
      <rule key="{e31f6ab9-cd50-4109-8aa6-cc95480c0192}" scalemaxdenom="2501" symbol="0" scalemindenom="1"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" frame_rate="10" type="line" alpha="1" is_animated="0" force_rhr="0" name="0">
        ...
        <layer locked="0" enabled="1" pass="0" id="{085145b8-4286-489e-bcac-f720a2fbabf5}" class="SimpleLine">
          <Option type="Map">
            ...
            <Option value="72,111,239,255,rgb:0.28235294117647058,0.43529411764705883,0.93725490196078431,1" type="QString" name="line_color"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol clip_to_extent="1" frame_rate="10" type="line" alpha="1" is_animated="0" force_rhr="0" name="">
        ...
        <layer locked="0" enabled="1" pass="0" id="{7aad8e88-8d76-4f6d-a74e-db38e92a2525}" class="SimpleLine">
          <Option type="Map">
            <Option value="0" type="QString" name="align_dash_pattern"/>
            <Option value="square" type="QString" name="capstyle"/>
            <Option value="5;2" type="QString" name="customdash"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement layerType="LineGeometry" centroidInside="0" repeatDistance="0" placementFlags="9" overrunDistanceUnit="MM" overrunDistance="0" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" geometryGenerator="" rotationAngle="0" overlapHandling="PreventOverlap" fitInPolygonOnly="0" preserveRotation="1" placement="2" geometryGeneratorType="PointGeometry" repeatDistanceUnits="MM" xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" rotationUnit="AngleDegrees" maximumDistanceUnit="MM" polygonPlacementFlags="2" yOffset="0" lineAnchorClipping="0" distUnits="MM" offsetUnits="MM" quadOffset="4" offsetType="0" prioritization="PreferCloser" priority="5" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maximumDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" geometryGeneratorEnabled="0" lineAnchorType="0" allowDegraded="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorTextPoint="FollowPlacement" maximumDistance="0" distMapUnitScale="3x:0,0,0,0,0,0"/>
      <rendering obstacleFactor="1" minFeatureSize="0" fontMaxPixelSize="10000" labelPerPart="0" limitNumLabels="0" mergeLines="0" unplacedVisibility="0" obstacle="1" obstacleType="1" scaleMin="0" drawLabels="1" zIndex="0" maxNumLabels="2000" fontMinPixelSize="3" upsidedownLabels="0" scaleVisibility="1" fontLimitPixelSize="0" scaleMax="251"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
