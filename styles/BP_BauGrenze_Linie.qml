...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling|MapTips" version="3.40.1-Bratislava">
  <renderer-v2 enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1" type="RuleRenderer">
    <rules key="{ce40e26c-cae2-4d68-a0fb-4d1bc3305bb5}">
      <rule symbol="0" scalemindenom="1" key="{e31f6ab9-cd50-4109-8aa6-cc95480c0192}" scalemaxdenom="2501"/>
    </rules>
    <symbols>
      <symbol frame_rate="10" alpha="1" type="line" is_animated="0" name="0" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" locked="0" class="SimpleLine" pass="0" id="{085145b8-4286-489e-bcac-f720a2fbabf5}">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="72,111,239,255,rgb:0.28235294117647058,0.43529411764705883,0.93725490196078431,1"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol frame_rate="10" alpha="1" type="line" is_animated="0" name="" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" name="name" value=""/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" class="SimpleLine" pass="0" id="{7aad8e88-8d76-4f6d-a74e-db38e92a2525}">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format autoWrapLength="30" wrapChar="" reverseDirectionSymbol="0" rightDirectionSymbol=">" plussign="0" useMaxLineLengthForAutoWrap="1" placeDirectionSymbol="0" decimals="3" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" multilineAlign="0"/>
      <placement priority="5" overrunDistanceUnit="MM" geometryGeneratorEnabled="0" dist="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" rotationUnit="AngleDegrees" layerType="LineGeometry" lineAnchorTextPoint="FollowPlacement" rotationAngle="0" maximumDistanceUnit="MM" geometryGeneratorType="PointGeometry" overlapHandling="PreventOverlap" prioritization="PreferCloser" centroidWhole="0" xOffset="0" maximumDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" fitInPolygonOnly="0" quadOffset="4" overrunDistance="0" centroidInside="0" offsetType="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="2" geometryGenerator="" allowDegraded="0" maxCurvedCharAngleIn="25" maximumDistance="0" lineAnchorType="0" placementFlags="9" distUnits="MM" offsetUnits="MM" repeatDistanceUnits="MM" lineAnchorClipping="0" maxCurvedCharAngleOut="-25" preserveRotation="1" lineAnchorPercent="0.5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
      <rendering limitNumLabels="0" drawLabels="1" scaleVisibility="1" fontLimitPixelSize="0" minFeatureSize="0" unplacedVisibility="0" upsidedownLabels="0" maxNumLabels="2000" scaleMin="0" obstacleFactor="1" fontMinPixelSize="3" obstacle="1" labelPerPart="0" mergeLines="0" zIndex="0" scaleMax="251" fontMaxPixelSize="10000" obstacleType="1"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
