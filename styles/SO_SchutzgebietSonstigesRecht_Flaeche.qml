...
<qgis labelsEnabled="1" version="3.26.3-Buenos Aires" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{84abca4b-5d95-41e0-8367-b8ae678108f9}">
      <rule symbol="0" label="alle" key="{c166b8e2-6c89-4301-96b0-c6fa5e01e874}"/>
      <rule filter=" &quot;artDerFestlegung&quot; is NULL" symbol="1" label="artDerFestlegung nicht definiert" key="{16a2108c-f913-42dc-87de-cf8f7e462dfb}"/>
    </rules>
    <symbols>
      <symbol type="fill" name="0" alpha="1" force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1">
        ...
        <layer class="PointPatternFill" pass="0" locked="0" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" name="seed" value="925295365"/>
          </Option>
          <prop v="0" k="angle"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style forcedBold="0" fontLetterSpacing="0" forcedItalic="0" fontKerning="1" namedStyle="Standard" fontFamily="Arial" textOpacity="1" fontSize="7" fontWeight="50" legendString="Aa" fontSizeUnit="Point" textColor="114,114,114,255" textOrientation="horizontal" fontStrikeout="0" previewBkgrdColor="255,255,255,255" multilineHeight="1" isExpression="1" allowHtml="0" fontWordSpacing="0" capitalization="0" fontUnderline="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fieldName="'SO Schutzgebiet sonst.Recht' +  &#xd;&#xa;CASE &#xd;&#xa;WHEN try(artDerFestlegung is not NULL,'-') THEN &#xd;&#xa; CASE &#xd;&#xa; WHEN &quot;artDerFestlegung&quot;= 1000 THEN '\n'+'Lärmschutzbereich' &#xd;&#xa; WHEN &quot;artDerFestlegung&quot;= 2000 THEN '\n'+'Schutzzone Leitungstrasse' &#xd;&#xa; WHEN &quot;artDerFestlegung&quot;= 9999 THEN '\n'+'sonstige Klassifizierung' &#xd;&#xa; ELSE ''&#xd;&#xa; END&#xd;&#xa;ELSE '' &#xd;&#xa;END&#xd;&#xa;/* ab hier ein copy&amp;paste Block für alle SO-Flächen */&#xd;&#xa;+ case when try(&quot;text&quot; is not null) then   case &#xd;&#xa;when length(&quot;text&quot;)>25 then '\n'+left(&quot;text&quot;,25)+'...'&#xd;&#xa;when length(&quot;text&quot;)&lt;26 then '\n'+     &quot;text&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;textlicheErgaenzung&quot; is not null) then   case &#xd;&#xa;when length(&quot;textlicheErgaenzung&quot;)>25 then '\n'+left(&quot;textlicheErgaenzung&quot;,25)+'...'&#xd;&#xa;when length(&quot;textlicheErgaenzung&quot;)&lt;26 then '\n'+     &quot;textlicheErgaenzung&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung1&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung1&quot;)>25 then '\n'+left(&quot;gliederung1&quot;,25)+'...'&#xd;&#xa;when length(&quot;gliederung1&quot;)&lt;26 then '\n'+     &quot;gliederung1&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung2&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung2&quot;)>25 then '\n'+left(&quot;gliederung2&quot;,25)+'...'&#xd;&#xa;when length(&quot;gliederung2&quot;)&lt;26 then '\n'+     &quot;gliederung2&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;aufschrift&quot; is not null) then   case &#xd;&#xa;when length(&quot;aufschrift&quot;)>25 then '\n'+left(&quot;aufschrift&quot;,25)+'...'&#xd;&#xa;when length(&quot;aufschrift&quot;)&lt;26 then '\n'+     &quot;aufschrift&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case  /* name nach Spezifikation zulässig  */&#xd;&#xa;when try(array_length(&quot;name&quot;)>0) then   &quot;&quot;&#xd;&#xa;when length(&quot;name&quot;)>25 then '\n'+left(&quot;name&quot;,25)+'...'&#xd;&#xa;when length(&quot;name&quot;)&lt;26 then '\n'+     &quot;name&quot;  &#xd;&#xa;ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;nummer&quot; is not null) then   case &#xd;&#xa;when length(&quot;nummer&quot;)>25 then '\n'+left(&quot;nummer&quot;,25)+'...'&#xd;&#xa;when length(&quot;nummer&quot;)&lt;26 then '\n'+     &quot;nummer&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;/* Ergänzung für Codelisten - vorher prüfen, ob es überhaupt eine gibt und ! ob sie Werte enthält&#xd;&#xa;https://registry.gdi-de.org/codelist/de.xleitstelle.xplanung/SO_DetailKlassifizSchutzgebietSonstRecht am 03.01.23 ohne Einträge */&#xd;&#xa;+ CASE &#xd;&#xa;WHEN try(detailArtDerFestlegung is not NULL,'-') THEN  '\n' + to_string(&quot;detailArtDerFestlegung&quot;)&#xd;&#xa;ELSE '' &#xd;&#xa;END&#xd;&#xa;" fontItalic="0" useSubstitutions="0">
        ...
        <background shapeSizeType="0" shapeRadiiUnit="Point" shapeFillColor="255,255,255,255" shapeOpacity="1" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeSizeY="3" shapeRotation="0" shapeRadiiX="0" shapeRotationType="0" shapeOffsetX="0" shapeOffsetUnit="Point" shapeSizeX="3" shapeDraw="1" shapeRadiiY="0" shapeType="0" shapeBorderColor="128,128,128,255" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="Point" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeSizeUnit="Point" shapeBorderWidth="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0">
      ...
      <text-format rightDirectionSymbol=">" decimals="3" addDirectionSymbol="0" wrapChar="" multilineAlign="0" formatNumbers="0" autoWrapLength="50" placeDirectionSymbol="0" reverseDirectionSymbol="0" plussign="0" useMaxLineLengthForAutoWrap="1" leftDirectionSymbol="&lt;"/>
      <placement offsetType="0" distUnits="MM" placementFlags="10" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" allowDegraded="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" xOffset="0" centroidInside="0" geometryGenerator="" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="8" rotationAngle="0" dist="20" overlapHandling="AllowOverlapIfRequired" priority="5" geometryGeneratorType="PointGeometry" repeatDistance="0" repeatDistanceUnits="MM" layerType="PolygonGeometry" yOffset="0" overrunDistance="0" maxCurvedCharAngleOut="-25" offsetUnits="MM" maxCurvedCharAngleIn="25" centroidWhole="0" lineAnchorClipping="0" rotationUnit="AngleDegrees" lineAnchorPercent="0.5" fitInPolygonOnly="0" polygonPlacementFlags="2" distMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" lineAnchorTextPoint="FollowPlacement" lineAnchorType="0"/>
      <rendering fontMinPixelSize="3" scaleMax="8000" scaleMin="999" obstacleFactor="1" obstacle="1" unplacedVisibility="0" minFeatureSize="0" maxNumLabels="2000" fontMaxPixelSize="10000" fontLimitPixelSize="0" zIndex="0" drawLabels="1" mergeLines="0" upsidedownLabels="0" limitNumLabels="0" scaleVisibility="1" labelPerPart="0" obstacleType="1"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option type="Map" name="properties">
            <Option type="Map" name="LabelDistance">
              ...
              <Option type="QString" name="expression" value="'BP_Plan_01929d58_1eba_4dd0_b63d_0c006870603f'"/>
              <Option type="int" name="type" value="3"/>
            </Option>
            <Option type="Map" name="PositionPoint">
              <Option type="bool" name="active" value="true"/>
              <Option type="QString" name="expression" value="closest_point(&#xd;&#xa;exterior_ring(buffer(exterior_ring(&#xd;&#xa;aggregate(layer:=plan_layer_id(), aggregate:='collect', expression:= force_polygon_cw( $geometry )))&#xd;&#xa;, @map_scale/60)), &#xd;&#xa;point_on_surface($geometry)&#xd;&#xa;)"/>
              <Option type="int" name="type" value="3"/>
            </Option>
          </Option>
          <Option type="QString" name="type" value="collection"/>
