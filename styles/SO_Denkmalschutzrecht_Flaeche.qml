...
<qgis labelsEnabled="1" version="3.26.3-Buenos Aires" styleCategories="Symbology|Labeling">
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0" referencescale="-1">
    <rules key="{db187956-0363-4e24-8205-d2ad3376c80f}">
      ...
      <rule symbol="1" label="artDerFestlegung nicht definiert" filter=" &quot;artDerFestlegung&quot; is NULL" key="{2a489548-4cff-4280-b827-4f605e169df0}"/>
    </rules>
    <symbols>
      <symbol name="0" type="fill" is_animated="0" force_rhr="0" frame_rate="10" clip_to_extent="1" alpha="1">
        ...
        <layer class="PointPatternFill" enabled="1" locked="0" pass="0">
          ...
          <symbol name="@0@0" type="marker" is_animated="0" force_rhr="0" frame_rate="10" clip_to_extent="1" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol name="1" type="fill" is_animated="0" force_rhr="0" frame_rate="10" clip_to_extent="1" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSize="7" forcedItalic="0" fontKerning="1" isExpression="1" fontWeight="50" fontItalic="0" fieldName="'SO Denkmalschutzrecht' + &#xd;&#xa;&#xd;&#xa;CASE &#xd;&#xa;WHEN try(artDerFestlegung is not NULL,'-') THEN &#xd;&#xa;&#x9;CASE &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1000 THEN '\n' +'Denkmalschutz Ensemble' &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1100 THEN '\n' +'Denkmalschutz Einzelanlage' &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1200 THEN '\n' +'Grabungsschutzgebiet' &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1300 THEN '\n' +'Engere Pufferzone Welterbestätte' &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1400 THEN '\n' +'Weitere Pufferzone Welterbestätte' &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1500 THEN '\n' +'Archäologisches Denkmal'  &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1600 THEN '\n' +'Bodendenkmal' &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 9999 THEN '\n' +'Sonst. Denkmalschutzrecht' &#xd;&#xa;&#x9;ELSE ''&#xd;&#xa;&#x9;END&#xd;&#xa;ELSE '' &#xd;&#xa;END&#xd;&#xa;/* ab hier ein copy&amp;paste Block für alle SO-Flächen */&#xd;&#xa;+ case when try(&quot;text&quot; is not null) then   case &#xd;&#xa;when length(&quot;text&quot;)>25 then '\n'+left(&quot;text&quot;,25)+'...'&#xd;&#xa;when length(&quot;text&quot;)&lt;26 then '\n'+     &quot;text&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;textlicheErgaenzung&quot; is not null) then   case &#xd;&#xa;when length(&quot;textlicheErgaenzung&quot;)>25 then '\n'+left(&quot;textlicheErgaenzung&quot;,25)+'...'&#xd;&#xa;when length(&quot;textlicheErgaenzung&quot;)&lt;26 then '\n'+     &quot;textlicheErgaenzung&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung1&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung1&quot;)>25 then '\n'+left(&quot;gliederung1&quot;,25)+'...'&#xd;&#xa;when length(&quot;gliederung1&quot;)&lt;26 then '\n'+     &quot;gliederung1&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung2&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung2&quot;)>25 then '\n'+left(&quot;gliederung2&quot;,25)+'...'&#xd;&#xa;when length(&quot;gliederung2&quot;)&lt;26 then '\n'+     &quot;gliederung2&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;aufschrift&quot; is not null) then   case &#xd;&#xa;when length(&quot;aufschrift&quot;)>25 then '\n'+left(&quot;aufschrift&quot;,25)+'...'&#xd;&#xa;when length(&quot;aufschrift&quot;)&lt;26 then '\n'+     &quot;aufschrift&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case  /* name nach Spezifikation zulässig  */&#xd;&#xa;when try(array_length(&quot;name&quot;)>0) then   &quot;&quot;&#xd;&#xa;when length(&quot;name&quot;)>25 then '\n'+left(&quot;name&quot;,25)+'...'&#xd;&#xa;when length(&quot;name&quot;)&lt;26 then '\n'+     &quot;name&quot;  &#xd;&#xa;ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;nummer&quot; is not null) then   case &#xd;&#xa;when length(&quot;nummer&quot;)>25 then '\n'+left(&quot;nummer&quot;,25)+'...'&#xd;&#xa;when length(&quot;nummer&quot;)&lt;26 then '\n'+     &quot;nummer&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;/* Ergänzung für Codelisten - vorher prüfen, ob es überhaupt eine gibt und ! ob sie Werte enthält&#xd;&#xa;https://registry.gdi-de.org/codelist/de.xleitstelle.xplanung/SO_DetailKlassifizSchutzgebietSonstRecht am 03.01.23 ohne Einträge */&#xd;&#xa;+ CASE &#xd;&#xa;WHEN try(detailArtDerFestlegung is not NULL,'-') THEN  '\n' + to_string(&quot;detailArtDerFestlegung&quot;)&#xd;&#xa;ELSE '' &#xd;&#xa;END&#xd;&#xa;&#xd;&#xa;" multilineHeight="1" fontSizeUnit="Point" capitalization="0" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal" fontFamily="Arial" allowHtml="0" blendMode="0" fontWordSpacing="0" forcedBold="0" fontUnderline="0" namedStyle="Standard" textOpacity="1" legendString="Aa" fontStrikeout="0" previewBkgrdColor="255,255,255,255" textColor="114,114,114,255" fontLetterSpacing="0">
        <families/>
        <text-buffer bufferJoinStyle="128" bufferOpacity="1" bufferSizeUnits="MM" bufferSize="1" bufferColor="250,250,250,255" bufferNoFill="1" bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0"/>
        <text-mask maskSizeUnits="MM" maskSize="0" maskOpacity="1" maskType="0" maskEnabled="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskedSymbolLayers=""/>
        <background shapeBorderWidth="0" shapeRadiiX="0" shapeBorderWidthUnit="Point" shapeSizeX="3" shapeBorderColor="128,128,128,255" shapeSizeType="0" shapeOffsetX="0" shapeOffsetY="0" shapeSVGFile="" shapeRadiiUnit="Point" shapeSizeUnit="Point" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="Point" shapeRotation="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeRotationType="0" shapeRadiiY="0" shapeFillColor="255,255,255,255" shapeOpacity="1" shapeSizeY="3" shapeDraw="1" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0">
          <symbol name="markerSymbol" type="marker" is_animated="0" force_rhr="0" frame_rate="10" clip_to_extent="1" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
          ...
          <symbol name="fillSymbol" type="fill" is_animated="0" force_rhr="0" frame_rate="10" clip_to_extent="1" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <shadow shadowOffsetAngle="135" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowScale="100" shadowRadiusAlphaOnly="0" shadowOpacity="0.69999999999999996" shadowDraw="0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowRadius="1.5" shadowRadiusUnit="MM" shadowUnder="0" shadowOffsetUnit="MM" shadowOffsetGlobal="1" shadowColor="0,0,0,255" shadowBlendMode="6" shadowOffsetDist="1"/>
        <dd_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <text-format reverseDirectionSymbol="0" plussign="0" addDirectionSymbol="0" autoWrapLength="50" wrapChar="" multilineAlign="0" decimals="3" formatNumbers="0" placeDirectionSymbol="0" rightDirectionSymbol=">" leftDirectionSymbol="&lt;" useMaxLineLengthForAutoWrap="1"/>
      <placement repeatDistance="0" geometryGeneratorType="PointGeometry" preserveRotation="1" priority="5" xOffset="0" distUnits="MM" centroidInside="0" quadOffset="4" maxCurvedCharAngleIn="25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorTextPoint="FollowPlacement" overrunDistanceUnit="MM" overlapHandling="AllowOverlapIfRequired" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" placement="8" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" polygonPlacementFlags="2" geometryGenerator="" placementFlags="10" layerType="PolygonGeometry" offsetType="0" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" rotationAngle="0" maxCurvedCharAngleOut="-25" allowDegraded="0" overrunDistance="0" repeatDistanceUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" yOffset="0" fitInPolygonOnly="0" lineAnchorType="0" rotationUnit="AngleDegrees" geometryGeneratorEnabled="0" lineAnchorPercent="0.5" dist="0"/>
      <rendering fontMaxPixelSize="10000" zIndex="0" minFeatureSize="0" fontLimitPixelSize="0" maxNumLabels="2000" obstacle="1" upsidedownLabels="0" scaleMax="2001" scaleMin="0" mergeLines="0" obstacleFactor="1" scaleVisibility="1" fontMinPixelSize="3" limitNumLabels="0" unplacedVisibility="0" labelPerPart="0" drawLabels="1" obstacleType="1"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties" type="Map">
            <Option name="MinimumScale" type="Map">
              ...
              <Option name="expression" type="QString" value="Case&#xd;&#xa;when try(aggregate('BP_Plan', 'array_agg', &quot;name&quot;) is not NULL) then 2001&#xd;&#xa;when try(aggregate('FP_Plan', 'array_agg', &quot;name&quot;) is not NULL) then 32001&#xd;&#xa;ELSE''&#xd;&#xa;END"/>
