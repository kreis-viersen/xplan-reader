...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.28.4-Firenze">
  <renderer-v2 forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0" referencescale="-1">
    ...
    <symbols>
      <symbol clip_to_extent="1" frame_rate="10" type="fill" force_rhr="0" name="0" is_animated="0" alpha="1">
        ...
        <layer enabled="1" locked="0" class="PointPatternFill" pass="0">
          <Option type="Map">
            ...
            <Option value="925295365" type="QString" name="seed"/>
          </Option>
          <data_defined_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
          ...
          <symbol clip_to_extent="1" frame_rate="10" type="marker" force_rhr="0" name="@0@0" is_animated="0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" frame_rate="10" type="fill" force_rhr="0" name="1" is_animated="0" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="7" textColor="114,114,114,255" fontLetterSpacing="0" multilineHeight="1" previewBkgrdColor="255,255,255,255" isExpression="1" fontWeight="50" fontSizeUnit="Point" fieldName="'SO Denkmalschutzrecht' + &#xd;&#xa;&#xd;&#xa;CASE &#xd;&#xa;WHEN try(artDerFestlegung is not NULL,'-') THEN &#xd;&#xa;&#x9;CASE &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1000 THEN '\n' +'Denkmalschutz Ensemble' &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1100 THEN '\n' +'Denkmalschutz Einzelanlage' &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1200 THEN '\n' +'Grabungsschutzgebiet' &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1300 THEN '\n' +'Engere Pufferzone Welterbestätte' &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1400 THEN '\n' +'Weitere Pufferzone Welterbestätte' &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1500 THEN '\n' +'Archäologisches Denkmal'  &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 1600 THEN '\n' +'Bodendenkmal' &#xd;&#xa;    WHEN &quot;artDerFestlegung&quot;= 9999 THEN '\n' +'Sonst. Denkmalschutzrecht' &#xd;&#xa;&#x9;ELSE ''&#xd;&#xa;&#x9;END&#xd;&#xa;ELSE '' &#xd;&#xa;END&#xd;&#xa;/* ab hier ein copy&amp;paste Block für alle SO-Flächen */&#xd;&#xa;+ case when try(&quot;text&quot; is not null) then   case &#xd;&#xa;when length(&quot;text&quot;)>25 then '\n'+left(&quot;text&quot;,25)+'...'&#xd;&#xa;when length(&quot;text&quot;)&lt;26 then '\n'+     &quot;text&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;textlicheErgaenzung&quot; is not null) then   case &#xd;&#xa;when length(&quot;textlicheErgaenzung&quot;)>25 then '\n'+left(&quot;textlicheErgaenzung&quot;,25)+'...'&#xd;&#xa;when length(&quot;textlicheErgaenzung&quot;)&lt;26 then '\n'+     &quot;textlicheErgaenzung&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung1&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung1&quot;)>25 then '\n'+left(&quot;gliederung1&quot;,25)+'...'&#xd;&#xa;when length(&quot;gliederung1&quot;)&lt;26 then '\n'+     &quot;gliederung1&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung2&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung2&quot;)>25 then '\n'+left(&quot;gliederung2&quot;,25)+'...'&#xd;&#xa;when length(&quot;gliederung2&quot;)&lt;26 then '\n'+     &quot;gliederung2&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;aufschrift&quot; is not null) then   case &#xd;&#xa;when length(&quot;aufschrift&quot;)>25 then '\n'+left(&quot;aufschrift&quot;,25)+'...'&#xd;&#xa;when length(&quot;aufschrift&quot;)&lt;26 then '\n'+     &quot;aufschrift&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case  /* name nach Spezifikation zulässig  */&#xd;&#xa;when try(array_length(&quot;name&quot;)>0) then   &quot;&quot;&#xd;&#xa;when length(&quot;name&quot;)>25 then '\n'+left(&quot;name&quot;,25)+'...'&#xd;&#xa;when length(&quot;name&quot;)&lt;26 then '\n'+     &quot;name&quot;  &#xd;&#xa;ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;nummer&quot; is not null) then   case &#xd;&#xa;when length(&quot;nummer&quot;)>25 then '\n'+left(&quot;nummer&quot;,25)+'...'&#xd;&#xa;when length(&quot;nummer&quot;)&lt;26 then '\n'+     &quot;nummer&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;weltkulturerbe&quot; is true) then '\n'+'Weltkulturerbe' Else'' End&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;/* Ergänzung für Codelisten - vorher prüfen, ob es überhaupt eine gibt und ! ob sie Werte enthält&#xd;&#xa;https://registry.gdi-de.org/codelist/de.xleitstelle.xplanung/SO_DetailKlassifizSchutzgebietSonstRecht am 03.01.23 ohne Einträge */&#xd;&#xa;+ CASE &#xd;&#xa;WHEN try(detailArtDerFestlegung is not NULL,'-') THEN  '\n' + to_string(&quot;detailArtDerFestlegung&quot;)&#xd;&#xa;ELSE '' &#xd;&#xa;END&#xd;&#xa;&#xd;&#xa;" useSubstitutions="0" textOpacity="1" namedStyle="Regular" fontUnderline="0" blendMode="0" forcedItalic="0" fontWordSpacing="0" multilineHeightUnit="Percentage" fontFamily="Arial" allowHtml="0" forcedBold="0" fontStrikeout="0" legendString="Aa" textOrientation="horizontal" fontKerning="1" fontItalic="0" capitalization="0">
        ...
        <background shapeType="0" shapeDraw="1" shapeOpacity="1" shapeBlendMode="0" shapeBorderColor="128,128,128,255" shapeOffsetX="0" shapeRotationType="0" shapeRadiiX="0" shapeSVGFile="" shapeRadiiUnit="Point" shapeSizeUnit="Point" shapeRadiiY="0" shapeOffsetY="0" shapeRotation="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeX="3" shapeSizeY="3" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeBorderWidthUnit="Point" shapeFillColor="255,255,255,255" shapeJoinStyle="64" shapeBorderWidth="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="Point" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0">
      ...
      <text-format multilineAlign="0" formatNumbers="0" rightDirectionSymbol=">" leftDirectionSymbol="&lt;" autoWrapLength="50" reverseDirectionSymbol="0" placeDirectionSymbol="0" wrapChar="" useMaxLineLengthForAutoWrap="1" decimals="3" plussign="0" addDirectionSymbol="0"/>
      <placement lineAnchorClipping="0" yOffset="0" geometryGeneratorType="PointGeometry" rotationUnit="AngleDegrees" repeatDistanceUnits="MM" overrunDistance="0" lineAnchorType="0" centroidInside="0" polygonPlacementFlags="2" lineAnchorTextPoint="FollowPlacement" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" overrunDistanceUnit="MM" offsetUnits="MM" lineAnchorPercent="0.5" xOffset="0" allowDegraded="0" placementFlags="10" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" layerType="PolygonGeometry" centroidWhole="0" overlapHandling="AllowOverlapIfRequired" offsetType="0" preserveRotation="1" quadOffset="4" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" fitInPolygonOnly="0" placement="8" geometryGeneratorEnabled="0" distMapUnitScale="3x:0,0,0,0,0,0" dist="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="5" distUnits="MM" geometryGenerator=""/>
      <rendering obstacleFactor="1" zIndex="0" fontMinPixelSize="3" drawLabels="1" maxNumLabels="2000" fontMaxPixelSize="10000" scaleVisibility="1" limitNumLabels="0" upsidedownLabels="0" scaleMin="0" fontLimitPixelSize="0" obstacle="1" minFeatureSize="0" scaleMax="2001" obstacleType="1" labelPerPart="0" unplacedVisibility="0" mergeLines="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
