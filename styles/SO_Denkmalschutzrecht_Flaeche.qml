...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.26.3-Buenos Aires">
      ...
      <symbol clip_to_extent="1" is_animated="0" name="0" alpha="1" type="fill" frame_rate="10" force_rhr="0">
        ...
        <layer enabled="1" locked="0" class="PointPatternFill" pass="0">
          <Option type="Map">
            ...
            <Option value="925295365" name="seed" type="QString"/>
          </Option>
          <prop v="0" k="angle"/>
          ...
          <symbol clip_to_extent="1" is_animated="0" name="@0@0" alpha="1" type="marker" frame_rate="10" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" rightDirectionSymbol=">" autoWrapLength="50" reverseDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" addDirectionSymbol="0" placeDirectionSymbol="0" plussign="0" multilineAlign="0"/>
      <placement maxCurvedCharAngleOut="-25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorPercent="0.5" repeatDistance="0" offsetUnits="MM" placement="8" overlapHandling="AllowOverlapIfRequired" distUnits="MM" centroidWhole="0" geometryGeneratorType="PointGeometry" geometryGenerator="" overrunDistance="0" fitInPolygonOnly="0" rotationUnit="AngleDegrees" xOffset="0" priority="5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" rotationAngle="0" allowDegraded="0" lineAnchorClipping="0" placementFlags="10" dist="20" lineAnchorType="0" geometryGeneratorEnabled="0" preserveRotation="1" offsetType="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" polygonPlacementFlags="2" lineAnchorTextPoint="FollowPlacement" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" centroidInside="0" layerType="PolygonGeometry" yOffset="0"/>
      <rendering minFeatureSize="0" obstacleType="1" scaleMin="0" fontLimitPixelSize="0" drawLabels="1" maxNumLabels="2000" obstacle="1" fontMaxPixelSize="10000" unplacedVisibility="0" mergeLines="0" fontMinPixelSize="3" limitNumLabels="0" upsidedownLabels="0" labelPerPart="0" obstacleFactor="1" scaleMax="2001" zIndex="0" scaleVisibility="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties" type="Map">
            <Option name="LabelDistance" type="Map">
              ...
              <Option value="'BP_Plan_01929d58_1eba_4dd0_b63d_0c006870603f'" name="expression" type="QString"/>
