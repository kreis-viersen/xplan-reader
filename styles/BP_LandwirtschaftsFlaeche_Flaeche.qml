...
<qgis version="3.28.3-Firenze" styleCategories="Symbology|Labeling" labelsEnabled="1">
      ...
      <symbol alpha="1" name="0" clip_to_extent="1" force_rhr="0" is_animated="0" type="fill" frame_rate="10">
        ...
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          <Option type="Map">
            ...
            <Option name="color" value="204,233,104,255" type="QString"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement lineAnchorType="0" maxCurvedCharAngleIn="25" offsetUnits="MM" placementFlags="10" rotationAngle="0" centroidWhole="0" yOffset="0" layerType="PolygonGeometry" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" dist="0" repeatDistanceUnits="MM" lineAnchorClipping="0" allowDegraded="0" preserveRotation="1" geometryGeneratorEnabled="0" geometryGeneratorType="PointGeometry" rotationUnit="AngleDegrees" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" overrunDistanceUnit="MM" lineAnchorTextPoint="FollowPlacement" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" priority="5" offsetType="0" geometryGenerator="" centroidInside="0" polygonPlacementFlags="2" overlapHandling="PreventOverlap" placement="0" lineAnchorPercent="0.5" maxCurvedCharAngleOut="-25" repeatDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR"/>
