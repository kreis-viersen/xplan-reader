  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" referencescale="-1" type="RuleRenderer">
    ...
    <symbols>
      <symbol frame_rate="10" name="0" is_animated="0" clip_to_extent="1" type="fill" alpha="1" force_rhr="0">
        ...
        <layer id="{47b86e2c-4a7a-4d70-8b20-7aa113313be5}" pass="0" locked="0" class="SimpleFill" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale" type="QString"/>
            <Option value="255,225,94,128" name="color" type="QString"/>
      ...
      <symbol frame_rate="10" name="13" is_animated="0" clip_to_extent="1" type="fill" alpha="1" force_rhr="0">
        ...
        <layer id="{affa0858-6457-4976-9c83-e694e387401c}" pass="0" locked="0" class="SimpleFill" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol frame_rate="10" name="" is_animated="0" clip_to_extent="1" type="fill" alpha="1" force_rhr="0">
        ...
        <layer id="{9eab89bc-9ddc-43a5-be62-2eb1b494abfd}" pass="0" locked="0" class="SimpleFill" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale" type="QString"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style allowHtml="0" fontSize="8" namedStyle="Standard" fontLetterSpacing="0" fontWeight="50" useSubstitutions="0" forcedItalic="0" legendString="Aa" multilineHeight="1" fontItalic="0" fontSizeUnit="Point" textColor="0,0,0,255" textOrientation="horizontal" fontKerning="1" capitalization="0" fontUnderline="0" forcedBold="0" multilineHeightUnit="Percentage" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" fontFamily="Arial" blendMode="0" fontWordSpacing="0" isExpression="1" fieldName="Case When try(gebietsTyp is not null) then &#xd;&#xa;&#x9;Case&#xd;&#xa;&#x9;When gebietsTyp=1000 then 'Vorranggebiet'&#xd;&#xa;&#x9;When gebietsTyp=1001 then 'Vorrangstandort'&#xd;&#xa;&#x9;When gebietsTyp=1100 then 'Vorbehaltsgebiet'&#xd;&#xa;&#x9;When gebietsTyp=1101 then 'Vorbehaltsstandort'&#xd;&#xa;&#x9;When gebietsTyp=1200 then 'Eignungsgebiet'&#xd;&#xa;&#x9;When gebietsTyp=1300 then 'Vorrang&amp;Eignungsgebiet'&#xd;&#xa;&#x9;When gebietsTyp=1400 then 'Ausschlussgebiet'&#xd;&#xa;&#x9;When gebietsTyp=1500 then 'Vorsorgegebiet'&#xd;&#xa;&#x9;When gebietsTyp=1501 then 'Vorsorgestandort'&#xd;&#xa;&#x9;When gebietsTyp=1600 then 'Vorzugsraum'&#xd;&#xa;&#x9;When gebietsTyp=1700 then 'Potenzialgebiet'&#xd;&#xa;&#x9;When gebietsTyp=1800 then 'Schwerpunktraum'&#xd;&#xa;&#x9;When gebietsTyp=9999 then 'SonstigesGebiet'&#xd;&#xa;&#x9;Else ''&#x9;End &#xd;&#xa;ELSE 'gebietsTyp nicht definiert' End &#xd;&#xa;&#xd;&#xa;+case when try(&quot;typ&quot;is not NULL)then'\n'ELSE''END&#xd;&#xa;+replace(case when try(&quot;typ&quot;is not NULL)then array_to_string(array_foreach(case when try(array_length(&quot;typ&quot;)>=0)then &quot;typ&quot; Else array(&quot;typ&quot;)end,&#xd;&#xa;case&#xd;&#xa;WHEN @element=1000 THEN 'Leitungstrasse' &#xd;&#xa;WHEN @element=1001 THEN 'Hochspannungsleitung' &#xd;&#xa;WHEN @element=1002 THEN 'Kabeltrasse-Netzanbindung'&#xd;&#xa;WHEN @element=2000 then 'Pipeline'&#xd;&#xa;WHEN @element=2001 then 'Übergabestation'&#xd;&#xa;WHEN @element=3000 then 'Kraftwerk'&#xd;&#xa;WHEN @element=3001 then 'Großkraftwerk'&#xd;&#xa;WHEN @element=3002 then 'Energiegewinnung'&#xd;&#xa;WHEN @element=4000 then 'Energiespeicherung'&#xd;&#xa;WHEN @element=4001 then 'Verstetigung-Speicherung'&#xd;&#xa;WHEN @element=4002 then 'Untergrundspeicher'&#xd;&#xa;WHEN @element=5000 then 'Umspannwerk'&#xd;&#xa;WHEN @element=6000 then 'Raffinerie'&#xd;&#xa;WHEN @element=7000 then 'Leitungsabbau'&#xd;&#xa;WHEN @element=8000 then 'Korridor'&#xd;&#xa;WHEN @element=9999 then 'sonst.Energieversorgung'&#xd;&#xa;else ''end&#xd;&#xa;)) ELSE ''END ,',', '\n' )&#xd;&#xa;&#xd;&#xa;+replace(case when try(&quot;primaerenergieTyp&quot;is not NULL)then array_to_string(array_foreach(case when try(array_length(&quot;primaerenergieTyp&quot;)>=0)then &quot;primaerenergieTyp&quot; Else array(&quot;primaerenergieTyp&quot;)end,&#xd;&#xa;case&#xd;&#xa;WHEN @element=1000 then '\nErdöl'&#xd;&#xa;WHEN @element=2000 then '\nGas'&#xd;&#xa;WHEN @element=2001 then '\nFerngas'&#xd;&#xa;WHEN @element=3000 then '\nFernwärme'&#xd;&#xa;WHEN @element=4000 then '\nKraftstoff'&#xd;&#xa;WHEN @element=5000 then '\nKohle'&#xd;&#xa;WHEN @element=6000 then '\nWasser'&#xd;&#xa;WHEN @element=7000 then '\nKernenergie'&#xd;&#xa;WHEN @element=8000 then '\nReststoffverwertung&#x9;'&#xd;&#xa;WHEN @element=9000 then '\nerneuerbare Energie'&#xd;&#xa;WHEN @element=9001 then '\nWindenergie'&#xd;&#xa;WHEN @element=9999 then '\nsonst.Primärenergie'&#xd;&#xa;else 'primaerenergieTyp nicht definiert'end&#xd;&#xa;)) ELSE '\nprimaerenergieTyp nicht definiert'END ,',', '\n' )&#xd;&#xa; &#xd;&#xa;&#xd;&#xa;+ case&#xd;&#xa;when  try(&quot;spannung&quot; is not null) then&#xd;&#xa;&#x9;case&#xd;&#xa;&#x9;when  &quot;spannung&quot; =1000 then '\n110KV'&#xd;&#xa;&#x9;when  &quot;spannung&quot; =2000 then '\n220KV'&#xd;&#xa;&#x9;when  &quot;spannung&quot; =3000 then '\n330KV'&#xd;&#xa;&#x9;when  &quot;spannung&quot; =4000 then '\n380KV'&#xd;&#xa;&#x9;Else '' end &#xd;&#xa;ELSE '' END &#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;text&quot; is not null) then   case &#xd;&#xa;when length(&quot;text&quot;)>25 then '\n'+left(replace(&quot;text&quot;,'\n',' '),25)+'...'&#xd;&#xa;when length(&quot;text&quot;)&lt;26 then '\n'+     replace(&quot;text&quot;,'\n',' ')  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung1&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung1&quot;)>25 then '\n'+left(&quot;gliederung1&quot;,25)+'...'&#xd;&#xa;when length(&quot;gliederung1&quot;)&lt;26 then '\n'+     &quot;gliederung1&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung2&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung2&quot;)>25 then '\n'+left(&quot;gliederung2&quot;,25)+'...'&#xd;&#xa;when length(&quot;gliederung2&quot;)&lt;26 then '\n'+     &quot;gliederung2&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;aufschrift&quot; is not null) then   case &#xd;&#xa;when length(&quot;aufschrift&quot;)>25 then '\n'+left(&quot;aufschrift&quot;,25)+'...'&#xd;&#xa;when length(&quot;aufschrift&quot;)&lt;26 then '\n'+     &quot;aufschrift&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;" textOpacity="1">
        <families/>
        <text-buffer bufferSizeUnits="Percentage" bufferNoFill="1" bufferSize="25" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferJoinStyle="128" bufferDraw="1" bufferOpacity="1" bufferColor="231,226,91,255"/>
      ...
      <callout type="simple">
        <Option type="Map">
          ...
          <Option value="&lt;symbol frame_rate=&quot;10&quot; name=&quot;symbol&quot; is_animated=&quot;0&quot; clip_to_extent=&quot;1&quot; type=&quot;line&quot; alpha=&quot;1&quot; force_rhr=&quot;0&quot;>&lt;data_defined_properties>&lt;Option type=&quot;Map&quot;>&lt;Option value=&quot;&quot; name=&quot;name&quot; type=&quot;QString&quot;/>&lt;Option name=&quot;properties&quot;/>&lt;Option value=&quot;collection&quot; name=&quot;type&quot; type=&quot;QString&quot;/>&lt;/Option>&lt;/data_defined_properties>&lt;layer id=&quot;{72e4844c-0354-4267-8848-90ebdaa119a1}&quot; pass=&quot;0&quot; locked=&quot;0&quot; class=&quot;SimpleLine&quot; enabled=&quot;1&quot;>&lt;Option type=&quot;Map&quot;>&lt;Option value=&quot;0&quot; name=&quot;align_dash_pattern&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;square&quot; name=&quot;capstyle&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;5;2&quot; name=&quot;customdash&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;3x:0,0,0,0,0,0&quot; name=&quot;customdash_map_unit_scale&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;MM&quot; name=&quot;customdash_unit&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;0&quot; name=&quot;dash_pattern_offset&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;3x:0,0,0,0,0,0&quot; name=&quot;dash_pattern_offset_map_unit_scale&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;MM&quot; name=&quot;dash_pattern_offset_unit&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;0&quot; name=&quot;draw_inside_polygon&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;bevel&quot; name=&quot;joinstyle&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;60,60,60,255&quot; name=&quot;line_color&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;solid&quot; name=&quot;line_style&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;0.3&quot; name=&quot;line_width&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;MM&quot; name=&quot;line_width_unit&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;0&quot; name=&quot;offset&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;3x:0,0,0,0,0,0&quot; name=&quot;offset_map_unit_scale&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;MM&quot; name=&quot;offset_unit&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;0&quot; name=&quot;ring_filter&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;0&quot; name=&quot;trim_distance_end&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;3x:0,0,0,0,0,0&quot; name=&quot;trim_distance_end_map_unit_scale&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;MM&quot; name=&quot;trim_distance_end_unit&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;0&quot; name=&quot;trim_distance_start&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;3x:0,0,0,0,0,0&quot; name=&quot;trim_distance_start_map_unit_scale&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;MM&quot; name=&quot;trim_distance_start_unit&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;0&quot; name=&quot;tweak_dash_pattern_on_corners&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;0&quot; name=&quot;use_custom_dash&quot; type=&quot;QString&quot;/>&lt;Option value=&quot;3x:0,0,0,0,0,0&quot; name=&quot;width_map_unit_scale&quot; type=&quot;QString&quot;/>&lt;/Option>&lt;data_defined_properties>&lt;Option type=&quot;Map&quot;>&lt;Option value=&quot;&quot; name=&quot;name&quot; type=&quot;QString&quot;/>&lt;Option name=&quot;properties&quot;/>&lt;Option value=&quot;collection&quot; name=&quot;type&quot; type=&quot;QString&quot;/>&lt;/Option>&lt;/data_defined_properties>&lt;/layer>&lt;/symbol>" name="lineSymbol" type="QString"/>
