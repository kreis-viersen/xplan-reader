...
<qgis maxScale="0" labelsEnabled="1" simplifyDrawingHints="1" simplifyMaxScale="1" version="3.34.0-Prizren" simplifyDrawingTol="1" styleCategories="Symbology|Labeling|MapTips|Rendering" minScale="0" simplifyLocal="1" symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0">
  <renderer-v2 referencescale="-1" type="RuleRenderer" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{509fbfec-cd80-4b78-a2e5-cc4d5144b0c5}">
      <rule symbol="0" key="{c4d3f514-c579-4dff-af82-b48a5f1030d6}" label="alles"/>
      <rule symbol="1" key="{86984889-98d0-4ab5-9902-01b6192fe4a8}" filter="Try(&quot;zweckbestimmung&quot; is Null)" label="davon ohne Zweckbestimmung"/>
    </rules>
    <symbols>
      <symbol type="fill" name="0" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
        ...
        <layer enabled="1" pass="0" id="{4731335a-7b6b-4f60-828c-f70dd8cbff44}" class="LinePatternFill" locked="0">
          <Option type="Map">
            <Option value="45" type="QString" name="angle"/>
            <Option value="during_render" type="QString" name="clip_mode"/>
            <Option value="35,115,235,179" type="QString" name="color"/>
          ...
          <symbol type="line" name="@0@0" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            ...
            <layer enabled="1" pass="0" id="{13769af6-3a32-4cc6-a4d3-63019000b78f}" class="SimpleLine" locked="0">
              <Option type="Map">
                ...
                <Option value="35,115,235,179" type="QString" name="line_color"/>
        ...
        <layer enabled="1" pass="0" id="{ed840a27-ed35-4092-aa76-aec1831a45b8}" class="LinePatternFill" locked="0">
          <Option type="Map">
          ...
          <symbol type="line" name="@0@1" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" pass="0" id="{7f4a2f88-4dad-49d1-8201-13009106dcf9}" class="SimpleLine" locked="0">
              <Option type="Map">
                <Option value="0" type="QString" name="align_dash_pattern"/>
                <Option value="square" type="QString" name="capstyle"/>
                <Option value="5;2" type="QString" name="customdash"/>
        ...
        <layer enabled="1" pass="0" id="{14087272-d80a-486c-b618-4be5b3a211e9}" class="SimpleFill" locked="0">
          <Option type="Map">
      ...
      <symbol type="fill" name="1" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
        ...
        <layer enabled="1" pass="0" id="{703ae012-d03c-40bc-8b66-8badf4b427d5}" class="SimpleFill" locked="0">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="fill" name="" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
        ...
        <layer enabled="1" pass="0" id="{abe94393-505e-4405-a7ff-25d074f99d63}" class="SimpleFill" locked="0">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style isExpression="1" fontUnderline="0" forcedItalic="0" legendString="Aa" capitalization="0" blendMode="0" multilineHeightUnit="Percentage" fieldName="'Wasserwirtschaft'+ '\n' &#xd;&#xa;+&#xd;&#xa; CASE &#xd;&#xa; WHEN try(&quot;zweckbestimmung&quot;= 1000) THEN 'Hochwasser-\nrückhaltebecken' &#xd;&#xa; WHEN try(&quot;zweckbestimmung&quot;= 1100) THEN 'Überschwemm.gefährdetes\nGebiet' &#xd;&#xa; WHEN try(&quot;zweckbestimmung&quot;= 1200) THEN 'Versickerungs-\nfläche' &#xd;&#xa; WHEN try(&quot;zweckbestimmung&quot;= 1300) THEN 'Entwässerungs-\ngraben' &#xd;&#xa; WHEN try(&quot;zweckbestimmung&quot;= 1400) THEN 'Deich' &#xd;&#xa; WHEN try(&quot;zweckbestimmung&quot;= 1500) THEN 'Regenrück-\nhaltebecken' &#xd;&#xa; WHEN try(&quot;zweckbestimmung&quot;= 9999) THEN 'sonst.Wasserwirtschaft' &#xd;&#xa; ELSE 'Zweckbestimmung\nnicht definiert' &#xd;&#xa; END&#xd;&#xa; " fontFamily="Arial" textColor="35,115,235,255" previewBkgrdColor="255,255,255,255" fontWeight="50" fontSize="8" textOrientation="horizontal" namedStyle="Regular" fontKerning="1" fontSizeUnit="Point" textOpacity="1" fontLetterSpacing="0" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWordSpacing="0" allowHtml="0" useSubstitutions="0" fontStrikeout="0" forcedBold="0" multilineHeight="1">
        <families/>
