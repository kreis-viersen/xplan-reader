...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling" version="3.26.3-Buenos Aires">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style multilineHeight="1" isExpression="1" blendMode="0" fontWordSpacing="0" fontUnderline="0" previewBkgrdColor="255,255,255,255" fontLetterSpacing="0" fontStrikeout="0" capitalization="0" fontKerning="1" textOrientation="horizontal" textOpacity="1" fontSize="7" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontSizeUnit="Point" legendString="Aa" textColor="50,50,50,255" allowHtml="0" fieldName="'FP:generisches Objekt: '&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;text&quot; is not null) then   case &#xd;&#xa;when length(&quot;text&quot;)>25 then '\n '+left(replace(&quot;text&quot;,'\n',' '),25)+'...'&#xd;&#xa;when length(&quot;text&quot;)&lt;26 then '\n '+     replace(&quot;text&quot;,'\n',' ')  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;textlicheErgaenzung&quot; is not null) then   case &#xd;&#xa;when length(&quot;textlicheErgaenzung&quot;)>25 then '\n '+left(&quot;textlicheErgaenzung&quot;,25)+'...'&#xd;&#xa;when length(&quot;textlicheErgaenzung&quot;)&lt;26 then '\n '+     &quot;textlicheErgaenzung&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;aufschrift&quot; is not null) then   case &#xd;&#xa;when length(&quot;aufschrift&quot;)>25 then '\n '+left(&quot;aufschrift&quot;,25)+'...'&#xd;&#xa;when length(&quot;aufschrift&quot;)&lt;26 then '\n '+     &quot;aufschrift&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa; &#xd;&#xa; &#xd;&#xa; " forcedBold="0" forcedItalic="0" fontItalic="0" fontFamily="Arial" fontWeight="50" namedStyle="Standard">
        <families/>
      ...
      <placement fitInPolygonOnly="0" geometryGenerator="" preserveRotation="1" xOffset="10" repeatDistanceUnits="MM" overrunDistance="0" allowDegraded="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overlapHandling="PreventOverlap" maxCurvedCharAngleOut="-25" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" polygonPlacementFlags="2" quadOffset="5" rotationAngle="0" geometryGeneratorType="PointGeometry" placementFlags="10" layerType="PointGeometry" lineAnchorTextPoint="FollowPlacement" repeatDistance="0" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" lineAnchorPercent="0.5" yOffset="0" priority="5" lineAnchorClipping="0" offsetType="1" distUnits="MM" rotationUnit="AngleDegrees" lineAnchorType="0" maxCurvedCharAngleIn="25" placement="1" offsetUnits="RenderMetersInMapUnits"/>
      <rendering mergeLines="0" fontMaxPixelSize="10000" zIndex="0" drawLabels="1" fontLimitPixelSize="0" obstacleFactor="1" fontMinPixelSize="3" scaleMin="1" limitNumLabels="0" upsidedownLabels="0" labelPerPart="0" minFeatureSize="0" scaleMax="4001" unplacedVisibility="0" scaleVisibility="1" obstacleType="1" obstacle="1" maxNumLabels="2000"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
