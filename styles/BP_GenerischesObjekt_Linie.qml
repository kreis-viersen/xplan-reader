...
<qgis minScale="2500" version="3.26.1-Buenos Aires" styleCategories="LayerConfiguration|Symbology|Symbology3D|Labeling|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" maxScale="1" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="0" labelsEnabled="1" simplifyDrawingHints="1" symbologyReferenceScale="-1" simplifyMaxScale="1" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1">
  <flags>
  ...
  <temporal mode="0" limitMode="0" startField="" enabled="0" endExpression="" startExpression="" fixedDuration="0" endField="" durationField="" durationUnit="min" accumulate="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation clamping="Terrain" binding="Centroid" symbology="Line" showMarkerSymbolInSurfacePlots="0" type="IndividualFeatures" respectLayerSymbol="1" zoffset="0" extrusion="0" zscale="1" extrusionEnabled="0">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" alpha="1" frame_rate="10" name="" force_rhr="0" type="line" clip_to_extent="1">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" alpha="1" frame_rate="10" name="" force_rhr="0" type="fill" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" alpha="1" frame_rate="10" name="" force_rhr="0" type="marker" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
  ...
  <renderer-v2 forceraster="0" referencescale="-1" enableorderby="0" type="singleSymbol" symbollevels="0">
    <symbols>
      <symbol is_animated="0" alpha="1" frame_rate="10" name="0" force_rhr="0" type="line" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option name="draw_inside_polygon" value="0" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="line_color" value="255,166,184,255" type="QString"/>
            <Option name="line_style" value="solid" type="QString"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontWordSpacing="0" fontItalic="0" forcedItalic="0" fontSize="10" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="1" fontLetterSpacing="0" textColor="50,50,50,255" fieldName="&#xd;&#xa;&#xd;&#xa;CASE &#xd;&#xa;WHEN try(aufschrift is not NULL,'-') THEN  ' '+ to_string(replace (replace (replace (&quot;aufschrift&quot; ,'&#x9;',' ') , '\n' ,' ') ,'  ',' ') )&#xd;&#xa;ELSE ''&#xd;&#xa;END&#xd;&#xa;+&#xd;&#xa;CASE &#xd;&#xa;WHEN (try(text is not NULL,'-') and length(replace(replace(&quot;text&quot;,'&#x9;',''),'\n',' '))&lt;30) &#xd;&#xa;THEN to_string(replace(replace(&quot;text&quot;,'&#x9;',''),'\n',' ') )&#xd;&#xa;WHEN (try(text is not NULL,'-') and length(replace(replace(&quot;text&quot;,'&#x9;',''),'\n',' '))>29) &#xd;&#xa;THEN left(replace(replace(&quot;text&quot;,'&#x9;',''),'\n',' '),20) + '...'&#xd;&#xa;ELSE ''&#xd;&#xa;END&#xd;&#xa;" fontUnderline="0" previewBkgrdColor="255,255,255,255" fontFamily="Arial" textOrientation="horizontal" blendMode="0" fontStrikeout="0" fontSizeUnit="Point" namedStyle="Regular" capitalization="0" textOpacity="1" fontWeight="50" useSubstitutions="0" fontKerning="1" forcedBold="0" allowHtml="0" legendString="Aa">
        <families/>
        <text-buffer bufferOpacity="1" bufferBlendMode="0" bufferDraw="1" bufferSizeUnits="Percentage" bufferNoFill="1" bufferColor="250,250,250,255" bufferSize="25" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128"/>
        <text-mask maskEnabled="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskType="0" maskedSymbolLayers="" maskSize="0" maskSizeUnits="MM" maskOpacity="1" maskJoinStyle="128"/>
        <background shapeBlendMode="0" shapeOffsetY="0" shapeOffsetX="0" shapeRotationType="0" shapeOpacity="1" shapeSizeX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeRotation="0" shapeJoinStyle="64" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeRadiiY="0" shapeRadiiUnit="Point" shapeDraw="0" shapeFillColor="255,255,255,255" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiX="0" shapeSizeUnit="Point" shapeSVGFile="" shapeBorderColor="128,128,128,255" shapeBorderWidth="0" shapeBorderWidthUnit="Point" shapeType="0" shapeOffsetUnit="Point">
          <symbol is_animated="0" alpha="1" frame_rate="10" name="markerSymbol" force_rhr="0" type="marker" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
          ...
          <symbol is_animated="0" alpha="1" frame_rate="10" name="fillSymbol" force_rhr="0" type="fill" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
        ...
        <shadow shadowRadiusUnit="MM" shadowUnder="0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowColor="0,0,0,255" shadowOffsetDist="1" shadowDraw="0" shadowOffsetUnit="MM" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowOpacity="0.69999999999999996" shadowRadiusAlphaOnly="0" shadowOffsetAngle="135" shadowRadius="1.5" shadowOffsetGlobal="1" shadowScale="100" shadowBlendMode="6"/>
        <dd_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <text-format wrapChar="" useMaxLineLengthForAutoWrap="1" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" multilineAlign="0" addDirectionSymbol="0" plussign="0" autoWrapLength="0" rightDirectionSymbol=">" reverseDirectionSymbol="0" placeDirectionSymbol="0"/>
      <placement rotationUnit="AngleDegrees" placement="3" lineAnchorPercent="0.5" lineAnchorClipping="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-25" offsetType="0" quadOffset="4" repeatDistance="0" xOffset="0" rotationAngle="0" geometryGenerator="" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" geometryGeneratorEnabled="0" offsetUnits="MM" layerType="LineGeometry" distMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" placementFlags="9" geometryGeneratorType="PointGeometry" allowDegraded="0" dist="0" distUnits="MM" preserveRotation="1" centroidInside="0" lineAnchorType="0" overlapHandling="PreventOverlap" maxCurvedCharAngleIn="25" overrunDistance="0" priority="5" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" yOffset="0" polygonPlacementFlags="2" lineAnchorTextPoint="FollowPlacement"/>
      <rendering scaleVisibility="0" upsidedownLabels="0" maxNumLabels="2000" fontMinPixelSize="3" scaleMin="0" minFeatureSize="0" fontLimitPixelSize="0" mergeLines="0" obstacle="1" drawLabels="1" obstacleFactor="1" obstacleType="1" fontMaxPixelSize="10000" labelPerPart="0" unplacedVisibility="0" scaleMax="0" limitNumLabels="0" zIndex="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory scaleBasedVisibility="0" sizeScale="3x:0,0,0,0,0,0" opacity="1" backgroundColor="#ffffff" maxScaleDenominator="1e+08" scaleDependency="Area" penColor="#000000" enabled="0" showAxis="1" spacing="5" spacingUnitScale="3x:0,0,0,0,0,0" penWidth="0" labelPlacementMethod="XHeight" barWidth="5" spacingUnit="MM" direction="0" sizeType="MM" lineSizeType="MM" diagramOrientation="Up" penAlpha="255" backgroundAlpha="255" minimumSize="0" width="15" lineSizeScale="3x:0,0,0,0,0,0" rotationOffset="270" height="15" minScaleDenominator="1">
      <fontProperties italic="0" underline="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" style="" bold="0"/>
  ...
  <DiagramLayerSettings linePlacementFlags="18" placement="2" obstacle="0" showAll="1" dist="0" zIndex="0" priority="0">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      <column name="text" width="410" type="field" hidden="0"/>
