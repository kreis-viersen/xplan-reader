...
<qgis styleCategories="Symbology|Labeling" version="3.28.4-Firenze" labelsEnabled="1">
  <renderer-v2 symbollevels="0" referencescale="-1" forceraster="0" enableorderby="0" type="RuleRenderer">
    <rules key="{e74a6379-6fae-453c-a1ea-746880fc59d4}">
      <rule key="{624e5e1a-5e5f-450c-a064-afef335b57c5}" scalemindenom="1" scalemaxdenom="2001" symbol="0"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" alpha="1" is_animated="0" clip_to_extent="1" name="0" type="marker" frame_rate="10">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style forcedItalic="0" blendMode="0" fontStrikeout="0" multilineHeightUnit="Percentage" textColor="199,112,0,255" fontWordSpacing="0" fontItalic="0" multilineHeight="1" capitalization="0" namedStyle="Regular" fontLetterSpacing="0" fontWeight="50" fontUnderline="0" textOrientation="horizontal" isExpression="1" fontSize="7" forcedBold="0" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Arial" allowHtml="0" legendString="Aa" fontSizeUnit="Point" fontKerning="1" textOpacity="1" fieldName="'BP_Zusatz-'+ '\n' +'kontingent'+ '\n' +'Laerm'" previewBkgrdColor="255,255,255,255">
        <families/>
      ...
      <placement distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" geometryGenerator="" yOffset="0" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" rotationUnit="AngleDegrees" overrunDistanceUnit="MM" lineAnchorClipping="0" geometryGeneratorEnabled="0" quadOffset="5" xOffset="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" offsetUnits="RenderMetersInMapUnits" layerType="PointGeometry" offsetType="1" priority="5" geometryGeneratorType="PointGeometry" allowDegraded="0" maxCurvedCharAngleOut="-25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" lineAnchorTextPoint="FollowPlacement" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorType="0" placementFlags="10" overlapHandling="PreventOverlap" distUnits="MM" polygonPlacementFlags="2" fitInPolygonOnly="0" repeatDistance="0" overrunDistance="0" maxCurvedCharAngleIn="25" placement="1" rotationAngle="0"/>
