...
<qgis labelsEnabled="1" version="3.32.3-Lima" styleCategories="Symbology|Labeling|MapTips">
  <renderer-v2 forceraster="0" referencescale="-1" enableorderby="0" type="RuleRenderer" symbollevels="0">
    <rules key="{4a416921-f2b2-4749-9233-ccd6c5ee702c}">
      ...
      <rule filter="try( &quot;laermpegelbereich&quot; is not NULL)" symbol="1" label="davon Lärmpegelbereich als Linie" key="{dd21945c-c3c3-4b29-9fb0-8057664e5e73}"/>
      <rule filter="try(&quot;technVorkehrung&quot; is null)" symbol="2" label="davon technVorkehrung nicht definiert" key="{66986488-369a-4e06-a6eb-c866e9a2a830}"/>
    </rules>
    <symbols>
      <symbol name="0" frame_rate="10" is_animated="0" alpha="1" type="line" force_rhr="0" clip_to_extent="1">
        ...
        <layer class="SimpleLine" pass="0" enabled="1" locked="1" id="{69f88e79-a2af-48f7-9664-7492c41f5b3e}">
          <Option type="Map">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0" id="{0b7a3166-8940-4be8-9b95-a5f73212a1c8}">
          <Option type="Map">
          ...
          <symbol name="@0@1" frame_rate="10" is_animated="0" alpha="1" type="marker" force_rhr="0" clip_to_extent="1">
            ...
            <layer class="SvgMarker" pass="0" enabled="1" locked="0" id="{f74e408a-5355-4f85-a854-052c918a3823}">
              <Option type="Map">
      ...
      <symbol name="1" frame_rate="10" is_animated="0" alpha="1" type="line" force_rhr="0" clip_to_extent="1">
        ...
        <layer class="SimpleLine" pass="0" enabled="1" locked="0" id="{85edcd0b-b07e-4608-8d18-c79d77d38d98}">
          <Option type="Map">
            <Option name="align_dash_pattern" type="QString" value="0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement rotationUnit="AngleDegrees" lineAnchorClipping="0" maxCurvedCharAngleOut="-25" dist="0" centroidWhole="0" placement="3" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" layerType="LineGeometry" xOffset="0" geometryGeneratorEnabled="0" lineAnchorTextPoint="FollowPlacement" offsetUnits="MM" rotationAngle="0" offsetType="0" distUnits="MM" allowDegraded="0" yOffset="0" maxCurvedCharAngleIn="25" lineAnchorPercent="0.5" overrunDistance="0" repeatDistanceUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidInside="0" repeatDistance="0" preserveRotation="1" overlapHandling="PreventOverlap" geometryGenerator="" placementFlags="9" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" geometryGeneratorType="PointGeometry" polygonPlacementFlags="2" fitInPolygonOnly="0" priority="5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
      <rendering fontMinPixelSize="3" obstacleFactor="1" drawLabels="1" scaleMax="1001" obstacleType="1" scaleVisibility="1" labelPerPart="0" upsidedownLabels="0" obstacle="1" minFeatureSize="0" fontLimitPixelSize="0" zIndex="0" fontMaxPixelSize="10000" maxNumLabels="2000" unplacedVisibility="0" limitNumLabels="0" scaleMin="0" mergeLines="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties"/>
