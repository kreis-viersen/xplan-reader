...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.28.4-Firenze">
  <renderer-v2 symbollevels="0" referencescale="-1" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{4a416921-f2b2-4749-9233-ccd6c5ee702c}">
      <rule key="{a99c4695-4c66-4e33-9c8a-395d41c91d82}" label="alle" symbol="0"/>
      <rule key="{d5d103c7-477d-4c85-8a94-b9174ef8766a}" label="Lärmpegelbereich und technVorkehrung nicht erfasst" symbol="1" filter="try(&quot;laermpegelbereich&quot; is NULL) and try(&quot;technVorkehrung&quot; is NULL)"/>
    </rules>
    <symbols>
      <symbol name="0" alpha="1" clip_to_extent="1" is_animated="0" type="line" force_rhr="0" frame_rate="10">
        ...
        <layer class="MarkerLine" locked="0" enabled="1" pass="0">
          ...
          <symbol name="@0@1" alpha="1" clip_to_extent="1" is_animated="0" type="marker" force_rhr="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol name="1" alpha="1" clip_to_extent="1" is_animated="0" type="line" force_rhr="0" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format reverseDirectionSymbol="0" placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" decimals="3" wrapChar="" useMaxLineLengthForAutoWrap="1" formatNumbers="0" leftDirectionSymbol="&lt;" autoWrapLength="0" addDirectionSymbol="0" plussign="0"/>
      <placement placementFlags="9" maxCurvedCharAngleIn="25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="3" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistance="0" offsetType="0" geometryGenerator="" quadOffset="4" centroidWhole="0" distMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" geometryGeneratorType="PointGeometry" fitInPolygonOnly="0" overrunDistanceUnit="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="LineGeometry" rotationUnit="AngleDegrees" offsetUnits="MM" centroidInside="0" lineAnchorPercent="0.5" yOffset="0" distUnits="MM" priority="5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" lineAnchorType="0" geometryGeneratorEnabled="0" rotationAngle="0" preserveRotation="1" repeatDistanceUnits="MM" allowDegraded="0" lineAnchorClipping="0" dist="0" overlapHandling="PreventOverlap" repeatDistance="0" xOffset="0" lineAnchorTextPoint="FollowPlacement"/>
      <rendering mergeLines="0" limitNumLabels="0" fontLimitPixelSize="0" obstacleFactor="1" obstacle="1" minFeatureSize="0" scaleVisibility="1" labelPerPart="0" fontMaxPixelSize="10000" upsidedownLabels="0" drawLabels="1" unplacedVisibility="0" obstacleType="1" scaleMax="1001" maxNumLabels="2000" zIndex="0" scaleMin="0" fontMinPixelSize="3"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties"/>
