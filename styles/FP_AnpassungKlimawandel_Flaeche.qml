...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.28.4-Firenze">
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{65cc9a4f-3d76-4842-b07c-fdde26b1968e}">
      <rule scalemindenom="1" scalemaxdenom="32001" symbol="0" key="{a9eb97db-b6d0-4f57-aee3-a66325c92299}"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" name="0" clip_to_extent="1" frame_rate="10" type="fill" alpha="1" is_animated="0">
        ...
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="color" value="128,228,27,153" type="QString"/>
        ...
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="line_color" value="128,228,27,255" type="QString"/>
            <Option name="line_style" value="solid" type="QString"/>
            <Option name="line_width" value="1.05" type="QString"/>
            <Option name="line_width_unit" value="MM" type="QString"/>
            <Option name="offset" value="1.05" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
        ...
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <Option type="Map">
            <Option name="align_dash_pattern" value="0" type="QString"/>
            <Option name="capstyle" value="square" type="QString"/>
            <Option name="customdash" value="2;3" type="QString"/>
            <Option name="customdash_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="customdash_unit" value="MM" type="QString"/>
            <Option name="dash_pattern_offset" value="0" type="QString"/>
            <Option name="dash_pattern_offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            ...
            <Option name="draw_inside_polygon" value="0" type="QString"/>
            <Option name="joinstyle" value="miter" type="QString"/>
            <Option name="line_color" value="242,252,0,255" type="QString"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" fontKerning="1" textColor="199,0,0,255" useSubstitutions="0" fontUnderline="0" fontSizeUnit="Point" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" capitalization="0" legendString="Aa" fontStrikeout="0" fontWeight="50" fontItalic="0" fieldName="'Anpassung Klimawandel'&#xd;&#xa;&#xd;&#xa;+case &#xd;&#xa;when try(&quot;massnahme&quot; is not null) then   &#xd;&#xa;&#x9;case &#xd;&#xa;&#x9;when &quot;massnahme&quot; = 1000  then  '\n' +'Erhalt Freiflächen'&#xd;&#xa;&#x9;when &quot;massnahme&quot; = 10000 then  '\n' +'Erhalt priv.Grünflächen'&#xd;&#xa;&#x9;when &quot;massnahme&quot; = 10001 then  '\n' +'Erhalt öff.Grünflächen'&#xd;&#xa;&#x9;when &quot;massnahme&quot; = 10002 then  '\n' +'Erhalt Kaltluftschneise'&#xd;&#xa;&#x9;when &quot;massnahme&quot; = 9999  then  '\n' +'sonst.Maßnahme'&#xd;&#xa;&#x9;ELSE '' End &#xd;&#xa;ELSE '' End&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;text&quot; is not null) then   case &#xd;&#xa;when length(&quot;text&quot;)>25 then '\n'+left(replace(&quot;text&quot;,'\n',' '),25)+'...'&#xd;&#xa;when length(&quot;text&quot;)&lt;26 then '\n'+     replace(&quot;text&quot;,'\n',' ')  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung1&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung1&quot;)>25 then '\n'+left(to_string(&quot;gliederung1&quot;),25)+'...'&#xd;&#xa;when length(&quot;gliederung1&quot;)&lt;26 then '\n'+     to_string(&quot;gliederung1&quot;)  ELSE'' End ELSE '' End &#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung2&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung2&quot;)>25 then '\n'+left(to_string(&quot;gliederung2&quot;),25)+'...'&#xd;&#xa;when length(&quot;gliederung2&quot;)&lt;26 then '\n'+     to_string(&quot;gliederung2&quot;)  ELSE'' End ELSE '' End &#xd;&#xa;&#xd;&#xa;+ case when try(&quot;aufschrift&quot; is not null) then   case &#xd;&#xa;when length(&quot;aufschrift&quot;)>25 then '\n'+left(&quot;aufschrift&quot;,25)+'...'&#xd;&#xa;when length(&quot;aufschrift&quot;)&lt;26 then '\n'+     &quot;aufschrift&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;name&quot; is not null) and try(&quot;name&quot;[1]is null) then   case &#xd;&#xa;when length(&quot;name&quot;)>25 then '\n'+left(&quot;name&quot;,25)+'...'&#xd;&#xa;when length(&quot;name&quot;)&lt;26 then '\n'+     &quot;name&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;/* Ergänzung für Codelisten  https://registry.gdi-de.org/codelist/de.xleitstelle.xplanung/ */&#xd;&#xa;+ CASE &#xd;&#xa;WHEN try(detailMassnahme is not NULL,'-')    THEN  '\n' + to_string(&quot;detailMassnahme&quot;)&#xd;&#xa;WHEN try(detailMassnahme[0] is not NULL,'-') THEN  '\n' + array_to_string(&quot;detailMassnahme&quot;[0] ,' ')&#xd;&#xa;ELSE '' &#xd;&#xa;END" namedStyle="Regular" forcedBold="0" forcedItalic="0" fontFamily="Arial" fontSize="8" isExpression="1" textOrientation="horizontal" blendMode="0" allowHtml="0" textOpacity="1" multilineHeightUnit="Percentage">
        <families/>
        <text-buffer bufferJoinStyle="128" bufferSize="30" bufferSizeUnits="Percentage" bufferColor="128,228,27,255" bufferNoFill="1" bufferOpacity="1" bufferDraw="1" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <text-format autoWrapLength="30" decimals="3" useMaxLineLengthForAutoWrap="1" addDirectionSymbol="0" rightDirectionSymbol=">" reverseDirectionSymbol="0" wrapChar="" placeDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" plussign="0" multilineAlign="3"/>
