...
<qgis styleCategories="Symbology|Labeling" version="3.26.3-Buenos Aires" labelsEnabled="1">
  <renderer-v2 referencescale="-1" forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{1f2c53c8-77d4-4ea5-b111-d62b933488ff}">
      ...
      <rule symbol="1" filter="try (to_string( &quot;zweckbestimmung&quot;) ILIKE '10%' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) ILIKE '10%' )" key="{3a8981d7-7066-4332-bf70-2e4747e1c439}" label="davon Elektrizität"/>
      <rule symbol="2" filter="try (to_string( &quot;zweckbestimmung&quot;) ILIKE '12%' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) ILIKE '12%' )" key="{e1732acb-b277-4ba3-aa8e-65a2993f3c11}" label="davon Gas"/>
      <rule symbol="3" filter="try (to_string( &quot;zweckbestimmung&quot;) ILIKE '13%' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) ILIKE '13%' )" key="{4d630375-7254-46b7-9415-1f61a55389db}" label="davon Erdöl"/>
      <rule symbol="4" filter="try (to_string( &quot;zweckbestimmung&quot;) ILIKE '14%' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) ILIKE '14%' )" key="{1bfc61fc-b7d4-4836-8b51-9b837b11736d}" label="davon Wärme"/>
      <rule symbol="5" filter="try (to_string( &quot;zweckbestimmung&quot;) ILIKE '16%' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) ILIKE '16%' )" key="{df8a809a-9b31-4092-9528-fc7dbeed812e}" label="davon Wasser"/>
      <rule symbol="6" filter="try (to_string( &quot;zweckbestimmung&quot;) ILIKE '18%' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) ILIKE '18%' )" key="{8f83e36a-33e5-46e2-9a7b-c79da6e86766}" label="davon Abwasser"/>
      <rule symbol="7" filter="try (to_string( &quot;zweckbestimmung&quot;) ILIKE '20%' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) ILIKE '20%' )" key="{f5b1219d-758d-46c1-9e54-5930f7254639}" label="davon Regenwasser"/>
      <rule symbol="8" filter="try (to_string( &quot;zweckbestimmung&quot;) ILIKE '22%' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) ILIKE '22%' )" key="{2888acd9-0842-4031-936e-6a0380b31cc6}" label="davon Abfall"/>
      <rule symbol="9" filter="try (to_string( &quot;zweckbestimmung&quot;) ILIKE '24%' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) ILIKE '24%' )" key="{68981604-0e38-4b66-bb39-12e464229277}" label="davon Ablagerung"/>
      <rule symbol="10" filter="try (to_string( &quot;zweckbestimmung&quot;) ILIKE '26%' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) ILIKE '26%' )" key="{35c89054-1f77-48bf-a5d0-d20ed5fd0b22}" label="davon Telekommunikation"/>
      <rule symbol="11" filter="try (to_string( &quot;zweckbestimmung&quot;) ILIKE '28%' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) ILIKE '28%' )" key="{fa4925bf-d32d-4ccd-814e-baf9dd2023bd}" label="davon erneuerbare Energie allg."/>
      <rule symbol="12" filter="try (to_string( &quot;zweckbestimmung&quot;) ILIKE '30%' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) ILIKE '30%' )" key="{c81e2da1-82ba-4701-a63b-77915c4486ae}" label="davon Kraftwärme Kopplung"/>
      <rule symbol="13" filter="try (to_string( &quot;zweckbestimmung&quot;) = '9999' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) = '9999' )" key="{dd041116-ff8b-4592-a991-88b340219469}" label="davon sonstiges"/>
      <rule symbol="14" filter="try (to_string( &quot;zweckbestimmung&quot;) = '99990' ) or try (to_string( &quot;zweckbestimmung&quot;[0]) = '99990' )" key="{bf10073e-52c1-462f-bb18-f60b0fa7ae36}" label="davon Produktenleitung"/>
      <rule symbol="15" filter="array_length( (&quot;zweckbestimmung&quot; )) >1" key="{2889f935-06e9-4d67-828d-ed51cb6c760f}" label="davon mehrere Zweckbestimmungen"/>
      <rule symbol="16" filter="try (to_string( &quot;zweckbestimmung&quot;) is NULL ) and try (to_string( &quot;zweckbestimmung&quot;[0]) is NULL )" key="{e054c081-34a1-4230-9f66-1b58d0faa268}" label="Zweckbestimmung nicht definiert"/>
    </rules>
    <symbols>
      ...
      <symbol frame_rate="10" is_animated="0" name="10" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" is_animated="0" name="11" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" is_animated="0" name="12" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" is_animated="0" name="13" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" is_animated="0" name="14" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" is_animated="0" name="15" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" is_animated="0" name="16" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" is_animated="0" name="4" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" is_animated="0" name="5" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" is_animated="0" name="6" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" is_animated="0" name="7" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" is_animated="0" name="8" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" is_animated="0" name="9" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
