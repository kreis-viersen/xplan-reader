...
<qgis styleCategories="Symbology|Labeling|MapTips" version="3.32.3-Lima" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" forceraster="0" symbollevels="0" enableorderby="0" referencescale="-1">
    <rules key="{2fc26d69-890a-40a4-99ae-043e432b680c}">
      <rule label="alle" symbol="0" key="{66370bfb-f878-4cfa-9bdc-1a5307c47454}"/>
      <rule label="davon Private Nutzung" filter=" &quot;nutzungsform&quot; =1000" symbol="1" key="{3d06ca3c-7601-40b2-a50b-2bf10c5b1639}"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" type="fill" frame_rate="10" alpha="1" name="0" force_rhr="0" is_animated="0">
        ...
        <layer class="SimpleFill" locked="0" id="{1696349d-3be7-4d35-a0a2-7f313e950f2b}" pass="0" enabled="1">
          <Option type="Map">
      ...
      <symbol clip_to_extent="1" type="fill" frame_rate="10" alpha="1" name="1" force_rhr="0" is_animated="0">
        ...
        <layer class="SimpleFill" locked="0" id="{ce46bebe-bd5a-4948-b013-26efb7e10f1c}" pass="0" enabled="1">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="255,217,47,255"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
        ...
        <layer class="LinePatternFill" locked="0" id="{0795a465-d052-4836-9060-50e7207e8442}" pass="0" enabled="1">
          <Option type="Map">
          ...
          <symbol clip_to_extent="1" type="line" frame_rate="10" alpha="1" name="@1@1" force_rhr="0" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" locked="0" id="{f981ba49-8e4f-462b-b92a-072ad3627d55}" pass="0" enabled="1">
              <Option type="Map">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <rendering fontLimitPixelSize="0" maxNumLabels="2000" obstacleType="1" minFeatureSize="0" upsidedownLabels="0" scaleMax="251" limitNumLabels="0" scaleMin="0" labelPerPart="0" zIndex="0" scaleVisibility="1" obstacleFactor="1" fontMinPixelSize="3" drawLabels="1" unplacedVisibility="0" fontMaxPixelSize="10000" obstacle="1" mergeLines="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option type="Map" name="properties">
