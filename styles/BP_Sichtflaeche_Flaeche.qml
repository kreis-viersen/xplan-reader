...
<qgis version="3.42.3-Münster" styleCategories="Symbology|Labeling|MapTips" labelsEnabled="1">
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{65317f7c-d098-4eb8-b399-e73214f756bb}">
      <rule scalemaxdenom="2001" symbol="0" scalemindenom="1" key="{763d7e0a-05f4-4331-9c43-478be85778ce}"/>
    </rules>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <rendering zIndex="0" minFeatureSize="0" labelPerPart="0" scaleVisibility="1" drawLabels="1" fontMinPixelSize="3" fontLimitPixelSize="0" unplacedVisibility="0" mergeLines="0" obstacleType="1" obstacleFactor="1" fontMaxPixelSize="10000" obstacle="1" scaleMax="251" maxNumLabels="2000" limitNumLabels="0" scaleMin="0" upsidedownLabels="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
          <Option name="properties"/>
