...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" readOnly="0" version="3.24.2-Tisler" symbologyReferenceScale="-1" maxScale="0" simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="0" labelsEnabled="1" simplifyLocal="1">
  <flags>
      ...
      <symbol clip_to_extent="1" type="fill" alpha="1" force_rhr="0" name="0">
        ...
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" value="200,200,200,255" name="line_color"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontItalic="0" previewBkgrdColor="255,255,255,255" fontSize="10" blendMode="0" textColor="200,200,200,255" fontUnderline="0" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Arial" multilineHeight="1" fontWordSpacing="0" fontSizeUnit="Point" fieldName="  concat( 'GFZ:', &quot;GFZ&quot;, '\n' ,'GRZ:',&quot;GRZ&quot; )" isExpression="1" fontWeight="50" useSubstitutions="0" legendString="Aa" fontLetterSpacing="0" allowHtml="0" textOrientation="horizontal" fontKerning="1" capitalization="0" namedStyle="Standard" fontStrikeout="0">
        <families/>
        ...
        <text-mask maskSize="1" maskJoinStyle="128" maskSizeUnits="MM" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskOpacity="1" maskEnabled="1" maskType="0"/>
  ...
  <aliases>
    ...
    <alias index="1" field="hoehenbezug" name=""/>
    <alias index="2" field="bezugspunkt" name=""/>
    <alias index="3" field="h" name=""/>
    <alias index="4" field="h_uom" name=""/>
    <alias index="5" field="rechtscharakter" name=""/>
    <alias index="6" field="flaechenschluss" name=""/>
    <alias index="7" field="GFZ" name=""/>
    <alias index="8" field="GRZ" name=""/>
    <alias index="9" field="Z" name=""/>
  </aliases>
  <defaults>
