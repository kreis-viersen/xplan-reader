...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.28.4-Firenze">
  <renderer-v2 forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0" referencescale="-1">
    <rules key="{dad12a48-f393-44c5-9396-af1bd54a300e}">
      <rule key="{d7a1cd6e-a927-4f1a-8473-901041ffaf72}" symbol="0" label="alle"/>
      <rule key="{9d01a16a-0fd6-41f7-8596-86231f7bafa5}" symbol="1" filter=" &quot;artDerFestlegung&quot; is NULL" label="artDerFestlegung nicht definiert"/>
    </rules>
    <symbols>
