...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling|MapTips" version="3.40.3-Bratislava">
  <renderer-v2 type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0">
    <rules key="{dad12a48-f393-44c5-9396-af1bd54a300e}">
      <rule symbol="0" label="alle" key="{d7a1cd6e-a927-4f1a-8473-901041ffaf72}"/>
      <rule filter=" &quot;artDerFestlegung&quot; is NULL" symbol="1" label="artDerFestlegung nicht definiert" key="{9d01a16a-0fd6-41f7-8596-86231f7bafa5}"/>
    </rules>
    <symbols>
      <symbol type="line" clip_to_extent="1" is_animated="0" name="0" alpha="1" frame_rate="10" force_rhr="0">
        ...
        <layer locked="0" pass="0" id="{39154d69-2e6e-4446-a0e4-810e25bf3853}" class="SimpleLine" enabled="1">
          <Option type="Map">
        ...
        <layer locked="0" pass="0" id="{69525a3f-6192-4ac6-9b36-a7481d9038a0}" class="SimpleLine" enabled="1">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
      ...
      <symbol type="line" clip_to_extent="1" is_animated="0" name="1" alpha="1" frame_rate="10" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" name="name" value=""/>
            <Option name="properties"/>
        ...
        <layer locked="0" pass="0" id="{3fa50fd1-1576-4c6d-be02-06f75eb16b8a}" class="SimpleLine" enabled="1">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="line" clip_to_extent="1" is_animated="0" name="" alpha="1" frame_rate="10" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" name="name" value=""/>
            <Option name="properties"/>
        ...
        <layer locked="0" pass="0" id="{c7341738-f78c-4c16-91fe-70509441500e}" class="SimpleLine" enabled="1">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format wrapChar="" autoWrapLength="0" reverseDirectionSymbol="0" decimals="3" addDirectionSymbol="0" leftDirectionSymbol="&lt;" multilineAlign="0" formatNumbers="0" plussign="0" useMaxLineLengthForAutoWrap="1" placeDirectionSymbol="0" rightDirectionSymbol=">"/>
      <placement preserveRotation="1" layerType="LineGeometry" overrunDistanceUnit="MM" lineAnchorPercent="0.5" geometryGeneratorType="PointGeometry" lineAnchorTextPoint="FollowPlacement" allowDegraded="0" xOffset="0" placementFlags="9" yOffset="0" repeatDistance="0" centroidInside="0" offsetUnits="MM" quadOffset="4" maximumDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" prioritization="PreferCloser" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distUnits="MM" centroidWhole="0" placement="3" maximumDistanceUnit="MM" overlapHandling="PreventOverlap" geometryGeneratorEnabled="0" lineAnchorClipping="0" fitInPolygonOnly="0" distMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" dist="0" maximumDistance="0" geometryGenerator="" offsetType="0" maxCurvedCharAngleOut="-25" priority="5" overrunDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" maxCurvedCharAngleIn="25" lineAnchorType="0" polygonPlacementFlags="2"/>
