...
<qgis version="3.28.3-Firenze" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" forceraster="0" referencescale="-1" enableorderby="0" symbollevels="0">
    <rules key="{5026c24d-04de-400d-b4fe-4451bdef4f94}">
      <rule scalemindenom="1" key="{70d5de59-30ff-4fdb-810a-1f02a01eda1f}" scalemaxdenom="2501" symbol="0"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" name="0" frame_rate="10" alpha="1" type="fill" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" pass="0" locked="0" class="MarkerLine">
          ...
          <symbol clip_to_extent="1" name="@0@0" frame_rate="10" alpha="1" type="marker" force_rhr="0" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
