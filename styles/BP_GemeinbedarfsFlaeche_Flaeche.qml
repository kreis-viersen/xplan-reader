...
<qgis styleCategories="Symbology|Labeling|MapTips" version="3.32.3-Lima" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" forceraster="0" symbollevels="0" enableorderby="0" referencescale="-1">
    <rules key="{f092c5dd-030c-4f7b-a44f-74247c8fe873}">
      <rule label="alle" symbol="0" key="{a1f40758-2f06-44f7-8bd1-28ccd5d1fcfc}"/>
      <rule label="Zweckbestimmung nicht definiert" filter="try(&quot;zweckbestimmung&quot; is NULL) and  try(&quot;zweckbestimmung&quot;[0]is NULL) and try(&quot;allgemein&quot; is NULL) and  try(&quot;allgemein&quot;[0]is NULL)" symbol="1" key="{ff2abee1-b2b2-4635-a0cc-4039be822a85}"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" type="fill" frame_rate="10" alpha="1" name="0" force_rhr="0" is_animated="0">
        ...
        <layer class="SimpleFill" locked="0" id="{b941c0a7-e244-45f4-8b6c-e6991c500fd7}" pass="0" enabled="1">
          <Option type="Map">
      ...
      <symbol clip_to_extent="1" type="fill" frame_rate="10" alpha="1" name="1" force_rhr="0" is_animated="0">
        ...
        <layer class="SimpleFill" locked="0" id="{04ce63b0-42da-48ef-92cc-94e42de3e897}" pass="0" enabled="1">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format addDirectionSymbol="0" placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" reverseDirectionSymbol="0" rightDirectionSymbol=">" plussign="0" multilineAlign="0" autoWrapLength="40" wrapChar="" formatNumbers="0" leftDirectionSymbol="&lt;" decimals="3"/>
