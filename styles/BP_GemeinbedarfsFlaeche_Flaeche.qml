...
<qgis symbologyReferenceScale="-1" simplifyDrawingTol="1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyLocal="1" labelsEnabled="1" version="3.36.1-Maidenhead" minScale="0" simplifyMaxScale="1" maxScale="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0">
  ...
  <elevation symbology="Line" respectLayerSymbol="1" clamping="Terrain" zoffset="0" showMarkerSymbolInSurfacePlots="0" extrusionEnabled="0" extrusion="0" binding="Centroid" zscale="1" type="IndividualFeatures">
    ...
    <profileLineSymbol>
      <symbol frame_rate="10" force_rhr="0" name="" is_animated="0" alpha="1" clip_to_extent="1" type="line">
        ...
        <layer pass="0" locked="0" class="SimpleLine" id="{3b31e410-81dc-414e-ac37-c164d1c3047e}" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol frame_rate="10" force_rhr="0" name="" is_animated="0" alpha="1" clip_to_extent="1" type="fill">
        ...
        <layer pass="0" locked="0" class="SimpleFill" id="{69e4bd9d-629d-48d3-96ad-6fa5dd60a3c7}" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol frame_rate="10" force_rhr="0" name="" is_animated="0" alpha="1" clip_to_extent="1" type="marker">
        ...
        <layer pass="0" locked="0" class="SimpleMarker" id="{9ff4d248-4c30-4b78-8c52-8b5b2a301297}" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" referencescale="-1" type="RuleRenderer" enableorderby="0">
    <rules key="{f092c5dd-030c-4f7b-a44f-74247c8fe873}">
      ...
      <rule symbol="1" label="Zweckbestimmung nicht definiert" filter="try(&quot;zweckbestimmung&quot; is NULL) and  try(&quot;zweckbestimmung&quot;[0]is NULL) and try(&quot;allgemein&quot; is NULL) and  try(&quot;allgemein&quot;[0]is NULL)" key="{ff2abee1-b2b2-4635-a0cc-4039be822a85}"/>
    </rules>
    <symbols>
      <symbol frame_rate="10" force_rhr="0" name="0" is_animated="0" alpha="1" clip_to_extent="1" type="fill">
        ...
        <layer pass="0" locked="0" class="SimpleFill" id="{b941c0a7-e244-45f4-8b6c-e6991c500fd7}" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale" type="QString"/>
      ...
      <symbol frame_rate="10" force_rhr="0" name="1" is_animated="0" alpha="1" clip_to_extent="1" type="fill">
        ...
        <layer pass="0" locked="0" class="SimpleFill" id="{04ce63b0-42da-48ef-92cc-94e42de3e897}" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol frame_rate="10" force_rhr="0" name="" is_animated="0" alpha="1" clip_to_extent="1" type="fill">
        ...
        <layer pass="0" locked="0" class="SimpleFill" id="{d30370ce-7888-42f7-8de9-cc3cba91d69f}" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale" type="QString"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format wrapChar="" reverseDirectionSymbol="0" autoWrapLength="40" decimals="3" addDirectionSymbol="0" plussign="0" multilineAlign="0" useMaxLineLengthForAutoWrap="1" formatNumbers="0" placeDirectionSymbol="0" leftDirectionSymbol="&lt;" rightDirectionSymbol=">"/>
      ...
      <rendering unplacedVisibility="0" zIndex="0" scaleVisibility="1" upsidedownLabels="0" drawLabels="1" obstacleFactor="1" fontMinPixelSize="3" scaleMin="0" fontLimitPixelSize="0" obstacleType="1" fontMaxPixelSize="10000" minFeatureSize="0" limitNumLabels="0" mergeLines="0" scaleMax="2001" maxNumLabels="2000" obstacle="1" labelPerPart="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
    ...
    <DiagramCategory lineSizeScale="3x:0,0,0,0,0,0" sizeType="MM" scaleDependency="Area" backgroundColor="#ffffff" diagramOrientation="Up" barWidth="5" scaleBasedVisibility="0" lineSizeType="MM" backgroundAlpha="255" labelPlacementMethod="XHeight" showAxis="1" width="15" minScaleDenominator="0" sizeScale="3x:0,0,0,0,0,0" maxScaleDenominator="0" minimumSize="0" penWidth="0" direction="0" spacingUnitScale="3x:0,0,0,0,0,0" enabled="0" spacing="5" penAlpha="255" opacity="1" penColor="#000000" rotationOffset="270" height="15" spacingUnit="MM">
      ...
      <axisSymbol>
        <symbol frame_rate="10" force_rhr="0" name="" is_animated="0" alpha="1" clip_to_extent="1" type="line">
          ...
          <layer pass="0" locked="0" class="SimpleLine" id="{628d7000-6e15-40f8-9224-e6717c51c27a}" enabled="1">
            <Option type="Map">
              <Option value="0" name="align_dash_pattern" type="QString"/>
              <Option value="square" name="capstyle" type="QString"/>
              <Option value="5;2" name="customdash" type="QString"/>
  ...
  <fieldConfiguration>
    ...
    <field name="detaillierteZweckbestimmung" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="zweckbestimmung" name="" index="13"/>
    <alias field="detaillierteZweckbestimmung" name="" index="14"/>
  </aliases>
  <splitPolicies>
    ...
    <policy field="detaillierteZweckbestimmung" policy="Duplicate"/>
  </splitPolicies>
  <defaults>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" exp_strength="0" field="detaillierteZweckbestimmung" unique_strength="0" constraints="0"/>
  </constraints>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column hidden="0" name="detaillierteZweckbestimmung" width="-1" type="field"/>
