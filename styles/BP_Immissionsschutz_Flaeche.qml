...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.28.4-Firenze">
  <renderer-v2 referencescale="-1" forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0">
    <rules key="{95bd018e-844e-4a03-99de-27c51bc817c6}">
      ...
      <rule filter="try(&quot;laermpegelbereich&quot; is not NULL) " label="davon Lärmpegelbereich " symbol="1" key="{ebf2fa65-dcef-4225-b6d9-27d8d0e153d6}"/>
      <rule filter="try(&quot;technVorkehrung&quot;=1000)" label="davon technVorkehrung allg. Lärmschutzvorkehrung" symbol="2" key="{d5898759-bbdc-4a14-8547-c42392d7455f}"/>
      <rule filter="try(&quot;technVorkehrung&quot;=10000)" label="davon technVorkehrung Fassaden mit Schallschutzmaßnahmen" symbol="3" key="{860b552d-4cba-4a59-a72d-7419dbf6e023}"/>
      <rule filter="try(&quot;technVorkehrung&quot;=10001) or try( &quot;technVorkehrung&quot;=10002)" label="davon technVorkehrung Lärmschutz-Wand/Wall" symbol="4" key="{cbe5b875-b652-400f-a45d-c320e53ddf88}"/>
      <rule filter="try(&quot;technVorkehrung&quot;=9999)" label="davon technVorkehrung sonst." symbol="5" key="{987c6a8f-2cbd-4f31-803c-66f744cecab1}"/>
      <rule filter="(try(&quot;laermpegelbereich&quot; is NULL) and try(&quot;technVorkehrung&quot; is NULL))" label="davon nicht definiert" symbol="6" key="{f41e9440-d89c-4e0e-bb61-b658ae15e272}"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" frame_rate="10" name="0" alpha="1" type="fill" is_animated="0">
        ...
        <layer class="MarkerLine" enabled="1" pass="0" locked="0">
          ...
          <symbol clip_to_extent="1" force_rhr="0" frame_rate="10" name="@0@0" alpha="1" type="marker" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" frame_rate="10" name="1" alpha="1" type="fill" is_animated="0">
        ...
        <layer class="MarkerLine" enabled="1" pass="0" locked="0">
          ...
          <symbol clip_to_extent="1" force_rhr="0" frame_rate="10" name="@1@0" alpha="1" type="marker" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" frame_rate="10" name="2" alpha="1" type="fill" is_animated="0">
        ...
        <layer class="MarkerLine" enabled="1" pass="0" locked="0">
          ...
          <symbol clip_to_extent="1" force_rhr="0" frame_rate="10" name="@2@0" alpha="1" type="marker" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" frame_rate="10" name="3" alpha="1" type="fill" is_animated="0">
        ...
        <layer class="MarkerLine" enabled="1" pass="0" locked="0">
          ...
          <symbol clip_to_extent="1" force_rhr="0" frame_rate="10" name="@3@0" alpha="1" type="marker" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" frame_rate="10" name="4" alpha="1" type="fill" is_animated="0">
        ...
        <layer class="MarkerLine" enabled="1" pass="0" locked="0">
          ...
          <symbol clip_to_extent="1" force_rhr="0" frame_rate="10" name="@4@0" alpha="1" type="marker" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" frame_rate="10" name="5" alpha="1" type="fill" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer class="MarkerLine" enabled="1" pass="0" locked="0">
          ...
          <symbol clip_to_extent="1" force_rhr="0" frame_rate="10" name="@5@0" alpha="1" type="marker" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" frame_rate="10" name="6" alpha="1" type="fill" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format placeDirectionSymbol="0" wrapChar="" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" decimals="3" autoWrapLength="0" leftDirectionSymbol="&lt;" multilineAlign="3" addDirectionSymbol="0" reverseDirectionSymbol="0" formatNumbers="0" plussign="0"/>
      <placement repeatDistanceUnits="MM" maxCurvedCharAngleIn="25" lineAnchorTextPoint="FollowPlacement" rotationUnit="AngleDegrees" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" offsetUnits="MM" overrunDistance="0" yOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="5" geometryGenerator="" geometryGeneratorType="PointGeometry" xOffset="0" quadOffset="4" maxCurvedCharAngleOut="-25" fitInPolygonOnly="0" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" overrunDistanceUnit="MM" layerType="PolygonGeometry" repeatDistance="0" centroidInside="1" lineAnchorClipping="0" priority="5" rotationAngle="0" polygonPlacementFlags="2" overlapHandling="PreventOverlap" dist="0" lineAnchorType="0" allowDegraded="0" offsetType="0" centroidWhole="1" lineAnchorPercent="0.5" preserveRotation="1" geometryGeneratorEnabled="0"/>
      <rendering zIndex="0" fontMinPixelSize="3" maxNumLabels="2000" obstacleType="1" minFeatureSize="0" upsidedownLabels="0" limitNumLabels="0" labelPerPart="0" obstacleFactor="1" mergeLines="0" scaleMin="0" fontLimitPixelSize="0" drawLabels="1" obstacle="1" scaleMax="1001" scaleVisibility="1" fontMaxPixelSize="10000" unplacedVisibility="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties" type="Map">
