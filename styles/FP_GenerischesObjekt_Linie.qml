...
<qgis labelsEnabled="1" version="3.26.3-Buenos Aires" styleCategories="Symbology|Labeling">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style forcedBold="0" fontLetterSpacing="0" forcedItalic="0" fontKerning="1" namedStyle="Standard" fontFamily="Arial" textOpacity="1" fontSize="8" fontWeight="50" legendString="Aa" fontSizeUnit="Point" textColor="0,0,0,255" textOrientation="horizontal" fontStrikeout="0" previewBkgrdColor="255,255,255,255" multilineHeight="1" isExpression="1" allowHtml="0" fontWordSpacing="0" capitalization="0" fontUnderline="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fieldName="zweckbestimmung" fontItalic="0" useSubstitutions="0">
        <families/>
      ...
      <placement offsetType="0" distUnits="RenderMetersInMapUnits" placementFlags="10" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" allowDegraded="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" xOffset="0" centroidInside="0" geometryGenerator="" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="3" rotationAngle="0" dist="-1" overlapHandling="PreventOverlap" priority="5" geometryGeneratorType="PointGeometry" repeatDistance="0" repeatDistanceUnits="MM" layerType="LineGeometry" yOffset="0" overrunDistance="0" maxCurvedCharAngleOut="-25" offsetUnits="MM" maxCurvedCharAngleIn="25" centroidWhole="0" lineAnchorClipping="0" rotationUnit="AngleDegrees" lineAnchorPercent="0.5" fitInPolygonOnly="0" polygonPlacementFlags="2" distMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" lineAnchorTextPoint="FollowPlacement" lineAnchorType="0"/>
