...
<qgis maxScale="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="0" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" version="3.20.2-Odense" simplifyDrawingHints="1" simplifyAlgorithm="0">
  <flags>
  ...
  <temporal endExpression="" startField="" accumulate="0" endField="" startExpression="" durationField="" durationUnit="min" enabled="0" fixedDuration="0" mode="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
      ...
      <symbol name="0" force_rhr="0" type="fill" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" class="SimpleFill" pass="0" enabled="1">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="103,193,81,255"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory backgroundColor="#ffffff" penAlpha="255" spacingUnitScale="3x:0,0,0,0,0,0" minimumSize="0" height="15" sizeType="MM" spacingUnit="MM" rotationOffset="270" enabled="0" lineSizeScale="3x:0,0,0,0,0,0" scaleDependency="Area" diagramOrientation="Up" scaleBasedVisibility="0" labelPlacementMethod="XHeight" lineSizeType="MM" direction="0" width="15" barWidth="5" backgroundAlpha="255" penColor="#000000" sizeScale="3x:0,0,0,0,0,0" maxScaleDenominator="0" opacity="1" spacing="5" penWidth="0" minScaleDenominator="0" showAxis="1">
  ...
  <DiagramLayerSettings linePlacementFlags="18" showAll="1" priority="0" dist="0" placement="1" zIndex="0" obstacle="0">
    <properties>
      <Option type="Map">
        <Option name="name" type="QString" value=""/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias name="" index="1" field="gliederung1"/>
    <alias name="" index="2" field="ebene"/>
    <alias name="" index="3" field="rechtscharakter"/>
    <alias name="" index="4" field="flaechenschluss"/>
    <alias name="" index="5" field="zweckbestimmung"/>
    <alias name="" index="6" field="nutzungsform"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    <constraint constraints="1" exp_strength="0" notnull_strength="1" unique_strength="0" field="gml_id"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="gliederung1"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="ebene"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="rechtscharakter"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="flaechenschluss"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="zweckbestimmung"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="nutzungsform"/>
  </constraints>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="nutzungsform" width="-1" type="field" hidden="0"/>
