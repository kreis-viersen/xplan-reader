...
<qgis version="3.28.4-Firenze" styleCategories="Symbology|Labeling" labelsEnabled="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <rendering fontMaxPixelSize="10000" maxNumLabels="2000" fontLimitPixelSize="0" limitNumLabels="0" scaleMin="0" obstacleFactor="1" minFeatureSize="0" scaleMax="8001" drawLabels="1" upsidedownLabels="0" zIndex="0" obstacle="1" labelPerPart="0" obstacleType="1" scaleVisibility="1" unplacedVisibility="0" mergeLines="0" fontMinPixelSize="3"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
