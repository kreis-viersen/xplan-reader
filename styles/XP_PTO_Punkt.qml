...
<qgis labelsEnabled="1" version="3.32.3-Lima" styleCategories="Symbology|Labeling|MapTips">
  <renderer-v2 forceraster="0" referencescale="-1" enableorderby="0" type="singleSymbol" symbollevels="0">
    <symbols>
      <symbol name="0" frame_rate="10" is_animated="0" alpha="1" type="marker" force_rhr="0" clip_to_extent="1">
        ...
        <layer class="SimpleMarker" pass="0" enabled="1" locked="0" id="{63af30c4-c4ae-42af-bf97-5a2a4471bd2c}">
          <Option type="Map">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOpacity="1" blendMode="0" legendString="Aa" fontWordSpacing="0" namedStyle="Italic" previewBkgrdColor="255,255,255,255" capitalization="0" fontFamily="Arial" fontItalic="1" forcedItalic="0" useSubstitutions="0" fieldName="CASE &#xd;&#xa;WHEN try(schriftinhalt is not NULL) THEN to_string(&quot;schriftinhalt&quot; )&#xd;&#xa;ELSE ''&#xd;&#xa;END" fontSize="7" fontLetterSpacing="0" multilineHeightUnit="Percentage" fontUnderline="0" allowHtml="0" forcedBold="0" textOrientation="horizontal" textColor="50,50,50,255" fontKerning="1" isExpression="1" fontStrikeout="0" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWeight="50" fontSizeUnit="Point">
        <families/>
        <text-buffer bufferDraw="1" bufferColor="250,250,26,255" bufferJoinStyle="128" bufferBlendMode="0" bufferSizeUnits="Percentage" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferSize="25"/>
      ...
      <placement rotationUnit="AngleDegrees" lineAnchorClipping="0" maxCurvedCharAngleOut="-25" dist="0" centroidWhole="0" placement="6" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" layerType="PointGeometry" xOffset="0" geometryGeneratorEnabled="0" lineAnchorTextPoint="FollowPlacement" offsetUnits="MM" rotationAngle="0" offsetType="1" distUnits="MM" allowDegraded="0" yOffset="0" maxCurvedCharAngleIn="25" lineAnchorPercent="0.5" overrunDistance="0" repeatDistanceUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidInside="0" repeatDistance="0" preserveRotation="0" overlapHandling="PreventOverlap" geometryGenerator="" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" geometryGeneratorType="PointGeometry" polygonPlacementFlags="2" fitInPolygonOnly="0" priority="5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
        ...
        <Option type="Map">
          ...
          <Option name="properties" type="Map">
            <Option name="LabelRotation" type="Map">
              ...
              <Option name="expression" type="QString" value="360-&quot;drehwinkel&quot; /*Formel so für Viersen für Daten aus Wiedemann*/"/>
              <Option name="type" type="int" value="3"/>
            </Option>
            <Option name="MinimumScale" type="Map">
              <Option name="active" type="bool" value="true"/>
              <Option name="expression" type="QString" value="case&#xd;&#xa;when  plan_layer_id() ilike '%BP%' then 251&#xd;&#xa;when  plan_layer_id() ilike '%FP%' then 2001&#xd;&#xa;else 4001&#xd;&#xa;end"/>
              <Option name="type" type="int" value="3"/>
            </Option>
          </Option>
          <Option name="type" type="QString" value="collection"/>
