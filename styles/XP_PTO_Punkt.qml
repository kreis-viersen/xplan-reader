...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling" version="3.28.3-Firenze">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format wrapChar="" reverseDirectionSymbol="0" multilineAlign="3" leftDirectionSymbol="&lt;" plussign="0" addDirectionSymbol="0" rightDirectionSymbol=">" useMaxLineLengthForAutoWrap="1" placeDirectionSymbol="0" decimals="3" autoWrapLength="25" formatNumbers="0"/>
      <placement yOffset="0" allowDegraded="0" fitInPolygonOnly="0" overrunDistance="0" lineAnchorPercent="0.5" repeatDistance="0" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" maxCurvedCharAngleIn="25" offsetUnits="MM" rotationAngle="0" distUnits="MM" placementFlags="10" quadOffset="4" polygonPlacementFlags="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidWhole="0" overrunDistanceUnit="MM" layerType="PointGeometry" geometryGeneratorType="PointGeometry" lineAnchorTextPoint="FollowPlacement" offsetType="1" priority="5" dist="0" overlapHandling="PreventOverlap" lineAnchorType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" placement="6" preserveRotation="0" geometryGenerator="" rotationUnit="AngleDegrees" maxCurvedCharAngleOut="-25" lineAnchorClipping="0" repeatDistanceUnits="MM" xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
      <rendering minFeatureSize="0" obstacleType="1" drawLabels="1" fontLimitPixelSize="0" scaleVisibility="1" fontMaxPixelSize="10000" mergeLines="0" limitNumLabels="0" fontMinPixelSize="3" scaleMax="1001" upsidedownLabels="0" obstacleFactor="1" zIndex="0" maxNumLabels="2000" scaleMin="0" labelPerPart="0" unplacedVisibility="0" obstacle="1"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option type="Map" name="properties">
            <Option type="Map" name="LabelRotation">
              ...
              <Option type="QString" name="expression" value="360-&quot;drehwinkel&quot; /*Formel so für Viersen für Daten aus Wiedemann*/"/>
