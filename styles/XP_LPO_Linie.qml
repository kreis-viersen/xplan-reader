...
<qgis version="3.26.1-Buenos Aires" labelsEnabled="1" styleCategories="Symbology|Labeling">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontStrikeout="0" fontItalic="0" textColor="50,50,50,255" fontKerning="1" textOrientation="horizontal" useSubstitutions="0" textOpacity="1" forcedItalic="0" fontWeight="50" forcedBold="0" blendMode="0" fontUnderline="0" fontWordSpacing="0" capitalization="0" allowHtml="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" fontSizeUnit="Point" fontSize="8" multilineHeight="1" previewBkgrdColor="255,255,255,255" namedStyle="Regular" fontFamily="Arial" fieldName="+ case when try(&quot;description&quot; is not null) then   case &#xd;&#xa;when length(&quot;description&quot;)>25 then left(replace(&quot;description&quot;,'\n',' '),25)+'...'&#xd;&#xa;when length(&quot;description&quot;)&lt;26 then      replace(&quot;description&quot;,'\n',' ')  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;stylesheetId&quot; is not null) then   case &#xd;&#xa;when length(&quot;stylesheetId&quot;)>25 then '/'+left(&quot;stylesheetId&quot;,25)+'...'&#xd;&#xa;when length(&quot;stylesheetId&quot;)&lt;26 then '/'+     &quot;stylesheetId&quot;  End ELSE '' End&#xd;&#xa;" isExpression="1" legendString="Aa">
        <families/>
      ...
      <placement xOffset="0" lineAnchorPercent="0.5" priority="5" rotationUnit="AngleDegrees" overlapHandling="PreventOverlap" allowDegraded="0" dist="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" distUnits="MM" overrunDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" polygonPlacementFlags="2" geometryGeneratorEnabled="0" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" yOffset="0" quadOffset="4" offsetUnits="MM" lineAnchorTextPoint="FollowPlacement" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" repeatDistanceUnits="MM" fitInPolygonOnly="0" centroidInside="0" offsetType="0" layerType="LineGeometry" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" preserveRotation="1" centroidWhole="0" placement="3" lineAnchorType="0" geometryGenerator="" placementFlags="9" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0"/>
      <rendering upsidedownLabels="0" scaleVisibility="1" minFeatureSize="0" labelPerPart="0" unplacedVisibility="0" fontMaxPixelSize="10000" scaleMin="0" scaleMax="2001" drawLabels="1" fontLimitPixelSize="0" limitNumLabels="0" obstacle="1" obstacleType="1" maxNumLabels="2000" mergeLines="0" fontMinPixelSize="3" obstacleFactor="1" zIndex="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
