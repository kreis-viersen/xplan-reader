...
<qgis styleCategories="Symbology|Labeling" version="3.28.3-Firenze" labelsEnabled="1">
  <renderer-v2 enableorderby="0" referencescale="-1" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{ed98e098-b7bc-43d3-a909-9b84364a9b11}">
      <rule scalemaxdenom="32001" symbol="0" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=1000)) or try(&quot;zweckbestimmung&quot; = 1000)" scalemindenom="1" label="Naturgewalten" key="{440d51ef-5914-4e82-9703-58902fa4eb63}"/>
      <rule scalemaxdenom="32001" symbol="1" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=2000)) or try(&quot;zweckbestimmung&quot; = 2000)" scalemindenom="1" label="Abbaufläche" key="{4395c347-33f8-4e9e-a68f-b1bad79b9458}"/>
      <rule scalemaxdenom="32001" symbol="2" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=3000)) or try(&quot;zweckbestimmung&quot; = 3000)" scalemindenom="1" label="Äussere Einwirkungen" key="{c75bf77f-04e5-4cf3-9bea-5f6679440ae8}"/>
      <rule scalemaxdenom="32001" symbol="3" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=4000)) or try(&quot;zweckbestimmung&quot; = 4000)" scalemindenom="1" label="SchadstoffBelastBoden" key="{f72bd02b-b8f5-4f12-a71a-7c8ecb350587}"/>
      <rule scalemaxdenom="32001" symbol="4" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=5000)) or try(&quot;zweckbestimmung&quot; = 5000)" scalemindenom="1" label="Lärmbelastung" key="{d9a2667d-ba74-4c61-8490-961ddf8b0a75}"/>
      <rule scalemaxdenom="32001" symbol="5" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=6000)) or try(&quot;zweckbestimmung&quot; = 6000)" scalemindenom="1" label="Bergbau" key="{873d66fd-497a-4c1c-96d6-beb15e348210}"/>
      <rule scalemaxdenom="32001" symbol="6" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=7000)) or try(&quot;zweckbestimmung&quot; = 7000)" scalemindenom="1" label="Bodenordnung" key="{a17befdc-e10d-47fa-a764-4399c84fe415}"/>
      <rule scalemaxdenom="32001" symbol="7" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=8000)) or try(&quot;zweckbestimmung&quot; = 8000)" scalemindenom="1" label="Vorhabensgebiet" key="{bd41dd13-cdea-4c43-bfc2-2e7e15eb9244}"/>
      <rule scalemaxdenom="32001" symbol="8" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=9999)) or try(&quot;zweckbestimmung&quot; = 9999)" scalemindenom="1" label="andere gesetzliche Vorschriften" key="{724c8a2e-f8f7-482d-9eec-e6d6814d486b}"/>
      <rule scalemaxdenom="32001" symbol="9" filter="try((array_length(&quot;zweckbestimmung&quot;)>0 and &quot;zweckbestimmung&quot;[0] is NULL)) or try(&quot;zweckbestimmung&quot; is NULL)" scalemindenom="1" label="Zweckbestimmung nicht definiert" key="{b782b483-282c-42b7-b6c7-eb92c0efa55e}"/>
      <rule scalemaxdenom="32001" symbol="10" filter="geom_to_wkt(force_polygon_cw($geometry)) = geom_to_wkt($geometry)" scalemindenom="1" label="in falscher Richtung digitalisiert" key="{6db63371-dafe-4b54-9e00-4fc666df40bc}"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" alpha="1" frame_rate="10" is_animated="0" clip_to_extent="1" type="fill" name="7">
        ...
        <layer class="MarkerLine" enabled="1" pass="0" locked="0">
          ...
          <symbol force_rhr="0" alpha="1" frame_rate="10" is_animated="0" clip_to_extent="1" type="marker" name="@7@1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" alpha="1" frame_rate="10" is_animated="0" clip_to_extent="1" type="fill" name="8">
        ...
        <layer class="MarkerLine" enabled="1" pass="0" locked="0">
          ...
          <symbol force_rhr="0" alpha="1" frame_rate="10" is_animated="0" clip_to_extent="1" type="marker" name="@8@1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style capitalization="0" textOpacity="1" fontWeight="50" namedStyle="Standard" allowHtml="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" multilineHeight="1" useSubstitutions="0" multilineHeightUnit="Percentage" legendString="Aa" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" forcedItalic="0" fontLetterSpacing="0" fontItalic="0" fontFamily="Arial" forcedBold="0" isExpression="1" blendMode="0" textColor="50,50,50,255" fontUnderline="0" fontStrikeout="0" fontSize="8" fontSizeUnit="Point" fontKerning="1" textOrientation="horizontal" fieldName="CASE &#xd;&#xa;WHEN try(&quot;zweckbestimmung&quot;= 1000) or try(&quot;zweckbestimmung&quot;[0]= 1000) THEN 'Kennzeichn.'+'\n'+'Naturgewalten' &#xd;&#xa;WHEN try(&quot;zweckbestimmung&quot;= 2000) or try(&quot;zweckbestimmung&quot;[0]= 2000) THEN 'Kennzeichn.'+'\n'+'Abbaufläche' &#xd;&#xa;WHEN try(&quot;zweckbestimmung&quot;= 3000) or try(&quot;zweckbestimmung&quot;[0]= 3000) THEN 'Kennzeichn.'+'\n'+'Äußere Einwirkungen' &#xd;&#xa;WHEN try(&quot;zweckbestimmung&quot;= 4000) or try(&quot;zweckbestimmung&quot;[0]= 4000) THEN 'Kennzeichn.'+'\n'+'Schadstoff'+'\n'+'belast.'+'\n'+'Boden' &#xd;&#xa;WHEN try(&quot;zweckbestimmung&quot;= 5000) or try(&quot;zweckbestimmung&quot;[0]= 5000) THEN 'Kennzeichn.'+'\n'+'Lärmbelastung' &#xd;&#xa;WHEN try(&quot;zweckbestimmung&quot;= 6000) or try(&quot;zweckbestimmung&quot;[0]= 6000) THEN 'Kennzeichn.'+'\n'+'Bergbau' &#xd;&#xa;WHEN try(&quot;zweckbestimmung&quot;= 7000) or try(&quot;zweckbestimmung&quot;[0]= 7000) THEN 'Kennzeichn.'+'\n'+'Bodenordnung' &#xd;&#xa;WHEN try(&quot;zweckbestimmung&quot;= 8000) or try(&quot;zweckbestimmung&quot;[0]= 8000) THEN 'Kennzeichn.'+'\n'+'Vorhabensgebiet' &#xd;&#xa;WHEN try(&quot;zweckbestimmung&quot;= 9999) or try(&quot;zweckbestimmung&quot;[0]= 9999) THEN 'Kennzeichn.'+'\n'+'and. Vorschriften' &#xd;&#xa;ELSE 'Kennzeichnungsfläche '+'\n'+'Zweckbestimmung '+'\n'+'nicht definiert' &#xd;&#xa;END&#xd;&#xa;+&#xd;&#xa;CASE&#xd;&#xa;WHEN try(length(text)&lt;51) THEN  '\n' +&quot;text&quot;&#xd;&#xa;WHEN try(length(text)>50) THEN  '\n' +left(&quot;text&quot;,50)+'...'&#xd;&#xa;ELSE ''&#xd;&#xa;End">
        <families/>
        <text-buffer bufferJoinStyle="128" bufferNoFill="1" bufferSizeUnits="Percentage" bufferBlendMode="0" bufferOpacity="1" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferSize="25"/>
