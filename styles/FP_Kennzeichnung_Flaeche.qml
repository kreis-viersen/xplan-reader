...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.28.4-Firenze">
  <renderer-v2 forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{ed98e098-b7bc-43d3-a909-9b84364a9b11}">
      <rule scalemindenom="1" scalemaxdenom="32001" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=1000)) or try(&quot;zweckbestimmung&quot; = 1000)" label="Naturgewalten" symbol="0" key="{440d51ef-5914-4e82-9703-58902fa4eb63}"/>
      <rule scalemindenom="1" scalemaxdenom="32001" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=2000)) or try(&quot;zweckbestimmung&quot; = 2000)" label="Abbaufläche" symbol="1" key="{4395c347-33f8-4e9e-a68f-b1bad79b9458}"/>
      <rule scalemindenom="1" scalemaxdenom="32001" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=3000)) or try(&quot;zweckbestimmung&quot; = 3000)" label="Äussere Einwirkungen" symbol="2" key="{c75bf77f-04e5-4cf3-9bea-5f6679440ae8}"/>
      <rule scalemindenom="1" scalemaxdenom="32001" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=4000)) or try(&quot;zweckbestimmung&quot; = 4000)" label="SchadstoffBelastBoden" symbol="3" key="{f72bd02b-b8f5-4f12-a71a-7c8ecb350587}"/>
      <rule scalemindenom="1" scalemaxdenom="32001" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=5000)) or try(&quot;zweckbestimmung&quot; = 5000)" label="Lärmbelastung" symbol="4" key="{d9a2667d-ba74-4c61-8490-961ddf8b0a75}"/>
      <rule scalemindenom="1" scalemaxdenom="32001" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=6000)) or try(&quot;zweckbestimmung&quot; = 6000)" label="Bergbau" symbol="5" key="{873d66fd-497a-4c1c-96d6-beb15e348210}"/>
      <rule scalemindenom="1" scalemaxdenom="32001" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=7000)) or try(&quot;zweckbestimmung&quot; = 7000)" label="Bodenordnung" symbol="6" key="{a17befdc-e10d-47fa-a764-4399c84fe415}"/>
      <rule scalemindenom="1" scalemaxdenom="32001" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=8000)) or try(&quot;zweckbestimmung&quot; = 8000)" label="Vorhabensgebiet" symbol="7" key="{bd41dd13-cdea-4c43-bfc2-2e7e15eb9244}"/>
      <rule scalemindenom="1" scalemaxdenom="32001" filter="try((array_length(&quot;zweckbestimmung&quot;)=1 and &quot;zweckbestimmung&quot;[0]=9999)) or try(&quot;zweckbestimmung&quot; = 9999)" label="andere gesetzliche Vorschriften" symbol="8" key="{724c8a2e-f8f7-482d-9eec-e6d6814d486b}"/>
      <rule scalemindenom="1" scalemaxdenom="32001" filter="try((array_length(&quot;zweckbestimmung&quot;)>0 and &quot;zweckbestimmung&quot;[0] is NULL)) or try(&quot;zweckbestimmung&quot; is NULL)" label="Zweckbestimmung nicht definiert" symbol="9" key="{b782b483-282c-42b7-b6c7-eb92c0efa55e}"/>
      <rule scalemindenom="1" scalemaxdenom="32001" filter="geom_to_wkt(force_polygon_cw($geometry)) = geom_to_wkt($geometry)" label="in falscher Richtung digitalisiert" symbol="10" key="{6db63371-dafe-4b54-9e00-4fc666df40bc}"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" name="3" clip_to_extent="1" frame_rate="10" type="fill" alpha="1" is_animated="0">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol force_rhr="0" name="@3@1" clip_to_extent="1" frame_rate="10" type="marker" alpha="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" name="4" clip_to_extent="1" frame_rate="10" type="fill" alpha="1" is_animated="0">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol force_rhr="0" name="@4@1" clip_to_extent="1" frame_rate="10" type="marker" alpha="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" name="5" clip_to_extent="1" frame_rate="10" type="fill" alpha="1" is_animated="0">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol force_rhr="0" name="@5@1" clip_to_extent="1" frame_rate="10" type="marker" alpha="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" name="6" clip_to_extent="1" frame_rate="10" type="fill" alpha="1" is_animated="0">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol force_rhr="0" name="@6@1" clip_to_extent="1" frame_rate="10" type="marker" alpha="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" name="7" clip_to_extent="1" frame_rate="10" type="fill" alpha="1" is_animated="0">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol force_rhr="0" name="@7@1" clip_to_extent="1" frame_rate="10" type="marker" alpha="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" name="8" clip_to_extent="1" frame_rate="10" type="fill" alpha="1" is_animated="0">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol force_rhr="0" name="@8@1" clip_to_extent="1" frame_rate="10" type="marker" alpha="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
