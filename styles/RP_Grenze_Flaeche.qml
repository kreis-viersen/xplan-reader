...
<qgis version="3.28.4-Firenze" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{45832543-2742-4598-b9c9-182b905bb166}">
      <rule key="{8ed0b61b-e30b-4ec7-a6ec-6a4d9f18f9d7}" symbol="0" filter="try ( &quot;typ&quot; &lt;1251 ) or try ( &quot;typ&quot;[0] &lt;1251 ) or try ( &quot;typ&quot;[1] &lt;1251 ) " label="Grenze Bund/Land/BezReg/Bezirk"/>
      <rule key="{221bccbc-cdcc-417b-ac78-e31def918def}" symbol="1" filter="try ( &quot;typ&quot; =1300 ) or try ( &quot;typ&quot;[0] =1300 ) or try ( &quot;typ&quot;[1] =1300 ) " label="Kreisgrenze"/>
      <rule key="{c0855db0-72df-4068-b5ed-8c3448c63e47}" symbol="2" filter="try ( &quot;typ&quot; >1300 ) or try ( &quot;typ&quot;[0] >1300 ) or try ( &quot;typ&quot;[1] >1300 ) " label="nachgeordnete Grenze"/>
      <rule key="{7fe5eff4-37bc-4759-9a08-05613eccdc5f}" symbol="3" filter="ELSE" label="weitere"/>
    </rules>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style allowHtml="0" fontWeight="50" fontKerning="1" isExpression="1" textColor="50,50,50,255" forcedItalic="0" capitalization="0" forcedBold="0" previewBkgrdColor="255,255,255,255" legendString="Aa" multilineHeight="1" fontWordSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontStrikeout="0" fontUnderline="0" useSubstitutions="0" fieldName="+ case when try(&quot;text&quot; is not null) then   case &#xd;&#xa;when length(&quot;text&quot;)>25 then left(replace(&quot;text&quot;,'\n',' '),25)+'...'&#xd;&#xa;when length(&quot;text&quot;)&lt;26 then      replace(&quot;text&quot;,'\n',' ')  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+&#xd;&#xa;case&#xd;&#xa;when try(&quot;spezifischerTyp&quot; is not null) then&#xd;&#xa;  case&#xd;&#xa;  when  &quot;spezifischerTyp&quot;=1000 then '12-Meilenzone'&#xd;&#xa;  when  &quot;spezifischerTyp&quot;=1001 then 'Begrenzung Küstenmeer'&#xd;&#xa;  when  &quot;spezifischerTyp&quot;=2000 then 'Verlauf umstritten'&#xd;&#xa;  when  &quot;spezifischerTyp&quot;=3000 then 'Grenze AWZ'&#xd;&#xa;  when  &quot;spezifischerTyp&quot;=4000 then 'mittl.Tide Hochwasserlinie'&#xd;&#xa;  when  &quot;spezifischerTyp&quot;=5000 then 'Planungsgrenze Region'&#xd;&#xa;  when  &quot;spezifischerTyp&quot;=6000 then 'Planungsgrenze Land'&#xd;&#xa;  when  &quot;spezifischerTyp&quot;=7000 then 'Grenze Braunkohlenplan'&#x9;&#x9;&#x9;  &#xd;&#xa;  when  &quot;spezifischerTyp&quot;=8000 then 'Grenzübergangsstelle'&#xd;&#xa;  else '' end &#xd;&#xa;else '' end   &#xd;&#xa;&#xd;&#xa;&#x9;&#xd;&#xa;" fontSize="8" fontFamily="Arial" fontLetterSpacing="0" multilineHeightUnit="Percentage" fontSizeUnit="Point" textOpacity="1" textOrientation="horizontal" namedStyle="Regular" blendMode="0">
        <families/>
        <text-buffer bufferBlendMode="0" bufferSizeUnits="Percentage" bufferColor="250,250,250,255" bufferNoFill="1" bufferJoinStyle="128" bufferOpacity="1" bufferSize="40" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="1"/>
      ...
      <placement overrunDistance="0" polygonPlacementFlags="2" centroidInside="0" yOffset="0" placementFlags="9" fitInPolygonOnly="0" repeatDistance="0" allowDegraded="0" offsetUnits="MM" geometryGenerator="" preserveRotation="1" geometryGeneratorType="PointGeometry" offsetType="0" distUnits="MM" lineAnchorClipping="0" lineAnchorPercent="0.5" rotationUnit="AngleDegrees" layerType="PolygonGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="7" overrunDistanceUnit="MM" lineAnchorTextPoint="FollowPlacement" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" priority="5" lineAnchorType="0" centroidWhole="0" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" quadOffset="4" xOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overlapHandling="PreventOverlap" repeatDistanceUnits="MM" dist="0"/>
      <rendering zIndex="0" scaleMax="32001" obstacleFactor="1" scaleVisibility="1" scaleMin="0" mergeLines="0" fontMaxPixelSize="10000" upsidedownLabels="0" unplacedVisibility="0" drawLabels="1" fontMinPixelSize="3" labelPerPart="0" obstacle="1" maxNumLabels="2000" fontLimitPixelSize="0" minFeatureSize="0" limitNumLabels="0" obstacleType="1"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
