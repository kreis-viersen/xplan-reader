...
<qgis simplifyLocal="1" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Symbology3D|Labeling|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" labelsEnabled="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" minScale="100000000" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" version="3.26.3-Buenos Aires" simplifyDrawingHints="1" maxScale="0">
  <flags>
  ...
  <temporal startExpression="" accumulate="0" durationField="" startField="" enabled="0" limitMode="0" fixedDuration="0" durationUnit="min" endField="" endExpression="" mode="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation zscale="1" binding="Centroid" showMarkerSymbolInSurfacePlots="0" extrusion="0" clamping="Terrain" type="IndividualFeatures" respectLayerSymbol="1" extrusionEnabled="0" zoffset="0" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" alpha="1" name="" clip_to_extent="1" frame_rate="10" force_rhr="0" type="line">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" alpha="1" name="" clip_to_extent="1" frame_rate="10" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" alpha="1" name="" clip_to_extent="1" frame_rate="10" force_rhr="0" type="marker">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol is_animated="0" alpha="1" name="0" clip_to_extent="1" frame_rate="10" force_rhr="0" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer locked="0" enabled="1" pass="0" class="PointPatternFill">
          <Option type="Map">
            ...
            <Option value="2.8" name="distance_x" type="QString"/>
            ...
            <Option value="328585660" name="seed" type="QString"/>
          </Option>
          <prop v="0" k="angle"/>
          ...
          <symbol is_animated="0" alpha="1" name="@0@0" clip_to_extent="1" frame_rate="10" force_rhr="0" type="marker">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
            ...
            <layer locked="0" enabled="1" pass="0" class="SimpleMarker">
              <Option type="Map">
                <Option value="0" name="angle" type="QString"/>
                <Option value="square" name="cap_style" type="QString"/>
                <Option value="209,58,120,0" name="color" type="QString"/>
                <Option value="1" name="horizontal_anchor_point" type="QString"/>
                <Option value="bevel" name="joinstyle" type="QString"/>
                ...
                <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
                <Option value="MM" name="offset_unit" type="QString"/>
                <Option value="209,58,128,255" name="outline_color" type="QString"/>
                <Option value="solid" name="outline_style" type="QString"/>
              ...
              <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
              <prop v="MM" k="offset_unit"/>
              <prop v="209,58,128,255" k="outline_color"/>
              <prop v="solid" k="outline_style"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory rotationOffset="270" minimumSize="0" maxScaleDenominator="1e+08" height="15" scaleBasedVisibility="0" penAlpha="255" spacingUnitScale="3x:0,0,0,0,0,0" spacing="5" lineSizeScale="3x:0,0,0,0,0,0" barWidth="5" width="15" lineSizeType="MM" penWidth="0" spacingUnit="MM" sizeScale="3x:0,0,0,0,0,0" direction="0" diagramOrientation="Up" showAxis="1" backgroundColor="#ffffff" minScaleDenominator="0" scaleDependency="Area" penColor="#000000" backgroundAlpha="255" enabled="0" labelPlacementMethod="XHeight" sizeType="MM" opacity="1">
      <fontProperties underline="0" style="" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0" strikethrough="0" italic="0"/>
      <axisSymbol>
        <symbol is_animated="0" alpha="1" name="" clip_to_extent="1" frame_rate="10" force_rhr="0" type="line">
          <data_defined_properties>
            <Option type="Map">
  ...
  <DiagramLayerSettings linePlacementFlags="18" showAll="1" obstacle="0" priority="0" zIndex="0" dist="0" placement="1">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
