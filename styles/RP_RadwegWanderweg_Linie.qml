...
<qgis version="3.28.4-Firenze" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1">
    <rules key="{5584dd72-51a2-4021-8cc6-ba597102bcb5}">
      <rule symbol="0" key="{bbeedd56-d3d7-45bb-8c03-56c2f9b71a00}"/>
    </rules>
    <symbols>
      <symbol type="line" frame_rate="10" alpha="1" is_animated="0" name="0" clip_to_extent="1" force_rhr="0">
        ...
        <layer locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="draw_inside_polygon" value="0"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="line_color" value="244,205,205,255"/>
