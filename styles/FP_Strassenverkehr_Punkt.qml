...
<qgis styleCategories="Symbology|Labeling" version="3.28.4-Firenze" labelsEnabled="1">
  <renderer-v2 symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0" referencescale="-1">
    <rules key="{94a4f8dc-6887-46b2-aa18-a83d7dacc992}">
      <rule scalemaxdenom="8001" filter="&quot;zweckbestimmung&quot;=1300" scalemindenom="1" key="{5a3cf030-ffbe-41be-b430-c56f07761dcf}" symbol="0" label="Ortsdurchfahrt"/>
      <rule scalemaxdenom="8001" filter="&quot;zweckbestimmung&quot;=16002" scalemindenom="1" key="{57afdfe6-969a-4647-b101-db53082e75ab}" symbol="1" label="Park &amp; Ride"/>
      <rule scalemaxdenom="8001" filter="&quot;zweckbestimmung&quot;=16000" scalemindenom="1" key="{bdaa68cd-7714-4ef1-a010-a717f3be069d}" symbol="2" label="Parkplatz"/>
      <rule scalemaxdenom="8001" filter="&quot;zweckbestimmung&quot;&lt;>1300 and&#xd;&#xa;&quot;zweckbestimmung&quot;&lt;>16002 and&#xd;&#xa;&quot;zweckbestimmung&quot;&lt;>16000" scalemindenom="1" key="{29c51994-767a-4903-bf86-881e1fb85a6a}" symbol="3" label="restliche"/>
      <rule scalemaxdenom="8001" filter="&quot;zweckbestimmung&quot; is NULL" scalemindenom="1" key="{5f5e59a4-b638-4b67-a7cf-1836e0854d69}" symbol="4" label="Zweckbestimmung nicht definiert"/>
    </rules>
    <symbols>
      <symbol name="0" frame_rate="10" alpha="1" type="marker" is_animated="0" force_rhr="0" clip_to_extent="1">
      ...
      <symbol name="1" frame_rate="10" alpha="1" type="marker" is_animated="0" force_rhr="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol name="2" frame_rate="10" alpha="1" type="marker" is_animated="0" force_rhr="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol name="3" frame_rate="10" alpha="1" type="marker" is_animated="0" force_rhr="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol name="4" frame_rate="10" alpha="1" type="marker" is_animated="0" force_rhr="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textColor="50,50,50,255" useSubstitutions="0" fontWeight="50" textOrientation="horizontal" multilineHeight="1" capitalization="0" isExpression="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" forcedBold="0" legendString="Aa" fontUnderline="0" fontWordSpacing="0" forcedItalic="0" namedStyle="Regular" fontKerning="1" fontFamily="Arial" fontSize="8" fontSizeUnit="Point" fieldName="case&#xd;&#xa;when try(zweckbestimmung is not NULL) then&#xd;&#xa;case&#xd;&#xa;when &quot;zweckbestimmung&quot;=1000   then 'Autobahn'&#xd;&#xa;when &quot;zweckbestimmung&quot;=1200   then 'Hauptverkehrsstraße'&#xd;&#xa;when &quot;zweckbestimmung&quot;=1300   then 'Ortsdurchfahrt'&#xd;&#xa;when &quot;zweckbestimmung&quot;=1400   then 'sonst.Verkehrsweg'&#xd;&#xa;when &quot;zweckbestimmung&quot;=1600   then 'ruhend.Verkehr'&#xd;&#xa;when &quot;zweckbestimmung&quot;=3000   then 'Car-Sharing'&#xd;&#xa;when &quot;zweckbestimmung&quot;=3100   then 'Abstell.gemein.Fahrrad'&#xd;&#xa;when &quot;zweckbestimmung&quot;=3200   then 'Bike&amp;Ride'&#xd;&#xa;when &quot;zweckbestimmung&quot;=3300   then 'Parkhaus'&#xd;&#xa;when &quot;zweckbestimmung&quot;=3400   then 'Mischverkehrsfläche'&#xd;&#xa;when &quot;zweckbestimmung&quot;=3500   then 'Ladestation E-KFZ'&#xd;&#xa;when &quot;zweckbestimmung&quot;=9999   then 'sonst.Zweckbestimmung'&#xd;&#xa;when &quot;zweckbestimmung&quot;=14000  then 'verkehrsberuhigt'&#xd;&#xa;when &quot;zweckbestimmung&quot;=14001  then 'Platz'&#xd;&#xa;when &quot;zweckbestimmung&quot;=14002  then 'Fußgängerbereich'&#xd;&#xa;when &quot;zweckbestimmung&quot;=14003  then 'Rad&amp;Fußweg'&#xd;&#xa;when &quot;zweckbestimmung&quot;=14004  then 'Radweg'&#xd;&#xa;when &quot;zweckbestimmung&quot;=14005  then 'Fußweg'&#xd;&#xa;when &quot;zweckbestimmung&quot;=14006  then 'Wanderweg'&#xd;&#xa;when &quot;zweckbestimmung&quot;=14007  then 'Reit&amp;Kutschweg'&#xd;&#xa;when &quot;zweckbestimmung&quot;=14008  then 'Rastanlage'&#xd;&#xa;when &quot;zweckbestimmung&quot;=14009  then 'Busbahnhof'&#xd;&#xa;when &quot;zweckbestimmung&quot;=16000  then 'Parkplatz'&#xd;&#xa;when &quot;zweckbestimmung&quot;=16001  then 'Abstell.Fahrrad'&#xd;&#xa;when &quot;zweckbestimmung&quot;=16002  then 'Park&amp;Ride'&#xd;&#xa;when &quot;zweckbestimmung&quot;=140010 then 'Überführung'&#xd;&#xa;when &quot;zweckbestimmung&quot;=140011 then 'Unterführung'&#xd;&#xa;when &quot;zweckbestimmung&quot;=140012 then 'Wirtschaftsweg'&#xd;&#xa;when &quot;zweckbestimmung&quot;=140013 then 'landwirt.Verkehr'&#xd;&#xa;else 'Zweckbestimmung nicht definiert' END &#xd;&#xa;else 'Zweckbestimmung nicht definiert' END &#xd;&#xa;&#xd;&#xa;+ case when try(&quot;text&quot; is not null) then   case &#xd;&#xa;when length(&quot;text&quot;)>25 then '\n'+left(replace(&quot;text&quot;,'\n',' '),25)+'...'&#xd;&#xa;when length(&quot;text&quot;)&lt;26 then '\n'+     replace(&quot;text&quot;,'\n',' ')  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung1&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung1&quot;)>25 then '\n'+left(&quot;gliederung1&quot;,25)+'...'&#xd;&#xa;when length(&quot;gliederung1&quot;)&lt;26 then '\n'+     &quot;gliederung1&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung2&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung2&quot;)>25 then '\n'+left(&quot;gliederung2&quot;,25)+'...'&#xd;&#xa;when length(&quot;gliederung2&quot;)&lt;26 then '\n'+     &quot;gliederung2&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;aufschrift&quot; is not null) then   case &#xd;&#xa;when length(&quot;aufschrift&quot;)>25 then '\n'+left(&quot;aufschrift&quot;,25)+'...'&#xd;&#xa;when length(&quot;aufschrift&quot;)&lt;26 then '\n'+     &quot;aufschrift&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;name&quot; is not null) and try(&quot;name&quot;[1]is null) then   case &#xd;&#xa;when length(&quot;name&quot;)>25 then '\n'+left(&quot;name&quot;,25)+'...'&#xd;&#xa;when length(&quot;name&quot;)&lt;26 then '\n'+     &quot;name&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;/* Ergänzung für Codelisten &#xd;&#xa;https://registry.gdi-de.org/codelist/de.xleitstelle.xplanung/SO_DetailKlassifizNachSchienenverkehrsrecht&#xd;&#xa;am 04.04.23 nur einen Eintrag Haltepunkt 9999_1 */&#xd;&#xa;+ CASE &#xd;&#xa;WHEN try(detaillierteZweckbestimmung is not NULL,'-')    THEN   '\n'  + to_string(&quot;detaillierteZweckbestimmung&quot;)&#xd;&#xa;WHEN try(detaillierteZweckbestimmung[0] is not NULL,'-') THEN   '\n'  + array_to_string(&quot;detaillierteZweckbestimmung&quot;[0] ,' ')&#xd;&#xa;ELSE '' &#xd;&#xa;END&#xd;&#xa;&#xd;&#xa;+ case when try( &quot;nutzungsform&quot; =1000) then    '\n' +'privat' ELSE '' End" fontItalic="0" textOpacity="1" fontStrikeout="0" fontLetterSpacing="0" multilineHeightUnit="Percentage" blendMode="0" allowHtml="0" previewBkgrdColor="255,255,255,255">
        ...
        <background shapeOffsetX="0" shapeRotation="0" shapeFillColor="255,255,255,255" shapeSizeUnit="Point" shapeBorderWidthUnit="Point" shapeRadiiY="0" shapeOpacity="1" shapeJoinStyle="64" shapeSizeType="0" shapeRotationType="0" shapeDraw="0" shapeSizeX="0" shapeSizeY="0" shapeSVGFile="" shapeRadiiUnit="Point" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="Point" shapeType="0" shapeBorderColor="128,128,128,255" shapeBlendMode="0" shapeBorderWidth="0">
      ...
      <text-format wrapChar="" leftDirectionSymbol="&lt;" addDirectionSymbol="0" autoWrapLength="25" useMaxLineLengthForAutoWrap="1" multilineAlign="3" rightDirectionSymbol=">" reverseDirectionSymbol="0" formatNumbers="0" placeDirectionSymbol="0" plussign="0" decimals="3"/>
      <placement overrunDistance="0" allowDegraded="0" priority="5" yOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" maxCurvedCharAngleOut="-25" placementFlags="10" rotationAngle="0" geometryGeneratorType="PointGeometry" rotationUnit="AngleDegrees" lineAnchorType="0" geometryGeneratorEnabled="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidWhole="0" overlapHandling="PreventOverlap" dist="0" fitInPolygonOnly="0" repeatDistance="0" polygonPlacementFlags="2" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="RenderMetersInMapUnits" layerType="PointGeometry" lineAnchorTextPoint="FollowPlacement" offsetType="1" distMapUnitScale="3x:0,0,0,0,0,0" quadOffset="5" placement="1" maxCurvedCharAngleIn="25" xOffset="14" preserveRotation="1" lineAnchorClipping="0" geometryGenerator="" repeatDistanceUnits="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" overrunDistanceUnit="MM" centroidInside="0"/>
      <rendering obstacleFactor="1" labelPerPart="0" fontLimitPixelSize="0" scaleMax="4001" obstacleType="1" zIndex="0" mergeLines="0" maxNumLabels="2000" scaleMin="1" upsidedownLabels="0" fontMaxPixelSize="10000" obstacle="1" fontMinPixelSize="3" limitNumLabels="0" scaleVisibility="1" drawLabels="1" unplacedVisibility="0" minFeatureSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
