...
<qgis labelsEnabled="1" version="3.30.2-'s-Hertogenbosch" styleCategories="Symbology|Labeling">
  <renderer-v2 referencescale="-1" type="RuleRenderer" symbollevels="0" forceraster="0" enableorderby="0">
    <rules key="{519cee4e-b8ac-4e23-9c28-768395c7b1e7}">
      <rule scalemindenom="1" symbol="0" scalemaxdenom="1001" key="{87d8bf25-c7c4-477d-b374-211cfef4f008}"/>
    </rules>
    <symbols>
      <symbol frame_rate="10" type="line" name="0" clip_to_extent="1" force_rhr="0" is_animated="0" alpha="1">
        ...
        <layer enabled="1" class="SimpleLine" pass="0" locked="0" id="{369569ec-6a6e-492d-b068-46b263dbc8fe}">
          <Option type="Map">
        ...
        <layer enabled="1" class="SimpleLine" pass="0" locked="0" id="{bdc5b6f1-0e2c-4763-8181-1a28bf0a905f}">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
            ...
            <Option type="QString" name="draw_inside_polygon" value="0"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="line_color" value="126,126,126,255"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement lineAnchorTextPoint="FollowPlacement" xOffset="0" overlapHandling="PreventOverlap" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="9" layerType="LineGeometry" maxCurvedCharAngleOut="-25" rotationUnit="AngleDegrees" preserveRotation="1" offsetUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" priority="5" lineAnchorType="0" yOffset="0" geometryGeneratorType="PointGeometry" geometryGenerator="" geometryGeneratorEnabled="0" fitInPolygonOnly="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" placement="3" repeatDistanceUnits="MM" overrunDistance="0" offsetType="0" lineAnchorPercent="0.5" quadOffset="4" allowDegraded="0" overrunDistanceUnit="MM" centroidInside="0" polygonPlacementFlags="2" repeatDistance="0" dist="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25"/>
      <rendering limitNumLabels="0" obstacleType="1" drawLabels="1" fontMaxPixelSize="10000" labelPerPart="0" scaleVisibility="1" fontLimitPixelSize="0" obstacleFactor="1" minFeatureSize="0" mergeLines="0" maxNumLabels="2000" scaleMax="501" zIndex="0" scaleMin="0" obstacle="1" fontMinPixelSize="3" unplacedVisibility="0" upsidedownLabels="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
