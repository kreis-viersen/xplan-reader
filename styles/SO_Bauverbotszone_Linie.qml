...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.28.4-Firenze">
  <renderer-v2 forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0" referencescale="-1">
    <rules key="{7747d635-9060-4c63-af03-cf6e382bbc87}">
      <rule key="{7e52e887-395e-4d38-8a8e-4fe56dc2cbf8}" symbol="0" scalemindenom="1" label="alle" scalemaxdenom="16001"/>
      <rule key="{b5053cc9-a11e-4f22-9aa2-80c507fd7d11}" symbol="1" scalemindenom="1" filter="&quot;artDerFestlegung&quot; is NULL" label="davon artDerFestlegung nicht definiert" scalemaxdenom="16001"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" frame_rate="10" type="line" force_rhr="0" name="1" is_animated="0" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="8" textColor="50,50,50,255" fontLetterSpacing="0" multilineHeight="1" previewBkgrdColor="255,255,255,255" isExpression="1" fontWeight="50" fontSizeUnit="Point" fieldName="&#xd;&#xa;CASE &#xd;&#xa;WHEN TRY(&quot;artDerFestlegung&quot;=1000) THEN 'Bauverbotszone'&#xd;&#xa;WHEN TRY(&quot;artDerFestlegung&quot;=2000) THEN 'Baubeschränkungszone'&#xd;&#xa;WHEN TRY(&quot;artDerFestlegung&quot;=3000) THEN 'Waldabstand'&#x9;&#xd;&#xa;WHEN TRY(&quot;artDerFestlegung&quot;=3000) THEN 'sonst.Baubeschränkung'&#x9;&#xd;&#xa;ELSE 'SO Bauverbotszone Linie ohne Festlegung'&#xd;&#xa;END" useSubstitutions="0" textOpacity="1" namedStyle="Regular" fontUnderline="0" blendMode="0" forcedItalic="0" fontWordSpacing="0" multilineHeightUnit="Percentage" fontFamily="Arial" allowHtml="0" forcedBold="0" fontStrikeout="0" legendString="Aa" textOrientation="horizontal" fontKerning="1" fontItalic="0" capitalization="0">
        <families/>
      ...
      <rendering obstacleFactor="1" zIndex="0" fontMinPixelSize="3" drawLabels="1" maxNumLabels="2000" fontMaxPixelSize="10000" scaleVisibility="1" limitNumLabels="0" upsidedownLabels="0" scaleMin="1" fontLimitPixelSize="0" obstacle="1" minFeatureSize="0" scaleMax="4001" obstacleType="1" labelPerPart="0" unplacedVisibility="0" mergeLines="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
