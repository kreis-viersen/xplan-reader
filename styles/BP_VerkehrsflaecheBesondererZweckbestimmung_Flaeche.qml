...
<qgis version="3.36.3-Maidenhead" styleCategories="Symbology|Labeling|MapTips" labelsEnabled="1">
  <renderer-v2 referencescale="-1" symbollevels="0" type="RuleRenderer" forceraster="0" enableorderby="0">
    <rules key="{d1a18705-782c-4041-8cab-c631adb5a594}">
      <rule symbol="0" key="{6d60a8d2-e607-48a9-b3e4-19f2a617657f}" label="alles"/>
      <rule filter="try (array_length( &quot;zweckbestimmung&quot;)>1)" symbol="1" key="{43dc0f57-c22f-41f0-9e2e-7f6ac30b6206}" label="davon mehrere Zweckbestimmungen"/>
      <rule filter="try (&quot;zweckbestimmung&quot;=1000) or try (&quot;zweckbestimmung&quot;[0]=1000)" symbol="2" key="{b61dcfb9-b440-4d27-8e14-906ced985651}" label="davon Fläche für das Parken von Fahrzeugen"/>
      <rule filter="Try(&quot;zweckbestimmung&quot;=1100) or try(&quot;zweckbestimmung&quot;=1500) or Try(&quot;zweckbestimmung&quot;[0]=1100) or try(&quot;zweckbestimmung&quot;[0]=1500)" symbol="3" key="{e294cfb9-eef7-4a22-9215-41c2b489f401}" label="davon Fußgängerbereich/reiner Fußweg"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=1200) or try(&quot;zweckbestimmung&quot;[0]=1200) " symbol="4" key="{2a4b44ee-61a4-465e-a5c7-efb2265245fd}" label="davon verkehrsberuhigte Zone"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=1300) or try(&quot;zweckbestimmung&quot;[0]=1300)" symbol="5" key="{3940d81e-312a-4942-a705-67e576a4ba45}" label="davon Rad- und Fußweg"/>
      <rule filter="try(&quot;zweckbestimmung&quot;=2400) or try(&quot;zweckbestimmung&quot;[0]=2400)" symbol="6" key="{e2f4d0e0-12a1-46a9-ba52-c6c3b057c754}" label="davon Verkehrsgrün"/>
      <rule filter="try (&quot;zweckbestimmung&quot; is NuLL) and try (&quot;zweckbestimmung&quot;[0] is NuLL)  " symbol="7" key="{cf78aa3c-a0b3-4e04-82ba-40762f76f6a0}" label="davon Zweckbestimmung nicht definiert"/>
    </rules>
    <symbols>
      <symbol name="0" force_rhr="0" is_animated="0" type="fill" frame_rate="10" alpha="1" clip_to_extent="1">
        ...
        <layer class="LinePatternFill" id="{d817a3df-b1a6-4414-b8bf-feb5153ae8d7}" enabled="1" pass="0" locked="0">
          <Option type="Map">
          ...
          <symbol name="@0@0" force_rhr="0" is_animated="0" type="line" frame_rate="10" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" id="{b5ef97f4-21e6-4866-a4af-dd5ac088cbbe}" enabled="1" pass="0" locked="0">
              <Option type="Map">
                ...
                <Option name="line_color" value="255,217,47,255,rgb:1,0.85098039215686272,0.18431372549019609,1" type="QString"/>
        ...
        <layer class="SimpleFill" id="{78db9b14-8589-4245-a8cd-17d3306ca427}" enabled="1" pass="0" locked="0">
          <Option type="Map">
      ...
      <symbol name="1" force_rhr="0" is_animated="0" type="fill" frame_rate="10" alpha="1" clip_to_extent="1">
        ...
        <layer class="LinePatternFill" id="{d817a3df-b1a6-4414-b8bf-feb5153ae8d7}" enabled="1" pass="0" locked="0">
          ...
          <symbol name="@1@0" force_rhr="0" is_animated="0" type="line" frame_rate="10" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol name="2" force_rhr="0" is_animated="0" type="fill" frame_rate="10" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer class="LinePatternFill" id="{57c177a2-1c94-43c2-a1bb-cc9082bb0c9d}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="angle" value="45" type="QString"/>
            <Option name="clip_mode" value="during_render" type="QString"/>
            <Option name="color" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" type="QString"/>
          ...
          <symbol name="@2@0" force_rhr="0" is_animated="0" type="line" frame_rate="10" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" id="{f5891d98-32fb-422c-b5c1-252714d0ea9c}" enabled="1" pass="0" locked="0">
              <Option type="Map">
                <Option name="align_dash_pattern" value="0" type="QString"/>
                <Option name="capstyle" value="square" type="QString"/>
                <Option name="customdash" value="5;2" type="QString"/>
        ...
        <layer class="SimpleFill" id="{e5d2c052-24ff-4dc2-8159-8c138d205096}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
        ...
        <layer class="CentroidFill" id="{cad790ed-50e5-4d65-84e1-4498c09601b6}" enabled="1" pass="0" locked="0">
          <Option type="Map">
          ...
          <symbol name="@2@2" force_rhr="0" is_animated="0" type="marker" frame_rate="10" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer class="SvgMarker" id="{cfcb359c-f65d-406e-a27e-e88ec86f789e}" enabled="1" pass="0" locked="0">
              <Option type="Map">
      ...
      <symbol name="3" force_rhr="0" is_animated="0" type="fill" frame_rate="10" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer class="LinePatternFill" id="{68f9f3b4-9345-438d-b2b9-2e3aff2c1207}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="angle" value="45" type="QString"/>
            <Option name="clip_mode" value="during_render" type="QString"/>
            <Option name="color" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" type="QString"/>
          ...
          <symbol name="@3@0" force_rhr="0" is_animated="0" type="line" frame_rate="10" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" id="{527475d7-1770-435a-8c53-8bcae92cc5c4}" enabled="1" pass="0" locked="0">
              <Option type="Map">
                <Option name="align_dash_pattern" value="0" type="QString"/>
                <Option name="capstyle" value="square" type="QString"/>
                <Option name="customdash" value="5;2" type="QString"/>
        ...
        <layer class="SimpleFill" id="{c0f3ef7d-0ec5-4452-98e3-de98ffb8dbb8}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
        ...
        <layer class="CentroidFill" id="{28bef5dd-7989-4d9a-9f68-8abbee7a5a60}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="clip_on_current_part_only" value="0" type="QString"/>
            <Option name="clip_points" value="1" type="QString"/>
            <Option name="point_on_all_parts" value="1" type="QString"/>
          ...
          <symbol name="@3@2" force_rhr="0" is_animated="0" type="marker" frame_rate="10" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer class="SvgMarker" id="{2b6dab96-5deb-44ba-94e4-682774edc520}" enabled="1" pass="0" locked="0">
              <Option type="Map">
                <Option name="angle" value="0" type="QString"/>
                <Option name="color" value="255,0,0,255,rgb:1,0,0,1" type="QString"/>
                <Option name="fixedAspectRatio" value="0" type="QString"/>
      ...
      <symbol name="4" force_rhr="0" is_animated="0" type="fill" frame_rate="10" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer class="LinePatternFill" id="{9f75125b-a7cf-4a3d-ba7e-323633b263e5}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="angle" value="45" type="QString"/>
            <Option name="clip_mode" value="during_render" type="QString"/>
            <Option name="color" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" type="QString"/>
          ...
          <symbol name="@4@0" force_rhr="0" is_animated="0" type="line" frame_rate="10" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" id="{4228bcd0-1abc-4747-87f9-a9c0d502c898}" enabled="1" pass="0" locked="0">
              <Option type="Map">
                <Option name="align_dash_pattern" value="0" type="QString"/>
                <Option name="capstyle" value="square" type="QString"/>
                <Option name="customdash" value="5;2" type="QString"/>
        ...
        <layer class="SimpleFill" id="{1b1644f7-b249-412b-a2a2-c0e804b20df5}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
        ...
        <layer class="CentroidFill" id="{0f9b42da-7f54-4d56-ad5a-6c55cd42bcf9}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="clip_on_current_part_only" value="0" type="QString"/>
            <Option name="clip_points" value="1" type="QString"/>
            <Option name="point_on_all_parts" value="1" type="QString"/>
          ...
          <symbol name="@4@2" force_rhr="0" is_animated="0" type="marker" frame_rate="10" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer class="SvgMarker" id="{b501c4c8-c496-440c-bf7c-498183a6e89c}" enabled="1" pass="0" locked="0">
              <Option type="Map">
                <Option name="angle" value="0" type="QString"/>
                <Option name="color" value="255,0,0,255,rgb:1,0,0,1" type="QString"/>
                <Option name="fixedAspectRatio" value="0" type="QString"/>
      ...
      <symbol name="5" force_rhr="0" is_animated="0" type="fill" frame_rate="10" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer class="LinePatternFill" id="{3baea0fb-2d28-44e5-a50a-96423096ae25}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="angle" value="45" type="QString"/>
            <Option name="clip_mode" value="during_render" type="QString"/>
            <Option name="color" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" type="QString"/>
          ...
          <symbol name="@5@0" force_rhr="0" is_animated="0" type="line" frame_rate="10" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" id="{fa658aac-4d69-49c1-b6cf-fe6aa0f3c6be}" enabled="1" pass="0" locked="0">
              <Option type="Map">
                <Option name="align_dash_pattern" value="0" type="QString"/>
                <Option name="capstyle" value="square" type="QString"/>
                <Option name="customdash" value="5;2" type="QString"/>
        ...
        <layer class="SimpleFill" id="{3f1f8d05-ec7e-41a9-b44d-4e9f036506e2}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
        ...
        <layer class="CentroidFill" id="{d8a99dac-7c75-44fe-9b1a-aaf8b9ec5465}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="clip_on_current_part_only" value="0" type="QString"/>
            <Option name="clip_points" value="1" type="QString"/>
            <Option name="point_on_all_parts" value="1" type="QString"/>
          ...
          <symbol name="@5@2" force_rhr="0" is_animated="0" type="marker" frame_rate="10" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer class="SvgMarker" id="{87b8daf3-1833-43ef-907e-c71ffc651cce}" enabled="1" pass="0" locked="0">
              <Option type="Map">
                <Option name="angle" value="0" type="QString"/>
                <Option name="color" value="255,0,0,255,rgb:1,0,0,1" type="QString"/>
                <Option name="fixedAspectRatio" value="0" type="QString"/>
      ...
      <symbol name="6" force_rhr="0" is_animated="0" type="fill" frame_rate="10" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer class="LinePatternFill" id="{d817a3df-b1a6-4414-b8bf-feb5153ae8d7}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="angle" value="45" type="QString"/>
            <Option name="clip_mode" value="during_render" type="QString"/>
            <Option name="color" value="51,160,44,255,rgb:0.20000000000000001,0.62745098039215685,0.17254901960784313,1" type="QString"/>
            <Option name="coordinate_reference" value="feature" type="QString"/>
            <Option name="distance" value="8" type="QString"/>
            <Option name="distance_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="distance_unit" value="MapUnit" type="QString"/>
          ...
          <symbol name="@6@0" force_rhr="0" is_animated="0" type="line" frame_rate="10" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" id="{b5ef97f4-21e6-4866-a4af-dd5ac088cbbe}" enabled="1" pass="0" locked="0">
              <Option type="Map">
                ...
                <Option name="draw_inside_polygon" value="0" type="QString"/>
                <Option name="joinstyle" value="bevel" type="QString"/>
                <Option name="line_color" value="51,160,44,255,rgb:0.20000000000000001,0.62745098039215685,0.17254901960784313,1" type="QString"/>
                <Option name="line_style" value="solid" type="QString"/>
                <Option name="line_width" value="4" type="QString"/>
                <Option name="line_width_unit" value="MapUnit" type="QString"/>
                <Option name="offset" value="0" type="QString"/>
      ...
      <symbol name="7" force_rhr="0" is_animated="0" type="fill" frame_rate="10" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer class="LinePatternFill" id="{518796f1-243b-407a-bbca-b93008915118}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="angle" value="45" type="QString"/>
            <Option name="clip_mode" value="during_render" type="QString"/>
            <Option name="color" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" type="QString"/>
          ...
          <symbol name="@7@0" force_rhr="0" is_animated="0" type="line" frame_rate="10" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" id="{07c9da22-f879-493d-937e-8f125a959ee4}" enabled="1" pass="0" locked="0">
              <Option type="Map">
                <Option name="align_dash_pattern" value="0" type="QString"/>
                <Option name="capstyle" value="square" type="QString"/>
                <Option name="customdash" value="5;2" type="QString"/>
        ...
        <layer class="SimpleFill" id="{2c757d4a-e161-43f6-a5f9-9a3366a44273}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" force_rhr="0" is_animated="0" type="fill" frame_rate="10" alpha="1" clip_to_extent="1">
        ...
        <layer class="SimpleFill" id="{c5235ee1-82b4-4bfa-a263-dc236292feb9}" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" geometryGeneratorEnabled="0" geometryGeneratorType="PointGeometry" rotationAngle="0" repeatDistanceUnits="MM" quadOffset="4" yOffset="0" rotationUnit="AngleDegrees" allowDegraded="0" priority="5" preserveRotation="1" maxCurvedCharAngleOut="-25" offsetType="0" lineAnchorPercent="0.5" geometryGenerator="" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" centroidInside="1" centroidWhole="0" lineAnchorType="0" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="1" lineAnchorClipping="0" xOffset="0" overlapHandling="PreventOverlap" fitInPolygonOnly="0" offsetUnits="MM" overrunDistanceUnit="MM" distUnits="MM" dist="0" layerType="PolygonGeometry" maxCurvedCharAngleIn="25" lineAnchorTextPoint="FollowPlacement" repeatDistance="0" placementFlags="10"/>
      <rendering scaleMin="0" drawLabels="1" limitNumLabels="0" fontMaxPixelSize="10000" zIndex="0" fontLimitPixelSize="0" mergeLines="0" unplacedVisibility="0" obstacleType="1" scaleMax="501" minFeatureSize="0" fontMinPixelSize="3" maxNumLabels="2000" obstacle="1" obstacleFactor="1" labelPerPart="0" upsidedownLabels="0" scaleVisibility="1"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties" type="Map">
