...
<qgis minScale="100000000" simplifyAlgorithm="0" symbologyReferenceScale="-1" version="3.26.3-Buenos Aires" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Symbology3D|Labeling|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" simplifyDrawingTol="1" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" readOnly="0" maxScale="0" simplifyLocal="1">
  <flags>
  ...
  <temporal startExpression="" endExpression="" fixedDuration="0" enabled="0" startField="" accumulate="0" durationField="" endField="" durationUnit="min" mode="0" limitMode="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation zoffset="0" clamping="Terrain" symbology="Line" extrusionEnabled="0" zscale="1" binding="Centroid" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0" type="IndividualFeatures" extrusion="0">
    ...
    <profileLineSymbol>
      <symbol alpha="1" name="" is_animated="0" force_rhr="0" frame_rate="10" type="line" clip_to_extent="1">
    ...
    <profileFillSymbol>
      <symbol alpha="1" name="" is_animated="0" force_rhr="0" frame_rate="10" type="fill" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
    ...
    <profileMarkerSymbol>
      <symbol alpha="1" name="" is_animated="0" force_rhr="0" frame_rate="10" type="marker" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
  ...
  <renderer-v2 referencescale="-1" forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0">
    <rules key="{d1a18705-782c-4041-8cab-c631adb5a594}">
      <rule filter="&quot;zweckbestimmung&quot;=1000" label="Fläche für das Parken von Fahrzeugen" symbol="0" key="{b61dcfb9-b440-4d27-8e14-906ced985651}"/>
      <rule filter="&quot;zweckbestimmung&quot;=1100 or &quot;zweckbestimmung&quot;=1500" label="Fußgängerbereich oder reiner Fußweg" symbol="1" key="{e294cfb9-eef7-4a22-9215-41c2b489f401}"/>
      <rule filter="&quot;zweckbestimmung&quot;=1200" label="Verkehrsberuhigte Zone" symbol="2" key="{2a4b44ee-61a4-465e-a5c7-efb2265245fd}"/>
      <rule filter="&quot;zweckbestimmung&quot;=1300" label="Rad- und Fußweg" symbol="3" key="{3940d81e-312a-4942-a705-67e576a4ba45}"/>
      <rule filter="&quot;zweckbestimmung&quot; not ILIKE 1000 and  &#xd;&#xa;&quot;zweckbestimmung&quot; not ILIKE 1100 and &#xd;&#xa;&quot;zweckbestimmung&quot; not ILIKE 1200 and  &#xd;&#xa;&quot;zweckbestimmung&quot; not ILIKE 1300 and  &#xd;&#xa;&quot;zweckbestimmung&quot; not ILIKE 1500 " label="alles andere" symbol="4" key="{19094b9a-ee7b-4d41-ab1f-7ea11607504e}"/>
      <rule filter="&quot;zweckbestimmung&quot; is NuLL" label="Zweckbestimmung nicht definiert" symbol="5" key="{39e98a10-6e56-4987-8655-c80deb821f50}"/>
    </rules>
    <symbols>
      <symbol alpha="1" name="0" is_animated="0" force_rhr="0" frame_rate="10" type="fill" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" name="@0@0" is_animated="0" force_rhr="0" frame_rate="10" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="CentroidFill" locked="0">
          ...
          <symbol alpha="1" name="@0@2" is_animated="0" force_rhr="0" frame_rate="10" type="marker" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" name="1" is_animated="0" force_rhr="0" frame_rate="10" type="fill" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" name="@1@0" is_animated="0" force_rhr="0" frame_rate="10" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="CentroidFill" locked="0">
          ...
          <symbol alpha="1" name="@1@2" is_animated="0" force_rhr="0" frame_rate="10" type="marker" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" name="2" is_animated="0" force_rhr="0" frame_rate="10" type="fill" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" name="@2@0" is_animated="0" force_rhr="0" frame_rate="10" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="CentroidFill" locked="0">
          ...
          <symbol alpha="1" name="@2@2" is_animated="0" force_rhr="0" frame_rate="10" type="marker" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" name="3" is_animated="0" force_rhr="0" frame_rate="10" type="fill" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" name="@3@0" is_animated="0" force_rhr="0" frame_rate="10" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="CentroidFill" locked="0">
          ...
          <symbol alpha="1" name="@3@2" is_animated="0" force_rhr="0" frame_rate="10" type="marker" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" name="4" is_animated="0" force_rhr="0" frame_rate="10" type="fill" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" name="@4@0" is_animated="0" force_rhr="0" frame_rate="10" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" name="5" is_animated="0" force_rhr="0" frame_rate="10" type="fill" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer pass="0" enabled="1" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" name="@5@0" is_animated="0" force_rhr="0" frame_rate="10" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory scaleBasedVisibility="0" height="15" rotationOffset="270" penColor="#000000" showAxis="1" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" scaleDependency="Area" penWidth="0" diagramOrientation="Up" minimumSize="0" spacing="5" backgroundAlpha="255" barWidth="5" maxScaleDenominator="1e+08" backgroundColor="#ffffff" enabled="0" lineSizeType="MM" spacingUnitScale="3x:0,0,0,0,0,0" lineSizeScale="3x:0,0,0,0,0,0" sizeType="MM" spacingUnit="MM" penAlpha="255" opacity="1" minScaleDenominator="0" direction="0" width="15">
      <fontProperties description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" style="" strikethrough="0" underline="0" bold="0" italic="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;zweckbestimmung&quot;" sortOrder="1">
    <columns>
      <column width="-1" name="rechtsstand" type="field" hidden="0"/>
      <column width="-1" name="ebene" type="field" hidden="0"/>
      <column width="-1" name="flaechenschluss" type="field" hidden="0"/>
      <column width="397" name="zweckbestimmung" type="field" hidden="0"/>
      <column width="-1" name="nutzungsform" type="field" hidden="0"/>
      <column width="-1" name="rechtscharakter" type="field" hidden="0"/>
