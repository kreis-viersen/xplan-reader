...
<qgis styleCategories="Symbology|Labeling|MapTips" labelsEnabled="1" version="3.36.3-Maidenhead">
  <renderer-v2 type="RuleRenderer" forceraster="0" symbollevels="0" referencescale="-1" enableorderby="0">
    <rules key="{d1a18705-782c-4041-8cab-c631adb5a594}">
      ...
      <rule symbol="1" label="davon mehrere Zweckbestimmungen" filter="try (array_length( &quot;zweckbestimmung&quot;)>1)" key="{43dc0f57-c22f-41f0-9e2e-7f6ac30b6206}"/>
      <rule symbol="2" label="davon Fläche für das Parken von Fahrzeugen" filter="try (&quot;zweckbestimmung&quot;=1000) or try (&quot;zweckbestimmung&quot;[0]=1000)" key="{b61dcfb9-b440-4d27-8e14-906ced985651}"/>
      <rule symbol="3" label="davon Fußgängerbereich/reiner Fußweg" filter="Try(&quot;zweckbestimmung&quot;=1100) or try(&quot;zweckbestimmung&quot;=1500) or Try(&quot;zweckbestimmung&quot;[0]=1100) or try(&quot;zweckbestimmung&quot;[0]=1500)" key="{e294cfb9-eef7-4a22-9215-41c2b489f401}"/>
      <rule symbol="4" label="davon verkehrsberuhigte Zone" filter="try(&quot;zweckbestimmung&quot;=1200) or try(&quot;zweckbestimmung&quot;[0]=1200) " key="{2a4b44ee-61a4-465e-a5c7-efb2265245fd}"/>
      <rule symbol="5" label="davon Rad- und Fußweg" filter="try(&quot;zweckbestimmung&quot;=1300) or try(&quot;zweckbestimmung&quot;[0]=1300)" key="{3940d81e-312a-4942-a705-67e576a4ba45}"/>
      <rule symbol="6" label="davon Verkehrsgrün" filter="try(&quot;zweckbestimmung&quot;=2400) or try(&quot;zweckbestimmung&quot;[0]=2400)" key="{e2f4d0e0-12a1-46a9-ba52-c6c3b057c754}"/>
      <rule symbol="7" label="davon Zweckbestimmung nicht definiert" filter="try (&quot;zweckbestimmung&quot; is NuLL) and try (&quot;zweckbestimmung&quot;[0] is NuLL)  " key="{cf78aa3c-a0b3-4e04-82ba-40762f76f6a0}"/>
    </rules>
    <symbols>
      <symbol is_animated="0" type="fill" alpha="1" frame_rate="10" clip_to_extent="1" name="0" force_rhr="0">
        ...
        <layer class="LinePatternFill" pass="0" id="{d817a3df-b1a6-4414-b8bf-feb5153ae8d7}" locked="0" enabled="1">
          <Option type="Map">
          ...
          <symbol is_animated="0" type="line" alpha="1" frame_rate="10" clip_to_extent="1" name="@0@0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" pass="0" id="{b5ef97f4-21e6-4866-a4af-dd5ac088cbbe}" locked="0" enabled="1">
              <Option type="Map">
        ...
        <layer class="SimpleFill" pass="0" id="{78db9b14-8589-4245-a8cd-17d3306ca427}" locked="0" enabled="1">
          <Option type="Map">
      ...
      <symbol is_animated="0" type="fill" alpha="1" frame_rate="10" clip_to_extent="1" name="1" force_rhr="0">
        ...
        <layer class="LinePatternFill" pass="0" id="{d817a3df-b1a6-4414-b8bf-feb5153ae8d7}" locked="0" enabled="1">
          ...
          <symbol is_animated="0" type="line" alpha="1" frame_rate="10" clip_to_extent="1" name="@1@0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
      ...
      <symbol is_animated="0" type="fill" alpha="1" frame_rate="10" clip_to_extent="1" name="2" force_rhr="0">
        ...
        <layer class="LinePatternFill" pass="0" id="{57c177a2-1c94-43c2-a1bb-cc9082bb0c9d}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="45" name="angle"/>
            <Option type="QString" value="during_render" name="clip_mode"/>
            <Option type="QString" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" name="color"/>
          ...
          <symbol is_animated="0" type="line" alpha="1" frame_rate="10" clip_to_extent="1" name="@2@0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" pass="0" id="{f5891d98-32fb-422c-b5c1-252714d0ea9c}" locked="0" enabled="1">
              <Option type="Map">
                <Option type="QString" value="0" name="align_dash_pattern"/>
                <Option type="QString" value="square" name="capstyle"/>
                <Option type="QString" value="5;2" name="customdash"/>
        ...
        <layer class="SimpleFill" pass="0" id="{e5d2c052-24ff-4dc2-8159-8c138d205096}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
            <Option type="QString" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" name="color"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
        ...
        <layer class="CentroidFill" pass="0" id="{cad790ed-50e5-4d65-84e1-4498c09601b6}" locked="0" enabled="1">
          <Option type="Map">
          ...
          <symbol is_animated="0" type="marker" alpha="1" frame_rate="10" clip_to_extent="1" name="@2@2" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SvgMarker" pass="0" id="{cfcb359c-f65d-406e-a27e-e88ec86f789e}" locked="0" enabled="1">
              <Option type="Map">
      ...
      <symbol is_animated="0" type="fill" alpha="1" frame_rate="10" clip_to_extent="1" name="3" force_rhr="0">
        ...
        <layer class="LinePatternFill" pass="0" id="{68f9f3b4-9345-438d-b2b9-2e3aff2c1207}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="45" name="angle"/>
            <Option type="QString" value="during_render" name="clip_mode"/>
            <Option type="QString" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" name="color"/>
          ...
          <symbol is_animated="0" type="line" alpha="1" frame_rate="10" clip_to_extent="1" name="@3@0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" pass="0" id="{527475d7-1770-435a-8c53-8bcae92cc5c4}" locked="0" enabled="1">
              <Option type="Map">
                <Option type="QString" value="0" name="align_dash_pattern"/>
                <Option type="QString" value="square" name="capstyle"/>
                <Option type="QString" value="5;2" name="customdash"/>
        ...
        <layer class="SimpleFill" pass="0" id="{c0f3ef7d-0ec5-4452-98e3-de98ffb8dbb8}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
            <Option type="QString" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" name="color"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
        ...
        <layer class="CentroidFill" pass="0" id="{28bef5dd-7989-4d9a-9f68-8abbee7a5a60}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="clip_on_current_part_only"/>
            <Option type="QString" value="1" name="clip_points"/>
            <Option type="QString" value="1" name="point_on_all_parts"/>
          ...
          <symbol is_animated="0" type="marker" alpha="1" frame_rate="10" clip_to_extent="1" name="@3@2" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SvgMarker" pass="0" id="{2b6dab96-5deb-44ba-94e4-682774edc520}" locked="0" enabled="1">
              <Option type="Map">
                <Option type="QString" value="0" name="angle"/>
                <Option type="QString" value="255,0,0,255,rgb:1,0,0,1" name="color"/>
                <Option type="QString" value="0" name="fixedAspectRatio"/>
      ...
      <symbol is_animated="0" type="fill" alpha="1" frame_rate="10" clip_to_extent="1" name="4" force_rhr="0">
        ...
        <layer class="LinePatternFill" pass="0" id="{9f75125b-a7cf-4a3d-ba7e-323633b263e5}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="45" name="angle"/>
            <Option type="QString" value="during_render" name="clip_mode"/>
            <Option type="QString" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" name="color"/>
          ...
          <symbol is_animated="0" type="line" alpha="1" frame_rate="10" clip_to_extent="1" name="@4@0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" pass="0" id="{4228bcd0-1abc-4747-87f9-a9c0d502c898}" locked="0" enabled="1">
              <Option type="Map">
                <Option type="QString" value="0" name="align_dash_pattern"/>
                <Option type="QString" value="square" name="capstyle"/>
                <Option type="QString" value="5;2" name="customdash"/>
        ...
        <layer class="SimpleFill" pass="0" id="{1b1644f7-b249-412b-a2a2-c0e804b20df5}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
            <Option type="QString" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" name="color"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
        ...
        <layer class="CentroidFill" pass="0" id="{0f9b42da-7f54-4d56-ad5a-6c55cd42bcf9}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="clip_on_current_part_only"/>
            <Option type="QString" value="1" name="clip_points"/>
            <Option type="QString" value="1" name="point_on_all_parts"/>
          ...
          <symbol is_animated="0" type="marker" alpha="1" frame_rate="10" clip_to_extent="1" name="@4@2" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SvgMarker" pass="0" id="{b501c4c8-c496-440c-bf7c-498183a6e89c}" locked="0" enabled="1">
              <Option type="Map">
                <Option type="QString" value="0" name="angle"/>
                <Option type="QString" value="255,0,0,255,rgb:1,0,0,1" name="color"/>
                <Option type="QString" value="0" name="fixedAspectRatio"/>
      ...
      <symbol is_animated="0" type="fill" alpha="1" frame_rate="10" clip_to_extent="1" name="5" force_rhr="0">
        ...
        <layer class="LinePatternFill" pass="0" id="{3baea0fb-2d28-44e5-a50a-96423096ae25}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="45" name="angle"/>
            <Option type="QString" value="during_render" name="clip_mode"/>
            <Option type="QString" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" name="color"/>
          ...
          <symbol is_animated="0" type="line" alpha="1" frame_rate="10" clip_to_extent="1" name="@5@0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" pass="0" id="{fa658aac-4d69-49c1-b6cf-fe6aa0f3c6be}" locked="0" enabled="1">
              <Option type="Map">
                <Option type="QString" value="0" name="align_dash_pattern"/>
                <Option type="QString" value="square" name="capstyle"/>
                <Option type="QString" value="5;2" name="customdash"/>
        ...
        <layer class="SimpleFill" pass="0" id="{3f1f8d05-ec7e-41a9-b44d-4e9f036506e2}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
            <Option type="QString" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" name="color"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
        ...
        <layer class="CentroidFill" pass="0" id="{d8a99dac-7c75-44fe-9b1a-aaf8b9ec5465}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="clip_on_current_part_only"/>
            <Option type="QString" value="1" name="clip_points"/>
            <Option type="QString" value="1" name="point_on_all_parts"/>
          ...
          <symbol is_animated="0" type="marker" alpha="1" frame_rate="10" clip_to_extent="1" name="@5@2" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SvgMarker" pass="0" id="{87b8daf3-1833-43ef-907e-c71ffc651cce}" locked="0" enabled="1">
              <Option type="Map">
                <Option type="QString" value="0" name="angle"/>
                <Option type="QString" value="255,0,0,255,rgb:1,0,0,1" name="color"/>
                <Option type="QString" value="0" name="fixedAspectRatio"/>
      ...
      <symbol is_animated="0" type="fill" alpha="1" frame_rate="10" clip_to_extent="1" name="6" force_rhr="0">
        ...
        <layer class="LinePatternFill" pass="0" id="{d817a3df-b1a6-4414-b8bf-feb5153ae8d7}" locked="0" enabled="1">
          ...
          <symbol is_animated="0" type="line" alpha="1" frame_rate="10" clip_to_extent="1" name="@6@0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" pass="0" id="{b5ef97f4-21e6-4866-a4af-dd5ac088cbbe}" locked="0" enabled="1">
              <Option type="Map">
                ...
                <Option type="QString" value="0" name="draw_inside_polygon"/>
                <Option type="QString" value="bevel" name="joinstyle"/>
                <Option type="QString" value="51,160,44,255,rgb:0.20000000000000001,0.62745098039215685,0.17254901960784313,1" name="line_color"/>
                <Option type="QString" value="solid" name="line_style"/>
                <Option type="QString" value="4" name="line_width"/>
                <Option type="QString" value="MapUnit" name="line_width_unit"/>
                <Option type="QString" value="0" name="offset"/>
      ...
      <symbol is_animated="0" type="fill" alpha="1" frame_rate="10" clip_to_extent="1" name="7" force_rhr="0">
        ...
        <layer class="LinePatternFill" pass="0" id="{518796f1-243b-407a-bbca-b93008915118}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="45" name="angle"/>
            <Option type="QString" value="during_render" name="clip_mode"/>
            <Option type="QString" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" name="color"/>
          ...
          <symbol is_animated="0" type="line" alpha="1" frame_rate="10" clip_to_extent="1" name="@7@0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" pass="0" id="{07c9da22-f879-493d-937e-8f125a959ee4}" locked="0" enabled="1">
              <Option type="Map">
                <Option type="QString" value="0" name="align_dash_pattern"/>
                <Option type="QString" value="square" name="capstyle"/>
                <Option type="QString" value="5;2" name="customdash"/>
        ...
        <layer class="SimpleFill" pass="0" id="{2c757d4a-e161-43f6-a5f9-9a3366a44273}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
            <Option type="QString" value="55,126,184,255,rgb:0.21568627450980393,0.49411764705882355,0.72156862745098038,1" name="color"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" type="fill" alpha="1" frame_rate="10" clip_to_extent="1" name="" force_rhr="0">
        ...
        <layer class="SimpleFill" pass="0" id="{c5235ee1-82b4-4bfa-a263-dc236292feb9}" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <rendering limitNumLabels="0" mergeLines="0" scaleMax="501" obstacle="1" unplacedVisibility="0" minFeatureSize="0" zIndex="0" scaleMin="0" labelPerPart="0" fontMaxPixelSize="10000" fontMinPixelSize="3" fontLimitPixelSize="0" maxNumLabels="2000" upsidedownLabels="0" obstacleType="1" scaleVisibility="1" obstacleFactor="1" drawLabels="1"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
          <Option type="Map" name="properties">
