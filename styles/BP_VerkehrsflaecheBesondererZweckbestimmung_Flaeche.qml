...
<qgis maxScale="0" labelsEnabled="1" simplifyDrawingHints="1" simplifyMaxScale="1" version="3.34.0-Prizren" simplifyDrawingTol="1" styleCategories="Symbology|Labeling|MapTips|Rendering" minScale="0" simplifyLocal="1" symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0">
  <renderer-v2 referencescale="-1" type="RuleRenderer" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{d1a18705-782c-4041-8cab-c631adb5a594}">
      ...
      <rule symbol="1" key="{43dc0f57-c22f-41f0-9e2e-7f6ac30b6206}" filter="try (array_length( &quot;zweckbestimmung&quot;)>1)" label="davon mehrere Zweckbestimmungen"/>
      <rule symbol="2" key="{b61dcfb9-b440-4d27-8e14-906ced985651}" filter="try (&quot;zweckbestimmung&quot;=1000) or try (&quot;zweckbestimmung&quot;[0]=1000)" label="davon Fläche für das Parken von Fahrzeugen"/>
      <rule symbol="3" key="{e294cfb9-eef7-4a22-9215-41c2b489f401}" filter="Try(&quot;zweckbestimmung&quot;=1100) or try(&quot;zweckbestimmung&quot;=1500) or Try(&quot;zweckbestimmung&quot;[0]=1100) or try(&quot;zweckbestimmung&quot;[0]=1500)" label="davon Fußgängerbereich/reiner Fußweg"/>
      <rule symbol="4" key="{2a4b44ee-61a4-465e-a5c7-efb2265245fd}" filter="try(&quot;zweckbestimmung&quot;=1200) or try(&quot;zweckbestimmung&quot;[0]=1200) " label="davon verkehrsberuhigte Zone"/>
      <rule symbol="5" key="{3940d81e-312a-4942-a705-67e576a4ba45}" filter="try(&quot;zweckbestimmung&quot;=1300) or try(&quot;zweckbestimmung&quot;[0]=1300)" label="davon Rad- und Fußweg"/>
      <rule symbol="6" key="{e2f4d0e0-12a1-46a9-ba52-c6c3b057c754}" filter="try(&quot;zweckbestimmung&quot;=2400) or try(&quot;zweckbestimmung&quot;[0]=2400)" label="davon Verkehrsgrün"/>
      <rule symbol="7" key="{39e98a10-6e56-4987-8655-c80deb821f50}" filter="try (&quot;zweckbestimmung&quot; is NuLL) and try (&quot;zweckbestimmung&quot;[0] is NuLL)  " label="davon Zweckbestimmung nicht definiert"/>
    </rules>
    <symbols>
      <symbol type="fill" name="0" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
        ...
        <layer enabled="1" pass="0" id="{d817a3df-b1a6-4414-b8bf-feb5153ae8d7}" class="LinePatternFill" locked="0">
          <Option type="Map">
          ...
          <symbol type="line" name="@0@0" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" pass="0" id="{b5ef97f4-21e6-4866-a4af-dd5ac088cbbe}" class="SimpleLine" locked="0">
              <Option type="Map">
        ...
        <layer enabled="1" pass="0" id="{78db9b14-8589-4245-a8cd-17d3306ca427}" class="SimpleFill" locked="0">
          <Option type="Map">
      ...
      <symbol type="fill" name="1" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" id="{d817a3df-b1a6-4414-b8bf-feb5153ae8d7}" class="LinePatternFill" locked="0">
          ...
          <symbol type="line" name="@1@0" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <symbol type="fill" name="2" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" id="{57c177a2-1c94-43c2-a1bb-cc9082bb0c9d}" class="LinePatternFill" locked="0">
          <Option type="Map">
            <Option value="45" type="QString" name="angle"/>
            <Option value="during_render" type="QString" name="clip_mode"/>
            <Option value="55,126,184,255" type="QString" name="color"/>
          ...
          <symbol type="line" name="@2@0" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" pass="0" id="{f5891d98-32fb-422c-b5c1-252714d0ea9c}" class="SimpleLine" locked="0">
              <Option type="Map">
                <Option value="0" type="QString" name="align_dash_pattern"/>
                <Option value="square" type="QString" name="capstyle"/>
                <Option value="5;2" type="QString" name="customdash"/>
        ...
        <layer enabled="1" pass="0" id="{e5d2c052-24ff-4dc2-8159-8c138d205096}" class="SimpleFill" locked="0">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="55,126,184,255" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
        ...
        <layer enabled="1" pass="0" id="{cad790ed-50e5-4d65-84e1-4498c09601b6}" class="CentroidFill" locked="0">
          <Option type="Map">
          ...
          <symbol type="marker" name="@2@2" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" pass="0" id="{cfcb359c-f65d-406e-a27e-e88ec86f789e}" class="SvgMarker" locked="0">
              <Option type="Map">
      ...
      <symbol type="fill" name="3" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" id="{68f9f3b4-9345-438d-b2b9-2e3aff2c1207}" class="LinePatternFill" locked="0">
          <Option type="Map">
            <Option value="45" type="QString" name="angle"/>
            <Option value="during_render" type="QString" name="clip_mode"/>
            <Option value="55,126,184,255" type="QString" name="color"/>
          ...
          <symbol type="line" name="@3@0" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" pass="0" id="{527475d7-1770-435a-8c53-8bcae92cc5c4}" class="SimpleLine" locked="0">
              <Option type="Map">
                <Option value="0" type="QString" name="align_dash_pattern"/>
                <Option value="square" type="QString" name="capstyle"/>
                <Option value="5;2" type="QString" name="customdash"/>
        ...
        <layer enabled="1" pass="0" id="{c0f3ef7d-0ec5-4452-98e3-de98ffb8dbb8}" class="SimpleFill" locked="0">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="55,126,184,255" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
        ...
        <layer enabled="1" pass="0" id="{28bef5dd-7989-4d9a-9f68-8abbee7a5a60}" class="CentroidFill" locked="0">
          <Option type="Map">
            <Option value="0" type="QString" name="clip_on_current_part_only"/>
            <Option value="1" type="QString" name="clip_points"/>
            <Option value="1" type="QString" name="point_on_all_parts"/>
          ...
          <symbol type="marker" name="@3@2" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" pass="0" id="{2b6dab96-5deb-44ba-94e4-682774edc520}" class="SvgMarker" locked="0">
              <Option type="Map">
                <Option value="0" type="QString" name="angle"/>
                <Option value="255,0,0,255" type="QString" name="color"/>
                <Option value="0" type="QString" name="fixedAspectRatio"/>
      ...
      <symbol type="fill" name="4" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" id="{9f75125b-a7cf-4a3d-ba7e-323633b263e5}" class="LinePatternFill" locked="0">
          <Option type="Map">
            <Option value="45" type="QString" name="angle"/>
            <Option value="during_render" type="QString" name="clip_mode"/>
            <Option value="55,126,184,255" type="QString" name="color"/>
          ...
          <symbol type="line" name="@4@0" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" pass="0" id="{4228bcd0-1abc-4747-87f9-a9c0d502c898}" class="SimpleLine" locked="0">
              <Option type="Map">
                <Option value="0" type="QString" name="align_dash_pattern"/>
                <Option value="square" type="QString" name="capstyle"/>
                <Option value="5;2" type="QString" name="customdash"/>
        ...
        <layer enabled="1" pass="0" id="{1b1644f7-b249-412b-a2a2-c0e804b20df5}" class="SimpleFill" locked="0">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="55,126,184,255" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
        ...
        <layer enabled="1" pass="0" id="{0f9b42da-7f54-4d56-ad5a-6c55cd42bcf9}" class="CentroidFill" locked="0">
          <Option type="Map">
            <Option value="0" type="QString" name="clip_on_current_part_only"/>
            <Option value="1" type="QString" name="clip_points"/>
            <Option value="1" type="QString" name="point_on_all_parts"/>
          ...
          <symbol type="marker" name="@4@2" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" pass="0" id="{b501c4c8-c496-440c-bf7c-498183a6e89c}" class="SvgMarker" locked="0">
              <Option type="Map">
                <Option value="0" type="QString" name="angle"/>
                <Option value="255,0,0,255" type="QString" name="color"/>
                <Option value="0" type="QString" name="fixedAspectRatio"/>
      ...
      <symbol type="fill" name="5" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" id="{3baea0fb-2d28-44e5-a50a-96423096ae25}" class="LinePatternFill" locked="0">
          <Option type="Map">
            <Option value="45" type="QString" name="angle"/>
            <Option value="during_render" type="QString" name="clip_mode"/>
            <Option value="55,126,184,255" type="QString" name="color"/>
          ...
          <symbol type="line" name="@5@0" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" pass="0" id="{fa658aac-4d69-49c1-b6cf-fe6aa0f3c6be}" class="SimpleLine" locked="0">
              <Option type="Map">
                <Option value="0" type="QString" name="align_dash_pattern"/>
                <Option value="square" type="QString" name="capstyle"/>
                <Option value="5;2" type="QString" name="customdash"/>
        ...
        <layer enabled="1" pass="0" id="{3f1f8d05-ec7e-41a9-b44d-4e9f036506e2}" class="SimpleFill" locked="0">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="55,126,184,255" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
        ...
        <layer enabled="1" pass="0" id="{d8a99dac-7c75-44fe-9b1a-aaf8b9ec5465}" class="CentroidFill" locked="0">
          <Option type="Map">
            <Option value="0" type="QString" name="clip_on_current_part_only"/>
            <Option value="1" type="QString" name="clip_points"/>
            <Option value="1" type="QString" name="point_on_all_parts"/>
          ...
          <symbol type="marker" name="@5@2" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" pass="0" id="{87b8daf3-1833-43ef-907e-c71ffc651cce}" class="SvgMarker" locked="0">
              <Option type="Map">
                <Option value="0" type="QString" name="angle"/>
                <Option value="255,0,0,255" type="QString" name="color"/>
                <Option value="0" type="QString" name="fixedAspectRatio"/>
      ...
      <symbol type="fill" name="6" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" id="{d817a3df-b1a6-4414-b8bf-feb5153ae8d7}" class="LinePatternFill" locked="0">
          ...
          <symbol type="line" name="@6@0" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <symbol type="fill" name="7" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" id="{518796f1-243b-407a-bbca-b93008915118}" class="LinePatternFill" locked="0">
          <Option type="Map">
            <Option value="45" type="QString" name="angle"/>
            <Option value="during_render" type="QString" name="clip_mode"/>
            <Option value="55,126,184,255" type="QString" name="color"/>
          ...
          <symbol type="line" name="@7@0" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" pass="0" id="{07c9da22-f879-493d-937e-8f125a959ee4}" class="SimpleLine" locked="0">
              <Option type="Map">
                <Option value="0" type="QString" name="align_dash_pattern"/>
                <Option value="square" type="QString" name="capstyle"/>
                <Option value="5;2" type="QString" name="customdash"/>
        ...
        <layer enabled="1" pass="0" id="{2c757d4a-e161-43f6-a5f9-9a3366a44273}" class="SimpleFill" locked="0">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="55,126,184,255" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="fill" name="" alpha="1" force_rhr="0" clip_to_extent="1" frame_rate="10" is_animated="0">
        ...
        <layer enabled="1" pass="0" id="{55dbacb4-e822-4443-9fa4-216d15eac3ef}" class="SimpleFill" locked="0">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement overrunDistance="0" centroidWhole="0" allowDegraded="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" layerType="PolygonGeometry" distUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" offsetUnits="MM" centroidInside="1" lineAnchorClipping="0" geometryGeneratorType="PointGeometry" geometryGenerator="" rotationAngle="0" yOffset="0" overlapHandling="PreventOverlap" polygonPlacementFlags="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetType="0" placement="1" maxCurvedCharAngleIn="25" preserveRotation="1" lineAnchorTextPoint="FollowPlacement" lineAnchorType="0" lineAnchorPercent="0.5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" rotationUnit="AngleDegrees" repeatDistance="0" quadOffset="4" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" placementFlags="10" dist="0" fitInPolygonOnly="0" priority="5"/>
      <rendering mergeLines="0" fontMaxPixelSize="10000" zIndex="0" maxNumLabels="2000" fontLimitPixelSize="0" scaleMax="501" labelPerPart="0" fontMinPixelSize="3" unplacedVisibility="0" drawLabels="1" scaleMin="0" scaleVisibility="1" upsidedownLabels="0" minFeatureSize="0" limitNumLabels="0" obstacle="1" obstacleFactor="1" obstacleType="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option type="Map" name="properties">
