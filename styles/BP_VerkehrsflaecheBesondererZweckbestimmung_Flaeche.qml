...
<qgis readOnly="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyDrawingTol="1" styleCategories="LayerConfiguration|Symbology|Symbology3D|Labeling|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" hasScaleBasedVisibilityFlag="0" version="3.26.3-Buenos Aires" maxScale="0" symbologyReferenceScale="-1" simplifyMaxScale="1" labelsEnabled="0" simplifyLocal="1" minScale="100000000">
  <flags>
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0" referencescale="-1">
    <rules key="{d1a18705-782c-4041-8cab-c631adb5a594}">
      <rule symbol="0" label="Fläche für das Parken von Fahrzeugen" filter="to_string(&quot;zweckbestimmung&quot;) ILIKE '%1000%' or &#xd;&#xa;to_string(&quot;zweckbestimmung&quot;) ILIKE '%Parkierungsflaeche%'" key="{b61dcfb9-b440-4d27-8e14-906ced985651}"/>
      <rule symbol="1" label="Fußgängerbereich oder reiner Fußweg" filter="to_string(&quot;zweckbestimmung&quot;) ILIKE '%1100%' or &#xd;&#xa;to_string(&quot;zweckbestimmung&quot;) ILIKE '%Fussgaengerbereich%' or &#xd;&#xa;to_string(&quot;zweckbestimmung&quot;) ILIKE '%1500%' or &#xd;&#xa;to_string(&quot;zweckbestimmung&quot;) ILIKE '%Gehweg%'" key="{e294cfb9-eef7-4a22-9215-41c2b489f401}"/>
      <rule symbol="2" label="Verkehrsberuhigte Zone" filter="to_string(&quot;zweckbestimmung&quot;) ILIKE '%1200%' or &#xd;&#xa;to_string(&quot;zweckbestimmung&quot;) ILIKE '%VerkehrsberuhigterBereich%'" key="{2a4b44ee-61a4-465e-a5c7-efb2265245fd}"/>
      <rule symbol="3" label="Rad- und Fußweg" filter="to_string(&quot;zweckbestimmung&quot;) ILIKE '%1300%' &#xd;&#xa;or to_string(&quot;zweckbestimmungCode&quot;) ILIKE '%RadGehweg%'" key="{3940d81e-312a-4942-a705-67e576a4ba45}"/>
      <rule symbol="4" label="alles andere" filter="to_string(&quot;zweckbestimmung&quot;) not ILIKE '%1000%' and  to_string(&quot;zweckbestimmung&quot;) not ILIKE '%Parkierungsflaeche%' and&#xd;&#xa;to_string(&quot;zweckbestimmung&quot;) not ILIKE '%1100%' and  to_string(&quot;zweckbestimmung&quot;) not ILIKE '%Fussgaengerbereich%' and&#xd;&#xa;to_string(&quot;zweckbestimmung&quot;) not ILIKE '%1200%' and  to_string(&quot;zweckbestimmung&quot;) not ILIKE '%VerkehrsberuhigterBereich%' and&#xd;&#xa;to_string(&quot;zweckbestimmung&quot;) not ILIKE '%1300%' and  to_string(&quot;zweckbestimmung&quot;) not ILIKE '%RadGehweg%' and&#xd;&#xa;to_string(&quot;zweckbestimmung&quot;) not ILIKE '%1500%' and  to_string(&quot;zweckbestimmung&quot;) not ILIKE '%Gehweg%'" key="{19094b9a-ee7b-4d41-ab1f-7ea11607504e}"/>
      <rule symbol="5" label="Zweckbestimmung nicht definiert" filter="&quot;zweckbestimmung&quot; is NuLL" key="{39e98a10-6e56-4987-8655-c80deb821f50}"/>
    </rules>
    <symbols>
      <symbol alpha="1" is_animated="0" name="0" clip_to_extent="1" type="fill" force_rhr="0" frame_rate="10">
        ...
        <layer enabled="1" locked="0" class="LinePatternFill" pass="0">
          ...
          <symbol alpha="1" is_animated="0" name="@0@0" clip_to_extent="1" type="line" force_rhr="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" class="PointPatternFill" pass="0">
          <Option type="Map">
            ...
            <Option value="595354380" name="seed" type="QString"/>
          </Option>
          <prop k="angle" v="0"/>
          ...
          <symbol alpha="1" is_animated="0" name="@0@2" clip_to_extent="1" type="marker" force_rhr="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" is_animated="0" name="1" clip_to_extent="1" type="fill" force_rhr="0" frame_rate="10">
        ...
        <layer enabled="1" locked="0" class="LinePatternFill" pass="0">
          ...
          <symbol alpha="1" is_animated="0" name="@1@0" clip_to_extent="1" type="line" force_rhr="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" class="PointPatternFill" pass="0">
          ...
          <symbol alpha="1" is_animated="0" name="@1@2" clip_to_extent="1" type="marker" force_rhr="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" is_animated="0" name="2" clip_to_extent="1" type="fill" force_rhr="0" frame_rate="10">
        ...
        <layer enabled="1" locked="0" class="LinePatternFill" pass="0">
          ...
          <symbol alpha="1" is_animated="0" name="@2@0" clip_to_extent="1" type="line" force_rhr="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" class="PointPatternFill" pass="0">
          ...
          <symbol alpha="1" is_animated="0" name="@2@2" clip_to_extent="1" type="marker" force_rhr="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" is_animated="0" name="3" clip_to_extent="1" type="fill" force_rhr="0" frame_rate="10">
        ...
        <layer enabled="1" locked="0" class="LinePatternFill" pass="0">
          ...
          <symbol alpha="1" is_animated="0" name="@3@0" clip_to_extent="1" type="line" force_rhr="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" class="PointPatternFill" pass="0">
          ...
          <symbol alpha="1" is_animated="0" name="@3@2" clip_to_extent="1" type="marker" force_rhr="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" is_animated="0" name="4" clip_to_extent="1" type="fill" force_rhr="0" frame_rate="10">
        ...
        <layer enabled="1" locked="0" class="LinePatternFill" pass="0">
          ...
          <symbol alpha="1" is_animated="0" name="@4@0" clip_to_extent="1" type="line" force_rhr="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" is_animated="0" name="5" clip_to_extent="1" type="fill" force_rhr="0" frame_rate="10">
        ...
        <layer enabled="1" locked="0" class="LinePatternFill" pass="0">
          ...
          <symbol alpha="1" is_animated="0" name="@5@0" clip_to_extent="1" type="line" force_rhr="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
  ...
  <attributetableconfig sortOrder="1" actionWidgetStyle="dropDown" sortExpression="&quot;zweckbestimmung&quot;">
    <columns>
      ...
      <column name="zweckbestimmung" type="field" width="397" hidden="0"/>
      <column name="nutzungsform" type="field" width="-1" hidden="0"/>
