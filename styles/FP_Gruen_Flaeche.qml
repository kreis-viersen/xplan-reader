...
<qgis version="3.26.3-Buenos Aires" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 symbollevels="0" type="RuleRenderer" forceraster="0" referencescale="-1" enableorderby="0">
    <rules key="{d586ac0c-6250-44f0-8b24-8cc390c25b7b}">
      ...
      <rule label="davon mit mehreren Zweckbestimmungen" symbol="1" filter="try(array_length (&quot;zweckbestimmung&quot; )>1)" key="{411ab253-a314-4519-8fcc-bf97393e99d0}"/>
      <rule label="davon mit einer Zweckbestimmung" symbol="2" filter="try( array_length(&quot;zweckbestimmung&quot;)=1) or  try(&quot;zweckbestimmung&quot; is not NULL)" key="{2381de8b-d671-4552-b076-779c245bd250}"/>
      <rule label="davon ohne Zweckbestimmung" symbol="3" filter="try( array_length(&quot;zweckbestimmung&quot;)=0) or  try(&quot;zweckbestimmung&quot; is NULL)" key="{3f1eb034-45b9-4e0e-a823-d94af7ffbfc7}"/>
    </rules>
    <symbols>
