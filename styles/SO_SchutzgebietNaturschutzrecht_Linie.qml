...
<qgis version="3.28.3-Firenze" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 forceraster="0" referencescale="-1" enableorderby="0" symbollevels="0" type="RuleRenderer">
    <rules key="{037de2a1-95ea-4ca0-95dc-4538a8d87cd0}">
      <rule label="alle" symbol="0" key="{a7fbcbdd-6183-47a0-9052-cf235c900348}"/>
      <rule label="artDerFestlegung nicht definiert" symbol="1" filter=" &quot;artDerFestlegung&quot; is NULL" key="{c0a917dd-cf45-4c81-acf5-4d179126fdfa}"/>
    </rules>
    <symbols>
      <symbol frame_rate="10" name="0" alpha="1" is_animated="0" clip_to_extent="1" type="line" force_rhr="0">
      ...
      <symbol frame_rate="10" name="1" alpha="1" is_animated="0" clip_to_extent="1" type="line" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format reverseDirectionSymbol="0" placeDirectionSymbol="0" leftDirectionSymbol="&lt;" decimals="3" wrapChar="" formatNumbers="0" useMaxLineLengthForAutoWrap="1" multilineAlign="0" autoWrapLength="0" addDirectionSymbol="0" plussign="0" rightDirectionSymbol=">"/>
      <placement repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" dist="0" xOffset="0" placementFlags="9" priority="5" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" polygonPlacementFlags="2" placement="3" layerType="LineGeometry" lineAnchorType="0" centroidInside="0" lineAnchorPercent="0.5" allowDegraded="0" lineAnchorTextPoint="FollowPlacement" maxCurvedCharAngleOut="-25" distUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGeneratorEnabled="0" lineAnchorClipping="0" rotationUnit="AngleDegrees" overrunDistanceUnit="MM" overrunDistance="0" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" offsetType="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" quadOffset="4" centroidWhole="0" overlapHandling="PreventOverlap" yOffset="0" geometryGenerator="" offsetUnits="MM" fitInPolygonOnly="0"/>
