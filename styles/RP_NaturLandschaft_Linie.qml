...
<qgis version="3.28.4-Firenze" styleCategories="Symbology|Labeling" labelsEnabled="1">
      ...
      <symbol type="line" is_animated="0" clip_to_extent="1" name="0" alpha="1" force_rhr="0" frame_rate="10">
        ...
        <layer class="SimpleLine" locked="0" pass="0" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="0,159,0,255"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style allowHtml="0" fontWeight="50" fontKerning="1" isExpression="1" textColor="0,159,0,255" forcedItalic="0" capitalization="0" forcedBold="0" previewBkgrdColor="255,255,255,255" legendString="Aa" multilineHeight="1" fontWordSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontStrikeout="0" fontUnderline="0" useSubstitutions="0" fieldName="'Natur&amp;Landschaft '+&#xd;&#xa;Case&#xd;&#xa;When try(gebietsTyp is not null) then &#xd;&#xa;&#x9;Case&#xd;&#xa;&#x9;When gebietsTyp=1000 then 'Vorranggebiet'&#xd;&#xa;&#x9;When gebietsTyp=1001 then 'Vorrangstandort'&#xd;&#xa;&#x9;When gebietsTyp=1100 then 'Vorbehaltsgebiet'&#xd;&#xa;&#x9;When gebietsTyp=1101 then 'Vorbehaltsstandort'&#xd;&#xa;&#x9;When gebietsTyp=1200 then 'Eignungsgebiet'&#xd;&#xa;&#x9;When gebietsTyp=1300 then 'Vorrang&amp;Eignungsgebiet'&#xd;&#xa;&#x9;When gebietsTyp=1400 then 'Ausschlussgebiet'&#xd;&#xa;&#x9;When gebietsTyp=1500 then 'Vorsorgegebiet'&#xd;&#xa;&#x9;When gebietsTyp=1501 then 'Vorsorgestandort'&#xd;&#xa;&#x9;When gebietsTyp=1600 then 'Vorzugsraum'&#xd;&#xa;&#x9;When gebietsTyp=1700 then 'Potenzialgebiet'&#xd;&#xa;&#x9;When gebietsTyp=1800 then 'Schwerpunktraum'&#xd;&#xa;&#x9;When gebietsTyp=9999 then 'SonstigesGebiet'&#xd;&#xa;&#x9;Else ''&#xd;&#xa;&#x9;End &#xd;&#xa;ELSE 'gebietsTyp nicht definiert'&#xd;&#xa;End &#xd;&#xa;+ CASE&#xd;&#xa;When try( typ is not null) then&#x9;&#xd;&#xa;&#x9;Case&#xd;&#xa;&#x9;When typ = 1000&#x9;Then ' '+'NaturLandschaft'&#xd;&#xa;&#x9;When typ = 1100&#x9;Then ' '+'Naturschutz&amp;Landschaftspflege'&#xd;&#xa;&#x9;When typ = 1101&#x9;Then ' '+'Naturschutz&amp;Landschaftspflege Gewässer'&#xd;&#xa;&#x9;When typ = 1200&#x9;Then ' '+'Flurdurchgrünung'&#xd;&#xa;&#x9;When typ = 1300&#x9;Then ' '+'Unzerschnittene Räume'&#xd;&#xa;&#x9;When typ = 1301&#x9;Then ' '+'Unzerschnittene verkehrsarme Räume'&#xd;&#xa;&#x9;When typ = 1400&#x9;Then ' '+'Feuchtgebiet'&#xd;&#xa;&#x9;When typ = 1500&#x9;Then ' '+'Ökologisches Verbundssystem'&#xd;&#xa;&#x9;When typ = 1501&#x9;Then ' '+'Ökologischer Raum'&#xd;&#xa;&#x9;When typ = 1600&#x9;Then ' '+'Verbess. Landschaftsstruktur/Naturhaushalt'&#xd;&#xa;&#x9;When typ = 1700&#x9;Then ' '+'Biotop'&#xd;&#xa;&#x9;When typ = 1701&#x9;Then ' '+'Biotopverbund'&#xd;&#xa;&#x9;When typ = 1702&#x9;Then ' '+'Biotopverbundachse'&#xd;&#xa;&#x9;When typ = 1703&#x9;Then ' '+'Arten-/Biotopschutz'&#xd;&#xa;&#x9;When typ = 1704&#x9;Then ' '+'Regionalpark'&#xd;&#xa;&#x9;When typ = 1705&#x9;Then ' '+'Waldlebensraum'&#xd;&#xa;&#x9;When typ = 1706&#x9;Then ' '+'Feuchtlebensraum'&#xd;&#xa;&#x9;When typ = 1707&#x9;Then ' '+'Trockenlebensraum'&#xd;&#xa;&#x9;When typ = 1708 Then ' '+'Länderübergreifend.Biotop(verbund)'&#xd;&#xa;&#x9;When typ = 1800&#x9;Then ' '+'Kompensation für Entwicklung'&#xd;&#xa;&#x9;When typ = 1900&#x9;Then ' '+'Grünlandbewirt./-pflege/-entwickl.'&#xd;&#xa;&#x9;When typ = 2000&#x9;Then ' '+'Landschaftsstruktur'&#xd;&#xa;&#x9;When typ = 2100&#x9;Then ' '+'Landschaftsgebiet für Erholung'&#xd;&#xa;&#x9;When typ = 2200&#x9;Then ' '+'Landschaftsprägend'&#xd;&#xa;&#x9;When typ = 2300&#x9;Then ' '+'Schutz der Natur'&#xd;&#xa;&#x9;When typ = 2400&#x9;Then ' '+'Schutz Landschaftsbild'&#xd;&#xa;&#x9;When typ = 2500&#x9;Then ' '+'Alpenpark'&#xd;&#xa;&#x9;When typ = 9999 Then ' '+'sonst.NaturLandschaftsschutz'&#xd;&#xa;&#x9;ELSE''&#xd;&#xa;&#x9;END &#xd;&#xa;ELSE '  typ nicht definiert'&#xd;&#xa;END &#xd;&#xa;&#xd;&#xa;+case when try(&quot;text&quot; is not null) then   case &#xd;&#xa;when length(&quot;text&quot;)>25 then ' '+left(replace(&quot;text&quot;,' ',' '),25)+'...'&#xd;&#xa;when length(&quot;text&quot;)&lt;26 then ' '+     replace(&quot;text&quot;,' ',' ')  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung1&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung1&quot;)>25 then ' '+left(&quot;gliederung1&quot;,25)+'...'&#xd;&#xa;when length(&quot;gliederung1&quot;)&lt;26 then ' '+     &quot;gliederung1&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;gliederung2&quot; is not null) then   case &#xd;&#xa;when length(&quot;gliederung2&quot;)>25 then ' '+left(&quot;gliederung2&quot;,25)+'...'&#xd;&#xa;when length(&quot;gliederung2&quot;)&lt;26 then ' '+     &quot;gliederung2&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;+ case when try(&quot;aufschrift&quot; is not null) then   case &#xd;&#xa;when length(&quot;aufschrift&quot;)>25 then ' '+left(&quot;aufschrift&quot;,25)+'...'&#xd;&#xa;when length(&quot;aufschrift&quot;)&lt;26 then ' '+     &quot;aufschrift&quot;  End ELSE '' End&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;" fontSize="10" fontFamily="Arial" fontLetterSpacing="0" multilineHeightUnit="Percentage" fontSizeUnit="Point" textOpacity="1" textOrientation="horizontal" namedStyle="Regular" blendMode="0">
        <families/>
        <text-buffer bufferBlendMode="0" bufferSizeUnits="Percentage" bufferColor="255,255,255,255" bufferNoFill="1" bufferJoinStyle="128" bufferOpacity="1" bufferSize="25" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="1"/>
