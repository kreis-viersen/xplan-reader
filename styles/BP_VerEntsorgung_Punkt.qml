...
<qgis version="3.28.4-Firenze" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 symbollevels="0" type="RuleRenderer" forceraster="0" referencescale="-1" enableorderby="0">
    <rules key="{0b968c9e-edb6-4baf-9c04-c66480152c62}">
      <rule scalemaxdenom="8001" symbol="0" label="alle" scalemindenom="1" key="{4c2aef2a-a6e9-4b0c-a622-f345784b51d1}"/>
      <rule scalemaxdenom="8001" filter="&quot;zweckbestimmung&quot; is NULL and  &quot;allgemein&quot; is NULL" symbol="1" label="Zweckbest./allgemein nicht definiert" scalemindenom="1" key="{1b23c979-80f5-406c-9f99-077d24be1783}"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" name="1" force_rhr="0" is_animated="0" type="marker" frame_rate="10" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format formatNumbers="0" placeDirectionSymbol="0" multilineAlign="3" plussign="0" addDirectionSymbol="0" rightDirectionSymbol=">" leftDirectionSymbol="&lt;" reverseDirectionSymbol="0" autoWrapLength="30" decimals="3" wrapChar="" useMaxLineLengthForAutoWrap="1"/>
      <placement repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" lineAnchorType="0" overlapHandling="PreventOverlap" repeatDistanceUnits="MM" geometryGeneratorEnabled="0" distMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" dist="0" offsetUnits="RenderMetersInMapUnits" geometryGeneratorType="PointGeometry" offsetType="1" priority="5" xOffset="2" placementFlags="10" placement="1" rotationAngle="0" maxCurvedCharAngleIn="25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationUnit="AngleDegrees" quadOffset="5" lineAnchorTextPoint="FollowPlacement" lineAnchorPercent="0.5" layerType="PointGeometry" centroidWhole="0" fitInPolygonOnly="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" overrunDistance="0" centroidInside="0" maxCurvedCharAngleOut="-25" lineAnchorClipping="0" polygonPlacementFlags="2" overrunDistanceUnit="MM" allowDegraded="0" yOffset="0" distUnits="MM"/>
      <rendering obstacle="1" fontLimitPixelSize="0" scaleMax="1001" obstacleType="1" zIndex="0" drawLabels="1" obstacleFactor="1" mergeLines="0" fontMinPixelSize="3" unplacedVisibility="0" scaleVisibility="1" maxNumLabels="2000" fontMaxPixelSize="10000" upsidedownLabels="0" minFeatureSize="0" limitNumLabels="0" scaleMin="1" labelPerPart="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
